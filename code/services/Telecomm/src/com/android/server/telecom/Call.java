...
public class Call implements CreateConnectionResponse {
    ...
    private boolean mIsOutGoing; //SPRD: add for bug543741
    ...
    private long mConnectRealTimeMillis = 0;
    /* @} */
    ...
    public void destroy() {
        ...
        /* SPRD: Fix system_server OOM issue. @{ */
        if(mVideoProviderProxy != null){
            mVideoProviderProxy.release();
        }
        /* @} */
    }
    ...
    public void setState(int newState, String tag) {
        if (mState != newState) {
            ...
            if (mState == CallState.ACTIVE || mState == CallState.ON_HOLD) {
                ...
                /*SPRD: Use cpu time instead of system time when user dialing {@ */
                if(mConnectRealTimeMillis == 0){
                    mConnectRealTimeMillis = SystemClock.elapsedRealtime();
                }
                /*@}*/
    ...
    void startCreateConnection(PhoneAccountRegistrar phoneAccountRegistrar) {
        /* SPRD: Add for Bug535546 @{ */
        if (mCreateConnectionProcessor != null && mState == CallState.SELECT_PHONE_ACCOUNT
                && getTargetPhoneAccount() != null) {
            Log.i(this, "startCreateConnection mCreateConnectionProcessor: %s, mState: %d", mCreateConnectionProcessor, mState);
            return;
        }
        /* @} */
    ...
    void answer(int videoState) {
        answer(videoState, MultiPartCallHelper.MPC_MODE_HF);
    }

    /**
     * SPRD Modify for multi-part-call mode.
     * @orig void answer(int)
     *
     ...
     */
    void answer(int videoState, int mpcMode) {
        ...
        if (isRinging("answer")) {
            ...
            mConnectionService.answer(this, videoState, mpcMode);
    ...
    void explicitCallTransfer() {
        if (mConnectionService == null) {
            Log.w(this, "transfering calls without a connection service.");
        } else {
