...
public class MissedCallNotifierImpl extends CallsManagerListenerBase implements MissedCallNotifier {
    ...
    /* SPRD: MISSED CALL NOTIFICATION RGB LIGHT FEATURE @{ */
    ...
    public void onCallStateChanged(Call call, int oldState, int newState) {
        ...
        if (shouldShowMissedCallNotification(call.getDisconnectCause().getCode(),
                oldState, newState)) {
            showMissedCallNotification(call);
        }
        /* @} */
    ...
    private void configureLedOnNotification(Notification notification) {
        ...
        * @orig
        ...
        Log.i(this, "configureLedOnNotification()...");
    ...
    /** SPRD: add for log rejected calls plugin @{ */
    private boolean shouldShowMissedCallNotification(int disConnectCause,
            int oldState, int newState) {
        LogRejectedCallsUtils logRejectedCallsUtils = LogRejectedCallsUtils.getInstance(mContext);
        return logRejectedCallsUtils.shouldShowMissedCallNotification(
                disConnectCause, oldState, newState);
    }
    /** @} */
}
