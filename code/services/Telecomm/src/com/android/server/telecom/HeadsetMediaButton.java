...
public class HeadsetMediaButton extends CallsManagerListenerBase {
    ...
    private KeyEvent mLastHookEvent;   // SPRD: Last Hook Event
    ...
    private boolean handleHeadsetHook(KeyEvent event) {
        ...
        // SPRD: Save ACTION_DOWN Event temporarily.
        ...
        } else if (event.getAction() == KeyEvent.ACTION_UP /* SPRD: && event.getRepeatCount() == 0*/) {
            // SPRD: We should not judge SHORT_PRESS by ACTION_UP event repeatCount, because it is always return 0.
            // Actually only ACTION_DOWN event repeatCount will increase when LONG_PRESS.
