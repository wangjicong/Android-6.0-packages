...
public class VideoProviderProxy extends Connection.VideoProvider {
    ...
    // orig: private final IVideoProvider mConectionServiceVideoProvider;
    private IVideoProvider mConectionServiceVideoProvider;
     ...
     */
    // SPRD: Fix system_server OOM issue.
    // orig: private final VideoCallListenerBinder mVideoCallListenerBinder;
    private VideoCallListenerBinder mVideoCallListenerBinder;
    ...
    private IBinder.DeathRecipient mDeathRecipient = new IBinder.DeathRecipient() {
        ...
        public void binderDied() {
            if(isReleased()) return;//SPRD:Fix system_server OOM issue.
    ...
    public void release(){
        synchronized (mLock) {
            try{
                if(mConectionServiceVideoProvider != null){
                    mConectionServiceVideoProvider.removeVideoCallback(mVideoCallListenerBinder);
                }
            } catch(Throwable t){
                t.printStackTrace();
            }
            mVideoCallListenerBinder = null;
            mConectionServiceVideoProvider = null;
            mCall = null;
        }
    }

    private boolean isReleased(){
        return (mLock == null || mConectionServiceVideoProvider == null);
    }
    /* @} */
}
