...
public class CallIntentProcessor {
    ...
    static void processOutgoingCallIntent(
        ...
        String[] callees = null;
        if(b != null){
            isConferenceDial = b.getBoolean(TelephonyIntents.EXTRA_IMS_CONFERENCE_REQUEST,false);
            callees = b.getStringArray(TelephonyIntents.EXTRA_IMS_CONFERENCE_PARTICIPANTS);
        ...
        /* SPRD: Add for VoLTE @{ */
        clientExtras.putBoolean(TelephonyIntents.EXTRA_IMS_CONFERENCE_REQUEST,isConferenceDial);
        clientExtras.putStringArray(TelephonyIntents.EXTRA_IMS_CONFERENCE_PARTICIPANTS,callees);
        /* @} */

        final boolean isPrivilegedDialer = intent.getBooleanExtra(KEY_IS_PRIVILEGED_DIALER, false);

        /* SPRD: add for vt bug479433 @{ */
        boolean isVideocall = (intent.getIntExtra(TelecomManager.EXTRA_START_CALL_WITH_VIDEO_STATE,
...
//        Call call = callsManager.startOutgoingCall(handle, phoneAccountHandle, clientExtras);
        Call call = callsManager.startOutgoingCall(handle, phoneAccountHandle, clientExtras,isVideocall);
        /* @} */
