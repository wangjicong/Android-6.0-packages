...
public class Log {
    ...
    public static final boolean FORCE_LOGGING = /** SPRD: false*/ Debug.isDebug(); /* STOP SHIP if true */
    public static final boolean SYSTRACE_DEBUG = /** SPRD: false*/ Debug.isDebug(); /* STOP SHIP if true */
