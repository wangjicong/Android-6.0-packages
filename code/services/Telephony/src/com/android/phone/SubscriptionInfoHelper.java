...
public class SubscriptionInfoHelper {
    ...
    /**
     * SPRD: Add for SDN/LND FEATURE.
     * @param intent
     * @param sdnOrLnd
     */
    public void addExtrasToIntent(Intent intent, int sdnOrLnd) {
        intent.putExtra(SubscriptionInfoHelper.SUB_ID_EXTRA, mSubId);
        intent.putExtra(SubscriptionInfoHelper.SUB_LABEL_EXTRA, mSubLabel);
        intent.putExtra(IccUriUtils.LIST_TPYE, sdnOrLnd);
    }
}
