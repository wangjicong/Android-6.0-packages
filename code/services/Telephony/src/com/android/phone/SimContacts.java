...
public class SimContacts extends ADNList {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (intent != null) {
            ...
            /* SPRD: modify for bug494410 @{ */
                ...
                Account[] acounts = AccountManager.get(this).getAccounts();
                mAccount = new Account(getAccountName(acounts), "sprd.com.android.account.phone");
            }
            /* @} */
        }
    ...
    /**
     * SPRD: add for bug494410 @{
     */
    private String getAccountName(Account[] acounts) {
        for (int i = 0; i < acounts.length; i++) {
            String name = acounts[i].name;
            if (acounts[i].type.equals("sprd.com.android.account.phone")) {
                return name;
            }
        }
        return null;
