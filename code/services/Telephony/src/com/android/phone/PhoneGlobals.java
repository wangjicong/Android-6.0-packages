...
import com.sprd.phone.SuppServiceConsumer;
import com.sprd.phone.settings.fastdial.FastDialManager;
...
public class PhoneGlobals extends ContextWrapper {
    ...
    private AlertDialog mMmiPreviousAlertAnother;
    /* @} */
    /**
    ...
    private static VTManagerProxy mVTManagerProxy;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case EVENT_DOCK_STATE_CHANGED:
                    ...
                    break;
                /* SPRD: orange requirement @{ */
                case EVENT_SEND_DISMISS_DIALOG_COMPLETE:
                    if (mMmiPreviousAlertAnother != null) {
                        mMmiPreviousAlertAnother.dismiss();
                        mMmiPreviousAlertAnother = null;
                    }
                    break;
                /* @} */
            }
    ...
    public void onCreate() {
        ...
        if (mCM == null) {
            ...
            mVTManagerProxy = mVTManagerProxy.init(this);
            for (Phone phone : PhoneFactory.getPhones()) {
                mCM.registerPhone(phone);
                // SPRD: Porting SS. Register Consumer Supplementary Service.
                SuppServiceConsumer.getInstance(this, phone);
                /* SPRD: add for bug479433 @{ */
                if (phone instanceof PhoneProxy) {
                    Phone basePhone = phone.getForegroundCall().getPhone();
                    if (basePhone instanceof GSMPhone) {
                        mVTManagerProxy.registerForMessages((GSMPhone) basePhone);
                    }
                }
                /* @} */
            }
            ...
            // SPRD: [bug475223] Init GlobalConfigManager
            GlobalConfigManager.getInstance().init(this);
    ...
    private void onMMIComplete(AsyncResult r) {
        ...
        /* SPRD: add for bug490253 @{ */
        mMmiPreviousAlertAnother = PhoneUtils.displayMMIComplete(mmiCode.getPhone(), getInstance(),
                mmiCode, null, null);
        mHandler.removeMessages(EVENT_SEND_DISMISS_DIALOG_COMPLETE);
        if (isDismissMMIDiaolg()) {
     ...
     * SPRD: add for bug490253 @{
     */
    public boolean isDismissMMIDiaolg() {
        MMICompleteUtils mmiCompleteUtils = MMICompleteUtils.getInstance(getBaseContext());
        return mmiCompleteUtils.isDismissMMIDialog();
    }
    /** @} */
...
//                PhoneUtils.setRadioPower(enabled);
                ...
                Log.d(LOG_TAG,
                        "ACTION_SHUTDOWN phone state : "
                                + PhoneGlobals.getInstance().mCM.getState());
    ...
    /** @} */
    /** SPRD: Add for auto query call forward feature for bug510093 @{
     * @param subId
     * @param visible
     */
    public void updateCfi(int subId, boolean visible) {
        notificationMgr.updateCfi(subId, visible);
    }
     ...
     * @param visible
     */
    public void updateMwi(int subId, boolean visible) {
        notificationMgr.updateMwi(subId, visible);
    }
    /** @} */
}
