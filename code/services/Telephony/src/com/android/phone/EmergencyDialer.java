...
public class EmergencyDialer extends Activity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle icicle) {
        ...
        SimLockManager.getInstance(this, R.string.feature_support_simlock).sendEMDialStart(this);
        /* @} */
        try {
            mHaptic.init(
                    this,
    ...
    public void onPause() {
        ...
        /* SPRD: add for sim lock @{ */
        SimLockManager.getInstance(this, R.string.feature_support_simlock).sendEMDialStop(this);
        /* @} */
    }
