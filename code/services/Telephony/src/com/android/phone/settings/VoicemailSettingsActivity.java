...
public class VoicemailSettingsActivity extends PreferenceActivity
    ...
    /*[Modify] by SPRD for Bug:[493896] 2015.11.06 Start */
    public void initResources(){
        ...
        /* SPRD: modify for bug561366 @{ */
        boolean isEditableVoicemail = CallSettingsPluginsHelper.getInstance().
                isSupportEditVoicemail();
        mSubMenuVoicemailSettings.setEnabled(isEditableVoicemail);
        /* @} */
    ...
    protected void onResume() {
        super.onResume();
        mForeground = true;
        /*[Modify] by SPRD for Bug:[501174] 2015.11.19 Start */
        if(mVoicemailSettings.getDialog()!=null){
                 mVoicemailSettings.getDialog().getActionBar().setDisplayHomeAsUpEnabled(false);
        }
        /*[Modify] by SPRD for Bug:[501174] 2015.11.19 End */
    }
    ...
    private void broadcastVoiceMailChangedIntent() {
        ...
        Intent intent = new Intent("android.intent.action.VM_SETTING_CHANGED");
    ...
    private void handleVmAndFwdSetSuccess(int dialogId) {
        ...
        showDialogIfForeground(dialogId);
        updateVoiceNumberField();
        broadcastVoiceMailChangedIntent(); //SPRD: add for bug532829
    }
