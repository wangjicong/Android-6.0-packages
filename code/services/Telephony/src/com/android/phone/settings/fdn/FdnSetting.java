...
public class FdnSetting extends PreferenceActivity
    ...
    private static final String ENABLEFDN_DIALOG_MESSAGE_KEY = "enablefdn_dialog_message_key";
    /* }@ */
            ...
            switch (msg.what) {
                ...
                case EVENT_PIN2_ENTRY_COMPLETE: {
                        ...
                        **/
                        ...
                        if (DBG) log("[Subscription: +" + mSubscriptionInfoHelper.getSubId() + "]: handle EVENT_PIN2_ENTRY_COMPLETE: pin2 = " + mRemainPin2Times
                            + ", puk2 = " + mRemainPuk2Times);
                        ...
                        if (ar.exception != null) {
                            ...
                            if (ar.exception instanceof CommandException) {
                                ...
                                if (ce.getCommandError() == CommandException.Error.SIM_PUK2) {
                                    // make sure we set the PUK2 state so that we can skip some redundant behavior.
                                    displayMessage(R.string.fdn_enable_puk2_requested);
                                    resetPinChangeStateForPUK2();
                                } else {
                                ...
                                Log.d(LOG_TAG, ar.exception.toString());
                            }
                        }
                        /* }@ */
                ...
                case EVENT_PIN2_CHANGE_COMPLETE: {
                        if (DBG) log("Handle EVENT_PIN2_CHANGE_COMPLETE");
                        AsyncResult ar = (AsyncResult) msg.obj;
                        /* SPRD: function FDN support. @{ */
                        updateRemainTimes();
                        /* }@ */
                                    ...
                                    **/
                                    ...
                                    if (mRemainPin2Times > 0) {
                                        ...
                                        if (mRemainPuk2Times < 1) {
                                            ...
                                            displayMessage(mIsPuk2Locked ? R.string.badPuk2 : R.string.puk2_requested);
                                            resetPinChangeStateForPUK2();
                                        }
                                    }
                                    /* }@ */
    ...
    private void updateEnableFDN() {
        ...
        /* SPRD: FDN new feature @{ */
        Intent intent = new Intent("android.intent.action.FDN_STATUS_CHANGED");
        ...
        if (!(tm.isAirplaneModeOn() || tm.isRadioBusy())) {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        **/
        ...
        getContentResolver().registerContentObserver(
            Settings.Global.getUriFor(Settings.Global.RADIO_OPERATION), true, mRadioBusyObserver);
        /* }@ */
    }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference != null) {
            ...
            if (intent != null) {
                ...
                if (DBG) Log.d(LOG_TAG, "onPreferenceTreeClick mSubscription:" + mSubscriptionInfoHelper.getSubId());
            }
        }
        return false;
    }
    ...
    public void updateRemainTimes() {
        mRemainPin2Times = mPhone.getRemainTimes(TelephonyManager.UNLOCK_PIN2);
        if (DBG) log("[Subscription: +" + mSubscriptionInfoHelper.getSubId() + "]: updateRemainTimes: pin2 = " + mRemainPin2Times);
        mRemainPuk2Times = mPhone.getRemainTimes(TelephonyManager.UNLOCK_PUK2);
        if (DBG) log("[Subscription: +" + mSubscriptionInfoHelper.getSubId() + "]: updateRemainTimes: puk2 = " + mRemainPuk2Times);
    }
    /* }@ */
