    ...
    private void recalculateConference() {
        ...
        if (numGsmConnections < 2) {
            ...
            if (mTelephonyConference != null) {
                ...
                long mTempConnectRealTimeMillis = Long.MAX_VALUE; //SPRD: add for bug492533
                ...
                for (Connection connection : conferencedConnections) {
                    ...
                    mTempConnectRealTimeMillis = Math.min(((TelephonyConnection) connection).getOriginalConnection().getConnectTimeReal(),
                            mTempConnectRealTimeMillis); //SPRD: add for bug492533
                }

                mTelephonyConference.setConnectRealTimeMillis(mTempConnectRealTimeMillis); //SPRD: add for bug492533
