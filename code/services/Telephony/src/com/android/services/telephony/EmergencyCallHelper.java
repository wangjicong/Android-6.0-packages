...
public class EmergencyCallHelper {
    ...
    private void powerOnRadio() {
        ...
        // SPRD: Add logic for SIM_STANDBY.
        TelephonyManager tm = TelephonyManager.from(mContext);
        /* SPRD: Dial emergency fail when radio busy @{ */
        if (tm.isRadioBusy()) {
            Log.i(this,"Can not dial emergency when radio busy.");
            return;
        }
        /* @} */
        ...
        else if (!tm.isSimStandby(mPhone.getPhoneId())) {
            Log.d(this, "==> Seems sim is not standby, we have to activate it.");
            tm.setSimStandby(mPhone.getPhoneId(), true);
        } /** @} */
        else {
