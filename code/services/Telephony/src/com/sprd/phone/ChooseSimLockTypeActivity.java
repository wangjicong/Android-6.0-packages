...
public class ChooseSimLockTypeActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (OptConfig.SUN_SUBCUSTOM_C7356_TYC_S417_WVGA) { //yanghua add
            mSimLockType = getResources().getStringArray(R.array.one_key_sim_lock_type_tyc);
        } else {
        ...
        mPhone = PhoneFactory.getGsmPhone(0);
    }
    ...
    private void setFacilityLockByUser(int type,boolean enable) {
        ...
        ((GSMPhone)mPhone).mCi.setFacilityLockByUser(
                mFacility,enable,mHandler.obtainMessage(MyHandler.MESSAGE_SET_LOCK));
    }
    ...
    private void querySimLockState(int type) {
        ...
        ((GSMPhone)mPhone).mCi.queryFacilityLock(mFacility,"00000000",DEFAULT_SERVICE_CLASS,
    ...
    private class OnItemClickListenerImpl implements OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int simlockType, long id) {
            Log.d(TAG," position = " + simlockType );
