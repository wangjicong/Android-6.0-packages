...
public class FastDialManager {
    ...
    private FastDialManager(Context context) {
        ...
        mPerSavedFDNumbers = mContext.getApplicationContext().getSharedPreferences(
                SHARED_PREFERENCES_NAME, mContext.MODE_WORLD_READABLE);
        mPerSavedFDNumbers.registerOnSharedPreferenceChangeListener(mSharedPreferenceChangeListener);
                ...
                if (i == 1) {
                            ...
                            try {
                                cursor2 = mContext.getContentResolver().query(
                                        ...
                                        CommonDataKinds.Phone.NUMBER + "=? AND "
                                                ...
                                                + "account_type"/*FIXME: Contacts.DISPLAY_ACCOUNT_TYPE */ + "=?",
                                        new String[] {
                    ...
                    if (!TextUtils.isEmpty(mPerSavedFDNumbers.getString("fast_dial_" + i
                        ...
                        if (mPerSavedFDNumbers.getString("fast_dial_accountType_" + i, "")
                            ...
                            Log.d(TAG, "accountType is sim  and is not contactsBootLoaded to cache");
                            HashMap<String, Object> map2 = new HashMap<String, Object>();
                            map2.put("name", mPerSavedFDNumbers.getString("fast_dial_name_" + i, ""));
                            map2.put("number", mPerSavedFDNumbers.getString("fast_dial_" + i, ""));
                            map2.put("accountType", mPerSavedFDNumbers.getString("fast_dial_accountType_" + i, ""));
                        ...
                        if (!TextUtils.isEmpty(mContactId) && TextUtils.isEmpty(mPhoto)) {
                            ...
                            try {
                                ...
                                if (cursor3 != null && cursor3.moveToFirst()) {
                                    mPhoto = cursor3.getString(cursor3.getColumnIndex(Data.PHOTO_URI));
                                }
                            } finally {
                                if (cursor3 != null) {
                                    cursor3.close();
    ...
    private void saveFastDialNumber(int key, String phoneNumber, String phoneName, String photoUri,
            String contactId, String dataUri, String accountType) {
    ...
    private void addFastDial(final Intent myData, final int fastDialIndex, final String number, final String strUri) {
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (AppWidgetManager.ACTION_APPWIDGET_UPDATE.equals(action)) {
                Log.d(TAG, "mContactsBroadcastReceiver Receive");
                mNeedSimLoadedCount--;
