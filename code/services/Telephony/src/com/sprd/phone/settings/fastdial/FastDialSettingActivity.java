 ...
 *
 */
package com.sprd.phone.settings.fastdial;
...
import com.sprd.phone.common.SelectPhoneAccountDialogFragment;
import com.sprd.phone.common.SelectPhoneAccountDialogFragment.SelectPhoneAccountListener;
...
public class FastDialSettingActivity extends Activity  implements View.OnClickListener,
    ...
    private class OnItemClickListenerImpl implements OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (position == 0) {
                ...
                if (0 == standbyCount) {
                    ...
                    final TelecomManager mTelecomManager =(TelecomManager) mContext.getSystemService(Context.TELECOM_SERVICE);
                    ...
                    final List<SubscriptionInfo> sil = mSubscriptionManager.getActiveSubscriptionInfoList();
                    ...
                    SelectPhoneAccountListener listener = new SelectPhoneAccountListener() {
                        ...
                        public void onPhoneAccountSelected(PhoneAccountHandle selectedAccountHandle,
                            ...
                            for(int i = 0; i < sil.size(); i++) {
                                ...
                                if (selectedAccountHandle.getId().equals(String.valueOf(sil.get(i).getIccId()))) {
                    ...
                    SelectPhoneAccountDialogFragment.showAccountDialog(((Activity) mContext).getFragmentManager(),
        ...
        public void selectFastDial() {
            ...
            builder.setView(View.inflate(FastDialSettingActivity.this, R.layout.fast_dial_input_dialog_ex, null));
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (mSubscriptionManager.getActiveSubscriptionIdList().length < TelephonyManager.getDefault().getPhoneCount()) {
            SelectPhoneAccountDialogFragment.dissmissDialog();
        }
        if (this.getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            setContentView(R.layout.fast_dial_setting_land_ex);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.contacts) {
            ...
            try {
                FastDialSettingActivity.this.startActivityForResult(mContactListIntent, REQUESET_CODE_SELECT_CONTACTS);
            } catch (ActivityNotFoundException e) {
                String toast = this.getResources().getString(com.android.internal.R.string.noApplications);
