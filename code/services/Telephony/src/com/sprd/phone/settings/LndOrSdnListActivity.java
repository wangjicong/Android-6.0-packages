...
public class LndOrSdnListActivity extends Activity {
    ...
    public static final String TAG = "hunter";//"LndOrSdnListActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IntentFilter intentFilter = new IntentFilter(TelephonyIntents.ACTION_SIM_STATE_CHANGED + mSubId);
    ...
    private void updateList(Cursor cursor) {
        ...
        if ((mOperateType == DELETE) && !isDelSuccess) {
            if (mSubId >= 0
                ...
                Toast.makeText(this, R.string.sim_notready_can_not_delete, Toast.LENGTH_SHORT).show();
            } else {
