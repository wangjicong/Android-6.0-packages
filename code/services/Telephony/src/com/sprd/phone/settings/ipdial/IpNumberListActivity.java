...
public class IpNumberListActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedIpPreference = mIpDialingUtils.getIpPreferenceNumber();
        mIsIpDial = true;
        refreshList();
    ...
    private void initViews(){
        ...
        Drawable backgroundRes = resources.getDrawable(R.drawable.ip_dialing_list_background_holo_ex);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id){
        ...
        mIpDialingUtils.setIpPreferenceNumber(position);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case START_NEW_ACTIVITY:
                ...
                mIpDialingUtils.setIpNumber(num, mMaxIpPreferenceNum);
                mIpDialingUtils.setIpPreferenceNumber(mMaxIpPreferenceNum);
                mMaxIpPreferenceNum++;
                refreshList();
