...
import com.android.phone.R.string;
import com.android.phone.R.style;
import com.android.phone.R.styleable;
   ...
   void setListener(CallBarringEditPreferencePreferenceListener listener){
        ...
        if (this.mButtonClicked == DialogInterface.BUTTON_POSITIVE) {
            ...
            if (action == CommandsInterface.CB_ACTION_ENABLE
                ...
                if (ENABLE_RIL){
                    ...
                    // SPRD: fix bug 426521
                    if(mPhone != null) {
                        mPhone.setFacilityLock(reasonToString(mReason), (action == CommandsInterface.CB_ACTION_ENABLE) , password, mServiceClass,
    ...
    private class MyHandler extends Handler {
        ...
        private void handleGetCBResponse(Message msg) {
            ...
            if (ENABLE_RIL) {
                ...
                if (ar.exception != null) {
                    ...
                    if (ar.exception instanceof CommandException) {
                           tcpListener.onException(CallBarringEditPreference.this, (CommandException) ar.exception);
                    } else {
                          setEnabled(false);
            ...
            if (msg.arg2 == MESSAGE_SET_LOCK && (mReason != CommandsInterface.CB_REASON_AI
                    && mReason != CommandsInterface.CB_REASON_IR)) {
                if (mNeedEcho){
                    updateSummaryText();
                }
            }
