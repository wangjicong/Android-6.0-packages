...
#ifndef SPRD_MPEG4_WRITER_H_

#define SPRD_MPEG4_WRITER_H_
...
class SprdMPEG4Writer : public SprdMediaWriter {
public:
    SprdMPEG4Writer(const char *filename);
    SprdMPEG4Writer(int fd);
...
private:
    ...
    SprdMPEG4Writer(const SprdMPEG4Writer &);
    SprdMPEG4Writer &operator=(const SprdMPEG4Writer &);
};
