...
public class DownloadService extends Service {
    ...
    static {
        final HandlerThread thread = new HandlerThread("Delete thread");
        thread.start();
        mDeleteHandler = new Handler(thread.getLooper()) {
            @Override
            public void handleMessage(Message message) {
                final String path =  (String)message.obj;
    ...
    private boolean updateLocked() {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                if (info.mDeleted) {
                     ...
                     *@{
                     */
                    Message msg = Message.obtain(mDeleteHandler);
                    msg.obj = info.mFileName;
                    mDeleteHandler.sendMessage(msg);
                    /*@}*/
        ...
        if (nextActionMillis > 0 && nextActionMillis < Long.MAX_VALUE) {
            Log.i(TAG, "scheduling start in " + nextActionMillis + "ms");
