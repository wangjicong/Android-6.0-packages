...
public class DownloadNotifier {
     ...
     */
     /* modify for keeping the download time in notification panel*/
    @GuardedBy("mActiveNotifs")
    private static final HashMap<String, Long> mActiveNotifs = Maps.newHashMap();
    ...
    private void updateWithLocked(Collection<DownloadInfo> downloads) {
        ...
        for (DownloadInfo info : downloads) {
            ...
            if(Constants.LOGVV) {
                Log.i(Constants.TAG, "DownloadNotifier updateWithLocked  tag == "+ tag);
            }
            if (tag != null) {
                /**
        ...
        for (String tag : clustered.keySet()) {
            ...
            if(Constants.LOGVV) {
                Log.i(Constants.TAG, "DownloadNotifier notify tag == "+ tag);
            }
