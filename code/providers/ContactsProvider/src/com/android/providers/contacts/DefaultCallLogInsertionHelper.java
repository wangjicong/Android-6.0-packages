...
//start - CallerIdSearch
        if (com.android.internal.telephony.CallerIDGeocodeHelper.isSupported()) {
            String location = com.android.internal.telephony.CallerIDGeocodeHelper.getGeoDescription(
                    mContext, values.getAsString(Calls.NUMBER));
            if (!TextUtils.isEmpty(location))
                values.put(Calls.GEOCODED_LOCATION, location);
        } else
//end - CallerIdSearch
