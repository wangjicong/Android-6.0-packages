...
*/
    ...
    private Cursor findOutSmsCursor(Uri url) {
    ...
    private Uri insertInner(Uri url, ContentValues initialValues, int callerUid, String callerPkg) {
        ...
        switch (match) {
            ...
            case SMS_ALL_ID:
                ...
                Cursor sms_cursor = findOutSmsCursor(url);
                if (sms_cursor != null) {
        ...
        if (table.equals(TABLE_SMS)) {
            ...
            if (((threadId == null) || (threadId == 0))
                ...
                if (MmsBackupStub.getInstance(getContext()).isEnable()) {
                    List<String> addressList = new ArrayList<String>();
                    addressList.add(address);
                    values.put(
                            Sms.THREAD_ID,
                            MmsBackupStub.getInstance(getContext())
                                    .getOrCreateThreadId(addressList,
