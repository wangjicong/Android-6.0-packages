...
public class TelephonyProvider extends ContentProvider
{
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private void createCarriersTable(SQLiteDatabase db, String tableName) {
            ...
            db.execSQL("CREATE TABLE " + tableName +
                    ...
                    "type TEXT DEFAULT ''," +
                    "current INTEGER," +
                    /* SPRD: 476104 Change default protocol to IPV4V6 @{ */
                    "protocol TEXT DEFAULT 'IPV4V6'," +
                    "roaming_protocol TEXT DEFAULT 'IPV4V6'," +
                    /* @} */
                    // SPRD: Add for some apn can't be edited.
                    "editable BOOLEAN," +
                    ...
                    // SPRD: Add to add the traffic class.
                    "traffic_class TEXT," +
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            /* SPRD: Modify carriers table when lower than 5.1 version upgrade to 6.0. @{ */
        ...
        private ContentValues getRow(XmlPullParser parser) {
            ...
            // SPRD: Add the traffic class.
            addStringAttribute(parser, "traffic_class", map, Telephony.Carriers.TRAFFIC_CLASS);
            ...
            // SPRD: Add for some apn can't be edited.
            addBoolAttribute(parser, "editable", map, Telephony.Carriers.EDITABLE);
        ...
        static public ContentValues setDefaultValue(ContentValues values) {
            ...
            /* SPRD: Add for some apn can't be edited @{ */
            if (!values.containsKey(Telephony.Carriers.EDITABLE)) {
                values.put(Telephony.Carriers.EDITABLE, true);
            }
            /* @} */
           /* SPRD: Set the traffic class default value is 2. @{ */
            if (!values.containsKey(Telephony.Carriers.TRAFFIC_CLASS)) {
                values.put(Telephony.Carriers.TRAFFIC_CLASS, "2");
            }
            /* @} */
    ...
    public boolean onCreate() {
        ...
        Intent intent = new Intent("android.intent.action.APN_LOAD_COMPLETED");
        intent.setFlags(Intent.FLAG_RECEIVER_REGISTERED_ONLY_BEFORE_BOOT);
        if (getContext() != null) {
            log("onCreate: Notify apn load completed.");
