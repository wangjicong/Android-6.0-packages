...
public class InstalledAppDetails extends AppInfoBase
    ...
    /* SPRD: 492525 ADD add whilte list for can not kill app @{ */
    ...
    private boolean handleDisableable(Button button) {
        ...
        /* SPRD: 492525: set the disenable button enabled. @{ */
        if (mkeepApp != null) {
    ...
    public void onCreate(Bundle icicle) {
        ...
        /* SPRD: 492525 get whilte list for not kill app @[ */
        final Resources resources = this.getResources();
        mkeepApp = resources.getStringArray(R.array.cannot_kill_app);
        /* @} */
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        // SPRD 522187 APP has been uninstalled,so the mAppEntry is null,add protection
        mUpdatedSysApp = mAppEntry == null ? false : (mAppEntry.info.flags 
    ...
    public void onClick(View v) {
        /* SPRD: for bug 500668 @{ */
        if (mAppEntry == null) {
            Toast.makeText(getActivity(), getString(R.string.does_not_exist),
