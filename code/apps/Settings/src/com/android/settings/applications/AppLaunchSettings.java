...
public class AppLaunchSettings extends AppInfoWithHeader implements OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // SPRD 508339 when mAppEntry is null rotating screen will kill acticity.
        /* SPRD: Add for bug 518800 @{ */
        if (mAppEntry == null) {
        /* @} */
            getActivity().finish();
            // SPRD 508339 when mAppEntry is null rotating screen will kill acticity.
    ...
    protected boolean refreshUi() {
        ...
        try {
            getActivity().getPackageManager().getPackageUid(mPackageName, UserHandle.myUserId());
