...
public final class ProcStatsEntry implements Parcelable {
    ...
    public void evaluateTargetPackage(PackageManager pm, ProcessStats stats,
        ...
        if (subProcs.size() > 1) {
            ...
            /*
             * SPRD 534675: for keep native code structure and less code change
             * ,we add null check for mBestTargetPackage and set the largest
             * weight proc's mPackage to it
             */
            if (mBestTargetPackage == null) {
                mBestTargetPackage = subProcs.get(0).mPackage;
            }
