...
public abstract class AppStateAppOpsBridge extends AppStateBaseBridge {
    ...
    public PermissionState getPermissionInfo(String pkg, int uid) {
        ...
        try {
            ...
            /* SPRD: modified for 526190 @{
             * After remove sdcard, the applications installed in sd card is also removed, so the
             * permissionState.packageInfo maybe null at this time */
            String[] requestedPermissions = null;
            int[] permissionFlags = null;
            if (permissionState.packageInfo != null){
                requestedPermissions = permissionState.packageInfo.requestedPermissions;
                permissionFlags = permissionState.packageInfo.requestedPermissionsFlags;
            }
            /* @} */
