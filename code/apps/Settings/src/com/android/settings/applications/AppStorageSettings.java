...
public class AppStorageSettings extends AppInfoWithHeader
    ...
    private void setupViews() {
        ...
        mChangeStorageButton = (Button) ((LayoutPreference) findPreference(KEY_CHANGE_STORAGE))
                .findViewById(/*SUN:jicong.wang modify for bug 53633 before  R.id.button*/R.id.button_change);
    ...
    private void refreshButtons() {
        ...
        if (!isMoveInProgress()) {
            initMoveDialog();
            initDataButtons();
            mChangeStorageButton.setEnabled(true);
        }else{
            mChangeStorageButton.setEnabled(false);
            mClearDataButton.setEnabled(false);
            mClearCacheButton.setEnabled(false);
        }
        /* @} */
