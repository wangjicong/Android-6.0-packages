...
public class NetworkPolicyEditor {
    ...
    public void read() {
        ...
        for (NetworkPolicy policy : policies) {
            ...
            /* Add for Bug 512829, 517908, if SubscriberId is null, and matchRule is not WIFI, do not add to the List @{ */
            if (policy.template != null && policy.template.getMatchRule() != NetworkTemplate.MATCH_WIFI
                      && policy.template.getSubscriberId() == null) {
                continue;
            }
            /* @} */
    ...
    public void setPolicyLimitBytes(NetworkTemplate template, long limitBytes) {
        ...
        if (template.getMatchRule() == MATCH_WIFI ||
            template.getMatchRule() == MATCH_WIFI_WILDCARD)
        {
