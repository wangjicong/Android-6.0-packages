...
public class ToggleAccessibilityServicePreferenceFragment
    ...
    public void onResume() {
        //SPRD 511424 serviceinfo will be null when the app is uninstalled
    ...
    public Dialog onCreateDialog(int dialogId) {
        switch (dialogId) {
            case DIALOG_ID_ENABLE_WARNING: {
                ...
                if (info == null) {
                    // SPRD:Modified for bug 528786,return a new dialog instead of return null
    ...
    protected void onInstallSwitchBarToggleSwitch() {
        ...
        mToggleSwitch.setOnBeforeCheckedChangeListener(new OnBeforeCheckedChangeListener() {
            ...
            public boolean onBeforeCheckedChanged(ToggleSwitch toggleSwitch, boolean checked) {
                /* SPRD: added for 526190 @{
                 * After remove the sd card, the application installed in sd card is also removed,
                 * so getAccessibilityServiceInfo() will be null at this time, just ignore the check
                 * behavior if info is null */
                AccessibilityServiceInfo info = getAccessibilityServiceInfo();
                if (info == null) {
                    return false;
                }
