...
/* SPRD Bug 498631 in setting, no assistanttouch, but can search assistanttouch @{ */
import android.os.SystemProperties;
/* @} */
/**
...
public class AccessibilitySettings extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    private static final String ASSISTANT_PREFERENCE_SCREEN =
            "assistant_preference_screen";
    ...
    // SPRD: add for assistant touch
    private PreferenceScreen mAssistantPreferenceScreen;
    /*Holster function switch --up161122@{*/
    private SwitchPreference mToggleHolsterFunctionPreference;
    /*Holster function switch --up161122@}*/
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (mSelectLongPressTimeoutPreference == preference) {
            ...
            return true;
		/*Holster function switch --up161122@{*/
        } else if (mToggleHolsterFunctionPreference == preference) {
            Settings.System.putInt(getContentResolver(), Settings.System.HOLSTER_FUNCTION,(Boolean) newValue ? 1 : 0);
			return true;
		/*Holster function switch --up161122@}*/
        }
        return false;
    ...
    private void initializeAllPreferences() {
        ...
        // SPRD: add for assistant touch
        mAssistantPreferenceScreen = (PreferenceScreen) findPreference(
            ASSISTANT_PREFERENCE_SCREEN);
		...
		/*Holster function switch --up161122@{*/
        mToggleHolsterFunctionPreference = (SwitchPreference) findPreference("toggle_holster_function_preference");
        mToggleHolsterFunctionPreference.setOnPreferenceChangeListener(this);
        if (!OptConfig.SUNVOV_HALLVIEW_CIRCLE_SUPPORT){
            mSystemsCategory.removePreference(mToggleHolsterFunctionPreference);
        } else {
             int default_flag = Settings.System.getInt(getContentResolver(), Settings.System.HOLSTER_FUNCTION,1);   
             mToggleHolsterFunctionPreference.setChecked(default_flag==1?true:false);
        }
		/*Holster function switch --up161122@}*/
    }
    ...
    private void updateServicesPreferences() {
        ...
        for (int i = 0, count = installedServices.size(); i < count; ++i) {
            ...
            if(OptConfig.SUNVOV_CUSTOM_C7301_XLL_FWVGA && ("com.google.android.marvin.talkback/com.android.switchaccess.SwitchAccessService".equals(preference.getKey()))){
               //wangxing add Remove switch access
            }else{
        ...
        /* Sprd: for bug 493210 @{ */
        mGlobalGesturePreferenceScreen.setEnabled(false);
        for (int i = 0; i < mServicesCategory.getPreferenceCount(); i++) {
            if ("TalkBack".equals(mServicesCategory.getPreference(i).getTitle())) {
                mGlobalGesturePreferenceScreen.setEnabled(true);
                break;
            }
        }
        /* @} */
    ...
    private void updateSystemPreferences() {
        ...
        if (assistantEnabled) {
            ...
            mSystemsCategory.removePreference(mAssistantPreferenceScreen);
        }
        // @}
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        ...
        public List<String> getNonIndexableKeys(Context context) {
            ...
            if (!SystemProperties.get("ro.product.assistanttouch").equals("1")) {
                result.add(ASSISTANT_PREFERENCE_SCREEN);
            }
            return result;
        }
        /* @} */
