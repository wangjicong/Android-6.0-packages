...
public class ZonePicker extends ListFragment {
    ...
    /* SPRD 492237 @{ */
    private static final int MENU_TIMEZONE = Menu.FIRST+2;
    private static final int MENU_PINGYIN = Menu.FIRST+1;
    /* @} */
    ...
    public static SimpleAdapter constructTimezoneAdapter(Context context,
        ...
        final String sortKey = (sortedByName ?  (isChineseLanguage() ? ZoneGetter.
                KEY_DISPLAYNAME_PINGYIN :ZoneGetter.KEY_DISPLAYNAME) : ZoneGetter.KEY_OFFSET);
        /* @} */
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        //SPRD 492237
        menu.add(0, MENU_PINGYIN, 0, R.string.zone_list_menu_sort_by_pinyin).setIcon(
                R.drawable.ic_menu_3d_globe);
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        if (!mSortedByTimezone) {
            menu.findItem(MENU_TIMEZONE).setVisible(true);
            menu.findItem(MENU_ALPHABETICAL).setVisible(false);
            menu.findItem(MENU_PINGYIN).setVisible(false);
        } else if (isChineseLanguage()) {
            menu.findItem(MENU_TIMEZONE).setVisible(false);
            menu.findItem(MENU_ALPHABETICAL).setVisible(false);
            menu.findItem(MENU_PINGYIN).setVisible(true);
        } else {
            menu.findItem(MENU_TIMEZONE).setVisible(false);
            menu.findItem(MENU_ALPHABETICAL).setVisible(true);
            menu.findItem(MENU_PINGYIN).setVisible(false);
