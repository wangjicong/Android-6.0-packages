...
public class ApnEditor extends InstrumentedPreferenceActivity
    ...
    // SPRD: Conmmon feature that apn can't be edited.
    private final static String IS_EDITABLE = "IS_EDITABLE";
    // SPRD: Add the trafficClass.
    ...
    // SPRD: Add the trafficClass.
    private ListPreference mTrafficClass;
    ...
    // SPRD: Add for Bug 492904.
    private boolean mIsApnErased = false;
    // SPRD: Common feature apn can't be edited.
    private boolean mIsEditable = true;
    // SPRD: Add the trafficClass.
    private boolean mIsSupportTrafficClass = false;
    // SPRD: Suppot Apn can be null.
    private boolean mSupportApnNull = false;
    ...
    private static final String[] sProjection = new String[] {
            ...
            // Just config apns-conf_8.xml.
            Telephony.Carriers.EDITABLE,  //23
            // SPRD: Add the trafficClass.
            Telephony.Carriers.TRAFFIC_CLASS  // 24
    };
    ...
    // SPRD: Add the trafficClass.
    private static final int TRAFFIC_CLASS_INDEX = 24;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        /* SPRD: Add the trafficClass. @{ */
        mIsSupportTrafficClass = SupportTrafficClassUtils.getInstance()
                .isSupportTracfficClass();
        /* @} */
        /* SPRD: Support Apn can be null. @{ */
        mSupportApnNull = SupportApnNullUtils.getInstance(getApplication())
                .IsSupportApnNull();
        /* @} */
        ...
        /* SPRD: Common feature that apn can't be edited. @{ */
        if (icicle != null) {
            mIsEditable = icicle.getBoolean(IS_EDITABLE, true);
    ...
    private void fillUi() {
        // SPRD: Make sure cursor moved to first.
        if (mFirstTime && mCursor.moveToFirst()) {
            mFirstTime = false;
            ...
            /* SPRD: Add the trafficClass. @{ */
            if (mIsSupportTrafficClass) {
                mTrafficClass.setValue(mCursor.getString(TRAFFIC_CLASS_INDEX));
            }
            /* @} */
            ...
            mIsEditable = ApnUtils.getInstance(getApplication()).getEditable(mCursor);
            /* @} */
    ...
    private String trafficClassDescription(String raw) {
        ...
        if (mTrafficClassIndex == -1) {
            ...
            String[] values = mRes
                    .getStringArray(R.array.traffic_class_entries);
            try {
            ...
            if (newValue != null && newValue.equals(oldValue) == false) {
                if (values[mvnoIndex].equals("SPN")) {
                    String operatorName = TeleUtils.updateOperator(
                            mTelephonyManager.getSimOperatorName(), "spn");
                    mMvnoMatchData.setText(operatorName);
                ...
                /* SPRD: Bug 538335 add support for MVNO type pnn @{ */
                    ...
                    mMvnoMatchData.setText(checkNull(mTelephonyManager.getPnnHomeName(mSubId)));
                }
                /* @} */
            }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (KEY_AUTH_TYPE.equals(key)) {
            ...
            /* SPRD: apn protocol showing problem for bug539540 @{ */
    ...
    protected void onSaveInstanceState(Bundle icicle) {
        ...
        // SPRD: Common feature that apn can't be edited.
        icicle.putBoolean(IS_EDITABLE, mIsEditable);
    }
    ...
    private boolean validateAndSave(boolean force) {
        /* SPRD: Add for Bug 492904.
         Sometimes the apn entry has been erased.but we need to save it now. @{ */
        if (mIsApnErased) {
        ...
        // SPRD: Suppot Apn can be null.
        if (force && mNewApn && name.length() < 1 && apn.length() < 1 && !mSupportApnNull) {
            getContentResolver().delete(mUri, null, null);
            // SPRD:Add for Bug 492904.
            mIsApnErased = true;
            return false;
        ...
        /* SPRD: Add the trafficClass @{ */
        if (mIsSupportTrafficClass) {
            String trafficClassVal = mTrafficClass.getValue();
            if (trafficClassVal != null) {
                values.put(Telephony.Carriers.TRAFFIC_CLASS, trafficClassVal);
            }
        }
        /* @} */
    ...
    private String getErrorMsg() {
        ...
        if (name.length() < 1) {
         ...
         // SPRD: Suppot Apn can be null.
        } else if (apn.length() < 1 && !mSupportApnNull) {
