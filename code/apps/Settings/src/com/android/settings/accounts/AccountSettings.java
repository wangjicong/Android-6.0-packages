...
public class AccountSettings extends SettingsPreferenceFragment
    ...
    private ArrayList<AccountPreference> getAccountTypePreferences(AuthenticatorHelper helper,
        ...
        for (int i = 0; i < accountTypes.length; i++) {
            ...
            if (label != null && accountType.equals("com.android.email")) {
                label = getActivity().getString(R.string.header_category_personal);
            }
            /* @} */
    ...
    /* SPRD 539066 add "Account" search function@{ */
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        ...
        public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
            ...
            indexable.xmlResId = R.xml.account_settings;
