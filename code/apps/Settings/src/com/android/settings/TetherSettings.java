...
public class TetherSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (mUsbTether != null && !orignal_support) {
            getPreferenceScreen().removePreference(mUsbTether);
        }
        /* @} */
    ...
    private class TetherChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context content, Intent intent) {
            ...
            if (action.equals(ConnectivityManager.ACTION_TETHER_STATE_CHANGED)) {
                ...
                // SPRD: Reset mTetherChoice when BT is power off  and mTetherChoice is WIFI_TETHERING.
            ...
            /*
             * SPRD: Add a judge that if action equals
             * BluetoothPan.ACTION_CONNECTION_STATE_CHANGED, update
             * summary instantly. @{
             */
            ...
            // SPRD: reset mTetherChoice when softap is disabled and mTetherChoice is WIFI_TETHERING.
    ...
    public void onStart() {
        ...
        // SPRD: Add a action that PAN ACTION_CONNECTION_STATE_CHANGED.
        ...
        //SPRD: add for softap and bt conexit
    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        /* SPRD: modified for softap and bt coexit @{ */
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen screen, Preference preference) {
        ...
        if (preference == mUsbTether) {
            ...
            // SPRD: Do not show the showing dialog.
