...
public class DeviceAdminAdd extends Activity {
    ...
    protected void onResume() {
        ...
        //qiuyaobo,20170511, for sprd SPCSS00380647, begin
        ...
        mCurSysAppOpMode = mAppOps.checkOpNoThrow(AppOpsManager.OP_SYSTEM_ALERT_WINDOW, uid, pkg);
        mCurToastAppOpMode = mAppOps.checkOpNoThrow(AppOpsManager.OP_TOAST_WINDOW, uid, pkg);
        //qiuyaobo,20170511, for sprd SPCSS00380647, end
