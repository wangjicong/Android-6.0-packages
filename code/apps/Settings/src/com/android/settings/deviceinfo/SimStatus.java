...
public class SimStatus extends InstrumentedPreferenceActivity {
    ...
    private void updateNetworkType() {
        ...
        if(OptConfig.SUN_2G3G4G_SUPPORT){
            int primaryCard = Settings.Global.getInt(getContentResolver(), Settings.Global.SERVICE_PRIMARY_CARD,-1);           
            int settingsNetworkMode = RILConstants.PREFERRED_NETWORK_MODE;
                                
            if(primaryCard == SubscriptionManager.getPhoneId(mSir.getSubscriptionId())){
                if (mPhone != null){
    ...
    private void updatePhoneInfos() {
        if (mSir != null) {
            ...
            if (UserHandle.myUserId() == UserHandle.USER_OWNER
                ...
                mPhone = phone;
                /* SPRD Add: Bug#513912 @{
                 * To avoid two SIMs and more than one PhoneStateListener updating UI.*/
