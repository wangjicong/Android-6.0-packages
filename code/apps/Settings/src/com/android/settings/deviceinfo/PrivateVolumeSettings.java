...
public class PrivateVolumeSettings extends SettingsPreferenceFragment {
    ...
    public void update() {
        ...
        if(VolumeInfo.ID_PRIVATE_INTERNAL.equals(mVolume.getId())&&(OptConfig.SUN_MEMORY_INFO_32G||OptConfig.SUN_MEMORY_INFO_16G || OptConfig.SUN_MEMORY_INFO_8G)){
            ...
            usedBytes = TotalSpace*(1000*(usedBytes)/file.getTotalSpace())/1000;
