...
public class PublicVolumeSettings extends SettingsPreferenceFragment {
    ...
    //private Preference mSetPrimary;
    ...
    public void onCreate(Bundle icicle) {
        ...
        /* SPRD: add for storage manage, disable switch primary storage @{ */
        //mSetPrimary = buildAction(R.string.storage_menu_set_primary);
        /* @} */
    }
    ...
    public void update() {
        ...
        /* SPRD: add for storage manage, disable switch primary storage @{
        final VolumeInfo primaryVol = getActivity().getPackageManager()
                .getPrimaryStorageCurrentVolume();
        if (mVolume.linkName.startsWith("sdcard0")
           || mVolume.linkName.startsWith("sdcard1")) {
            if ((primaryVol == null) || !Objects.equals(mVolume, primaryVol)) {
                addPreference(mSetPrimary);
            }
        }
         @} */
    }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference pref) {
        ...
        } else if (pref == mSetPrimary) {
            final Intent intent = new Intent(context, StorageWizardMigrateConfirm.class);
            intent.putExtra(VolumeInfo.EXTRA_VOLUME_ID, mVolume.getId());
            intent.putExtra(StorageWizardMigrateConfirm.SET_PRIMARY, true);
            startActivity(intent);
         @} */
        }
