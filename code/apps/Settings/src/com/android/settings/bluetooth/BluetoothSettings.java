...
public final class BluetoothSettings extends DeviceListPreferenceFragment implements Indexable {
    ...
    private AtomicBoolean mDialogShow = new AtomicBoolean(false);
    ...
    public void onResume() {
        ...
        // SPRD: the Search devices icon disappeared when re-enter.
        super.onResume();
    }
    ...
    private void startScanning() {
        ...
        if (mAvailableDevicesCategory != null) {
            ...
            // SPRD: Don't clear device list before start discovery
            //removeAllDevices();
        }
        ...
        switch (bluetoothState) {
            case BluetoothAdapter.STATE_ON:
                ...
                addDeviceCategory(mAvailableDevicesCategory,
                        ...
                        BluetoothDeviceFilter.UNBONDED_DEVICE_FILTER, true);
                ...
                // SPRD: if none of paired devices then startScaning
                if (numberOfPairedDevices <=0 && !mInitialScanStarted) {
                    startScanning();
                }
    ...
    private final View.OnClickListener mDeviceProfilesListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            //v.setEnabled(false);
            if (DeviceProfilesSettings.isDialogShow() == true) {
                return;
            }
