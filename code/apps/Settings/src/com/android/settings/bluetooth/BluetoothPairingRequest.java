        ...
        if (action.equals(BluetoothDevice.ACTION_PAIRING_REQUEST)) {
            ...
            if (type == BluetoothDevice.PAIRING_VARIANT_PASSKEY_CONFIRMATION ||
                ...
                if (pairingKey == BluetoothDevice.ERROR) {
                    Log.e(TAG, "Invalid Passkey received , pairingKey = "+ pairingKey);
                    return;
                }
                pairingIntent.putExtra(BluetoothDevice.EXTRA_PAIRING_KEY, pairingKey);
            }
            pairingIntent.setAction(BluetoothDevice.ACTION_PAIRING_REQUEST);
            // SPRD: Add for Increase priority of the Broadcast BluetoothDevice.ACTION_PAIRING_REQUEST.
            pairingIntent.addFlags(Intent.FLAG_RECEIVER_FOREGROUND);
            ...
            if (powerManager.isScreenOn() &&
                ...
                if (!powerManager.isScreenOn()) {
                // SPRD: add to makesure that a notification will appear when screeoff
                    context.startActivity(pairingIntent);
                }
