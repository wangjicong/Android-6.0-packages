...
public final class Ranking {
    ...
    //SPRD 492910
    public static final int RANK_MEMORY = 23;
    //SPRD 494558 ,add the search for Timer Switch Machine
    public static final int RANK_ALARM_CLOCK = 24;
    // SPRD: Bug 511228 Smart Controls in Settings
    public static final int RANK_SMART_CONTROLS = 25;
    // SPRD: Bug 539066  add "Account" search function
    public static final int RANK_ACCOUNT_SETTINGS = 26;
    ...
    static {
        ...
        // SPRD: Bug 539066  add "Account" search function
        sRankMap.put(AccountSettings.class.getName(), RANK_ACCOUNT_SETTINGS);
        // SPRD: Bug 536583 Add the search for Agps Location
