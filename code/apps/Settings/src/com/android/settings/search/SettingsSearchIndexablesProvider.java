...
public class SettingsSearchIndexablesProvider extends SearchIndexablesProvider {
    ...
    public Cursor queryXmlResources(String[] projection) {
        ...
        for (SearchIndexableResource val : values) {
            ...
            @{ */
            ref[COLUMN_INDEX_XML_RES_INTENT_ACTION] = val.intentAction;//intent action
            ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_PACKAGE] = val.intentTargetPackage;//intent target package
            ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_CLASS] = val.intentTargetClass;//intent targetclass
            /* @} */
            cursor.addRow(ref);
        }
        return cursor;
