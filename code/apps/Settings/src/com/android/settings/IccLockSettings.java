...
public class IccLockSettings extends InstrumentedPreferenceActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (numSims > 1) {
            ...
            SubscriptionInfo sir = sm.getActiveSubscriptionInfoForSimSlotIndex(prevTabId);
        ...
        mRes = getResources();
        updatePreferences();
        /* SPRD: modify by bug #494113 @{ */
        getContentResolver().registerContentObserver(
                Settings.Global.getUriFor(Settings.Global.RADIO_OPERATION),
                true, mRadioBusyObserver);
        /* @} */
    }
    ...
    private void updatePreferences() {
        ...
        if (mPhone == null
                ...
                || tm.getSimState(mSlotId) != TelephonyManager.SIM_STATE_READY
                || mPhone.getServiceState().getState() == ServiceState.STATE_POWER_OFF
                || tm.isAirplaneModeOn()
                || tm.isRadioBusy()
                || !tm.isSimStandby(mSlotId)) {
            mPinDialog.setEnabled(false);
            mPinToggle.setEnabled(false);
            // SPRD: modify by bug #498761.
    ...
    private ContentObserver mRadioBusyObserver = new ContentObserver(
            new Handler()) {
        @Override
    ...
    protected void onSaveInstanceState(Bundle out) {
        ...
        if (mPinDialog.isDialogOpen()) {
            ...
            // SPRD: See bug #496369
            out.putInt(SLOT_ID, mSlotId);
            // SPRD: save the cursorPosition for bug 496971
            out.putInt(CURSOR_POSITION, mPinDialog.getEditText().getSelectionEnd());
