...
public class PowerUsageSummary extends PowerUsageBase {
    ...
    public void onCreate(Bundle icicle) {
        ...
        /*SUN:jicong.wang modify for battery percent start {@*/
        if (!getResources().getBoolean(com.android.internal.R.bool.config_batterypercent_available)){
            getPreferenceScreen().removePreference(mBatteryPercentagePref);
        }
        /*SUN:jicong.wang modify for battery percent end @}*/
        /* @} */
        ...
        "battery_percentage_enabled", 0, UserHandle.USER_OWNER) == 1);
        ...
        if(OptConfig.SUN_C7359_C5D_FWVGA_CHERRY){//Kalyy
            mAppListGroup.removePreference(mHeartBeatSyncSettings);
        }
        /*SUN:jicong.wang add remove battery history start {@*/
        if (getResources().getBoolean(com.android.internal.R.bool.def_remove_battery_history)){
            getPreferenceScreen().removePreference(mHistPref);
        }
        /*SUN:jicong.wang add remove battery history end @}*/
