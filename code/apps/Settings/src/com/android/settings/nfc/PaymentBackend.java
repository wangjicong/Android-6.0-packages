...
public class PaymentBackend {
    ...
    public void refresh() {
        ...
        List<ApduServiceInfo> serviceInfos = null;
        if(mCardEmuManager != null ){
           serviceInfos = mCardEmuManager.getServices(CardEmulation.CATEGORY_PAYMENT);
        }
