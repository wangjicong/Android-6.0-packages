...
public class TtsEngineSettingsFragment extends SettingsPreferenceFragment implements
    ...
    private void updateDefaultLocalePref(ArrayList<String> availableLangs) {
        ...
        for (int i = 0; i < availableLangs.size(); i++) {
            ...
            if (locale != null){
                /* SPRD: Modify for bug517440 @{ */
                String displayName = new StringBuffer()
                    .append(Character.toUpperCase(locale.getDisplayName().charAt(0)))
                    .append(locale.getDisplayName().substring(1))
                    .toString();
