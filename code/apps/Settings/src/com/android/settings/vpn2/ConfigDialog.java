...
class ConfigDialog extends AlertDialog implements TextWatcher,
    ...
    //SPRD: Bug 438153 add for limite vpn name length.
    ...
    protected void onCreate(Bundle savedState) {
        ...
        /* SPRD: Bug438153 add for limite vpn name length. @{ */
        mName.setFilters(new InputFilter[] {new InputFilter.LengthFilter(MAX_NAME_LENGTH)});
        mName.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (length >= MAX_NAME_LENGTH) {
                    Toast.makeText(getContext(), R.string.name_too_long, Toast.LENGTH_SHORT).show();
                }
            }
        });
        /* @}*/
