...
import com.sprd.android.config.OptConfig;//qiuyaobo,20170323
/**
...
public class SettingsAppWidgetProvider extends AppWidgetProvider {
    ...
    private static boolean supportBtWifiSoftApCoexit = !SystemProperties.get("ro.btwifisoftap.coexist", "true").equals("false");
        ...
        // SPRD: Modify for bug544913.
            ...
            if (buttonId == BUTTON_WIFI) {
                ...
                if (!supportBtWifiSoftApCoexit) {
                    ...
                    if (wifiManager.isSoftapEnablingOrEnabled()) {
                        Toast.makeText(context,
                                R.string.bt_softap_cannot_coexist,
