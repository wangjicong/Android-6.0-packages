...
public class ChartGridView extends View {
    ...
    private static final int MEDIUM_TEXT_SIZE = 18;//value of system medium font size
    ...
    public ChartGridView(Context context, AttributeSet attrs, int defStyle) {
        ...
        /* SPRD: added for 520985.
           To avoid mLabelStart overlapping with mLabelMid, limit the font size. @{ */
        if (mLabelSize > MEDIUM_TEXT_SIZE) {
            mLabelSize = MEDIUM_TEXT_SIZE;
        }
        /* @} */
        ta.recycle();
