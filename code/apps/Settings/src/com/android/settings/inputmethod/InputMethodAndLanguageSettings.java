...
public class InputMethodAndLanguageSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        /* SPRD: add for Orange sim language */
        SimLangListUtils.getInstance(activity).setPreferenceByCardForOrange(this);
    }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference instanceof PreferenceScreen) {
            ...
            /* SPRD: add for Orange sim language @{ */
            if(KEY_SIM_STORED_LANG_EDIT.equals(preference.getKey())) {
                SimLangListUtils.getInstance(getActivity()).startActivityByCards(getActivity());
                return true;
            }
            /* @} */
