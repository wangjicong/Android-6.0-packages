...
import android.util.Log;//jxl add
import com.sprd.android.config.OptConfig;//jxl
    ...
    public static TreeSet<String> getUserDictionaryLocalesSet(Context context) {
        ...
        for (final InputMethodInfo imi : imis) {
            ...
            for (InputMethodSubtype subtype : subtypes) {
                ...
                if(OptConfig.SUN_CUSTOM_C7356_XT_HVGA_SUPPORT){//jxl add to remove zz
                if (!TextUtils.isEmpty(locale) && !"zz".equals(locale)) {
