...
public final class Alarm implements Parcelable {
    ...
    public Alarm(Context context,Cursor c) {
        ...
        if (Alarms.ALARM_ALERT_SILENT.equals(alertString)) {
            ...
            if (alertString != null && alertString.length() != 0) {
                ...
                // Get the sdcard path from database.
                String[] data = { MediaStore.Audio.Media.DATA };
                Log.v("timerpower Alarm =====  else data :::: "+data.toString());
                Cursor cursor = null;
                try {
                    /*cursor = ((Activity) context).managedQuery(alert, data,
                            null, null, null);*/
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public String getLabelOrDefault(Context context) {
        if (label == null || label.length() == 0) {
            return /*context.getString(R.string.default_label)*/"test";
        }
        return label;
    }
    ...
    static final class DaysOfWeek {
        ...
        public String toString(Context context, boolean showNever) {
            ...
            /* SPRD: 433610 show short weekdays @{ */
