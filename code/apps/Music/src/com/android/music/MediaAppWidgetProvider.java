...
public class MediaAppWidgetProvider extends AppWidgetProvider {
    ...
    void notifyChange(MediaPlaybackService service, String what) {
        if (hasInstances(service)) {
            if (MediaPlaybackService.META_CHANGED.equals(what) ||
                ...
                /* SPRD 476972  @{*/
                performUpdate(service, null, null);
            }
            /* SPRD 476972  @{*/
            if (MediaPlaybackService.SERVICE_DESTROY.equals(what)) {
                performUpdate(service, null, MediaPlaybackService.SERVICE_DESTROY);
            }
            /* @} */
        }
    }
     ...
     */
    /* SPRD 476972  @{*/
    void performUpdate(MediaPlaybackService service, int[] appWidgetIds, String what) {
    ...
    private void linkButtons(Context context, RemoteViews views, boolean playerActive) {
        ...
        views.setOnClickPendingIntent(R.id.control_pre, pendingIntent);
        /* @} */
    }
}
