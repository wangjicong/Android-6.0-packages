...
public class MediaPlaybackService extends Service {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case TRACK_WENT_TO_NEXT:
                    ...
                    break;
                case TRACK_ENDED:
                    Log.i(LOGTAG,"TRACK_ENDED mPlayPos = " + mPlayPos +"mRepeatMode =" +mRepeatMode );
                    if (mRepeatMode == REPEAT_CURRENT) {
                        /* SPRD 476972 @{ */
                        if (!mSetNextPlayerEnable && MusicDRM.getInstance().isDRM(mCursor)) {
                            stop(false);
                            openCurrentAndNext();
                            play();
                            notifyChange(META_CHANGED);
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.i(LOGTAG, "mIntentReceiver.onReceive " + action + " / "+ (cmd != null ? cmd : " is null"));
            if (CMDNEXT.equals(cmd) || NEXT_ACTION.equals(action)) {
                ...
                /* SPRD 476972 @{ */
                mAppWidgetProvider.performUpdate(MediaPlaybackService.this, appWidgetIds, null);
            }
            /* SPRD 476974 @{ */
    ...
    public void onDestroy() {
       Log.d(LOGTAG, "onDestroy");
        ...
        /* SPRD 476972 @{ */
        mAppWidgetProvider.notifyChange(this, SERVICE_DESTROY);
            ...
            while(true) {
                ...
                if (mOpenFailedCounter++ < 10 &&  mPlayListLen > 1) {
                    ...
                    if (pos < 0) {
                        ...
                        Log.d(LOGTAG, "Failed to open file for playback and have no songs");
                        /* @} */
                        if (mIsSupposedToBePlaying) {
                            mIsSupposedToBePlaying = false;
                    ...
                    mPlayPos = pos;
                    mCursor = getCursorForId(mPlayList[mPlayPos]);
                    Log.i(LOGTAG,"mPlayPos =" +mPlayPos);
                } else {
                    mOpenFailedCounter = 0;
                    if (!mQuietMode) {
                        /* SPRD 476972 @{ */
                    ...
                    /// SPRD: Clear playlist and history when open failed times more than OPEN_FAILED_MAX_COUNT
                    /// or all the playlist songs have opened failed. {@
                    Log.d(LOGTAG, "clear palylist and position when open failed: mPlayListLen = " + mPlayListLen);
                    /* SPRD 476972 @{ */
                    mHistory.clear();
                    mPlayPos = -1;
                    mNextPlayPos = -1;
    ...
    private void setNextTrack() {
        ...
        /* SPRD 476972 @{ */
        if (mNextPlayPos >= 0 && (mRepeatMode != REPEAT_CURRENT || MusicDRM.getInstance().isDRM(mCursor)) ) {
    ...
    public boolean open(String path) {
        synchronized (this) {
            ...
            /* SPRD 476978 @{ */
            if (MusicDRM.getInstance().openIsInvaildDrm(mCursor)) {
                stop(true);
                return false;
            }
            /* @} */
     ...
     */
    public void play() {
        Log.i(LOGTAG,"mPlayFromFocusGain= " +mPlayFromFocusGain + "mPlayFromFocusCanDuck = " +mPlayFromFocusCanDuck);
        /* SPRD 476974 @{ */
        if (!mPlayFromFocusGain && !mPlayFromFocusCanDuck) {
            if (mAudioManager.requestAudioFocus(mAudioFocusListener,
                    AudioManager.STREAM_MUSIC, AudioManager.AUDIOFOCUS_GAIN)
                == AudioManager.AUDIOFOCUS_REQUEST_FAILED) {
                mMediaplayerHandler.post(new Runnable() {
                    public void run() {
                        Toast.makeText(MediaPlaybackService.this, R.string.no_play,
        ...
        if (mPlayer != null && mPlayer.isInitialized()) {
            ...
            /* SPRD 490526 If can duck is true,it means another player is still playing,
             * so don't set volumn up @{ */
            ...
            if(OptConfig.SUN_BREATHINGLIGHT){
                Intent breathLightIntent = new Intent("system.media.play");
    ...
    private void updateNotification() {
        /* SPRD 476963 @{ */
        Log.i(LOGTAG, "updateNotification()");
        ...
        if(bmp == null) {
            ...
            mStatusBarViews.setImageViewBitmap(R.id.icon, bmp);
        }
        String artist = getArtistName();
        mStatusBarViews.setTextViewText(R.id.trackname, getTrackName());
        ...
        mStatusBarViews.setTextViewText(R.id.artistalbum,
                getString(R.string.notification_artist_album, artist, album));

        if (mIsSupposedToBePlaying) {
            mStatusBarViews.setImageViewResource(R.id.toggle_btn, R.drawable.ic_media_pause);
        } else {
            mStatusBarViews.setImageViewResource(R.id.toggle_btn, R.drawable.ic_media_play);
        }
    ...
    private void gotoIdleState() {
		...
		/*SUN:jicong.wang add for SUN_BREATHINGLIGHT start {@*/
        if(OptConfig.SUN_BREATHINGLIGHT){
            Log.d("yanghua", "---gotoIdleState---");
            Intent breathLightIntent = new Intent("system.media.stop");
            sendBroadcast(breathLightIntent);
        }
		/*SUN:jicong.wang add for SUN_BREATHINGLIGHT end @}*/
        /* SPRD 476972 @{ */
        //stopForeground(true);
    ...
    public int removeTracks(int first, int last) {
        Log.d(LOGTAG, "removeTracks()-first = " + first + ",last = "
                + last);
    ...
    private class MultiPlayer {
        ...
        public void setNextDataSource(String path) {
            ...
            //SPRD 476978
            if ((mRepeatMode != REPEAT_CURRENT) && nextTrackIsDRM()) return;
    ...
    /*  SPRD 476978 @{*/
    public String getAudioData() {
        return MusicDRM.getInstance().getAudioData(mCursor);
    }
     ...
     */
    public boolean getAudioIsDRM() {
        return MusicDRM.getInstance().getAudioIsDRM(mCursor);
    }
