...
public class RecurrencePickerDialog extends DialogFragment implements OnItemSelectedListener,
    ...
    /* SPRD: Modify bug399152/440383/493139, Screen switching, time display does not match. @{ */
    private long mTimeMillis;
    private static final String TIME_ZONE = "timeZone";
    private static final String TIME_MILLIS = "timeMillis";
    private static final String  MONTHREPEATBYDAYOFWEEK= "MonthRepeatByDayOfWeek";
    /* @} */
    ...
    private static class RecurrenceModel implements Parcelable {
        ...
        /* SPRD: bug487597/514176 android.os.BadParcelableException@{ */
        public RecurrenceModel(Parcel dest) {
            /* SPRD: bug514887 android.os.BadParcelableException@{ */
            if (null == endDate) {
                endDate = new Time();
            }
            /* @} */
            freq = dest.readInt();
            interval = dest.readInt();
            end = dest.readInt();
            endDate.year = dest.readInt();
            endDate.month = dest.readInt();
            endDate.monthDay = dest.readInt();
            endCount = dest.readInt();
            dest.readBooleanArray(weeklyByDayOfWeek);
            monthlyRepeat = dest.readInt();
            monthlyByMonthDay = dest.readInt();
            monthlyByDayOfWeek = dest.readInt();
            monthlyByNthDayOfWeek = dest.readInt();
            recurrenceState = dest.readInt();
        }
    ...
    static private void copyModelToEventRecurrence(final RecurrenceModel model,
        ...
        switch (model.end) {
            case RecurrenceModel.END_BY_DATE:
                if (model.endDate != null) {
                    //SPRD: change for bug438669/bug491638 do not need switch timeZone
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (savedInstanceState != null) {
            ...
            /* SPRD: Modify bug399152/440383/493139, Screen switching, time display does not match. @{ */
            mMonthRepeatByDayOfWeekStr = (String) savedInstanceState.get(MONTHREPEATBYDAYOFWEEK);

            mTime.set((long) savedInstanceState.get(TIME_MILLIS));
            String tz = (String) savedInstanceState.get(TIME_ZONE);
            ...
            if (b != null) {
                ...
                /* SPRD: Modify bug399152/511450, Screen switching, time display does not match. @{ */
                mTimeMillis = b.getLong(BUNDLE_START_TIME_MILLIS);
                /* @} */
        ...
        if (mModel.endDate == null) {
            ...
            /*SPRD for bug446277 Repeat date more than December 31, 2037 @{*/
            if ((mModel.endDate.year >= Utils.YEAR_MAX && mModel.endDate.month > Utils.MONTH_MAX)
                    || mModel.endDate.year > Utils.YEAR_MAX) {
                mModel.endDate.year = Utils.YEAR_MAX;
                mModel.endDate.month = Utils.MONTH_MAX;
                mModel.endDate.monthDay = Utils.DAY_MAX;
            }
            /* @} */
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        /* SPRD: Modify bug399152/440383/493139, Screen switching, time display does not match. @{ */
        outState.putString(TIME_ZONE, mTime.timezone);
        outState.putLong(TIME_MILLIS, mTimeMillis);
        outState.putString(MONTHREPEATBYDAYOFWEEK, mMonthRepeatByDayOfWeekStr);
        /* @} */
