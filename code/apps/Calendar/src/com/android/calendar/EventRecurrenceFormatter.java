...
public class EventRecurrenceFormatter
{
    ...
    public static String getRepeatString(Context context, Resources r, EventRecurrence recurrence,
        ...
        switch (recurrence.freq) {
            ...
            case EventRecurrence.MONTHLY: {
                ...
                if (recurrence.bydayCount == 1 && recurrence.startDate != null) {
    ...
    /* SPRD for bug449438/501157, set MonthRepeatByDayOfWeekStrs =Null if mMonthRepeatByDayOfWeekStrs != null @{*/
    public static void setMonthRepeatByDayOfWeekStrsNull(){
        if (mMonthRepeatByDayOfWeekStrs != null) {
            mMonthRepeatByDayOfWeekStrs = null;
        }
    }
    /* @} */
}
