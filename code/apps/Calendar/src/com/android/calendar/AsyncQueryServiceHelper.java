...
public class AsyncQueryServiceHelper extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        /*
         * SPRD: modify for bug 513212/522251
         * catch SQLiteDiskIOException and SQLiteFullException @{
         */
        ...
        if (resolver != null) {
            ...
            switch (args.op) {
                case Operation.EVENT_ARG_QUERY:
                    ...
                    try {
                        ...
                        Log.w(TAG, "EVENT_ARG_QUERY"+ e.toString());
                        sqliteException = e;
                ...
                case Operation.EVENT_ARG_INSERT:
                    try{
                        ...
                        sqliteException = e;
                        Log.w(TAG, "EVENT_ARG_INSERT"+ e.toString());
                    } catch (SQLiteDiskIOException e) {
                        sqliteException = e;
                        Log.w(TAG, "EVENT_ARG_INSERT"+ e.toString());
                    }
                ...
                case Operation.EVENT_ARG_UPDATE:
                    ...
                    /* SPRD: bug522251, when the memory is high, app will throw SQLiteDiskIOException. @} */
                    try {
                        args.result = resolver.update(args.uri, args.values, args.selection,
                                args.selectionArgs);
                    } catch (SQLiteFullException e) {
                        sqliteException = e;
                        Log.w(TAG, "EVENT_ARG_UPDATE"+ e.toString());
                    } catch (SQLiteDiskIOException e) {
                        sqliteException = e;
                        Log.w(TAG, "EVENT_ARG_UPDATE"+ e.toString());
                    } catch (RuntimeException e) {
                        Log.d(TAG, "AsyncQueryServiceHelper RuntimeException");
                        args.result = 0;
                    }
                    /* @} */
                    break;
                ...
                case Operation.EVENT_ARG_DELETE:
                    try {
                        ...
                        sqliteException = e;
                        Log.w(TAG, "EVENT_ARG_DELETE"+ e.toString());
                    } catch (SQLiteDiskIOException e) {
                        sqliteException = e;
                        Log.w(TAG, "EVENT_ARG_DELETE"+ e.toString());
                    }
                ...
                case Operation.EVENT_ARG_BATCH:
                    try {
                        ...
                        sqliteException = e;
                        Log.w(TAG, "EVENT_ARG_BATCH"+ e.toString());
                    } catch (SQLiteDiskIOException e) {
                        sqliteException = e;
                        Log.w(TAG, "EVENT_ARG_BATCH"+ e.toString());
            ...
            if (sqliteException != null && (sqliteException instanceof SQLiteFullException
                    || sqliteException instanceof SQLiteDiskIOException || sqliteException instanceof SQLiteException)) {
                args.result = sqliteException;
            }
            /* @} */
            reply.sendToTarget();
        }
