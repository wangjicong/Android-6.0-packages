...
public class CalendarAppWidgetService extends RemoteViewsService {
    ...
    public static class CalendarFactory extends BroadcastReceiver implements
        ...
        //SPRD: Modify 20150117 of Bug394985, change the time zone.
        private static String sLastUpdateTimeZone;
        ...
        public void onCreate() {
            ...
            mNeedRequestPermissions = Utils.checkPermissions(mContext);
        ...
        public void onLoadComplete(Loader<Cursor> loader, Cursor cursor) {
            ...
            synchronized (mLock) {
                ...
                if (time.normalize(true) != sLastUpdateTime) {
                    //SPRD: Modify 20150117 of Bug394985, change the time zone.
                    Time time2 = new Time(sLastUpdateTimeZone != null ? sLastUpdateTimeZone
                            : Utils.getTimeZone(mContext, null));
        ...
        public void onReceive(Context context, Intent intent) {
            /* SPRD: bug516811, check runtime permissions @{ */
