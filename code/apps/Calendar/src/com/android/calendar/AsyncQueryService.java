...
public class AsyncQueryService extends Handler {
    ...
    /* SPRD: fix bug 513212/522251 when the memory is high,app will throw SQLiteDiskIOException @{ */
    ...
    /* SPRD: fix bug 513212/522251 When memory is too high, prompt to user @{ */
    ...
    public void handleMessage(Message msg) {
        ...
        /* SPRD: for bug 513212/522251 When memory is too high, prompt to user @{ */
        if(info != null && info.result != null && (info.result instanceof SQLiteFullException
                || info.result instanceof SQLiteDiskIOException || info.result instanceof SQLiteException)){
