...
public class SelectSyncedCalendarsMultiAccountAdapter extends CursorTreeAdapter implements
    ...
    //SPRD for bug 455231/474232, Local Calendar can not Synced
    private static String mCanNotSyncedText;
    ...
    public SelectSyncedCalendarsMultiAccountAdapter(Context context, Cursor acctsCursor,
        ...
        //SPRD for bug 455231/474232, Local Calendar can not Synced
        mCanNotSyncedText = context.getString(R.string.can_not_synced);
    ...
    protected void bindChildView(View view, Context context, Cursor cursor, boolean isLastChild) {
        ...
        if (name.equals("Local Calendar")) {
            name = context.getResources().getString(R.string.local_account);
        }
        if (owner.equals("Local Calendar")) {
            owner = context.getResources().getString(R.string.local_account);
        }
        /* @} */
        ...
        /* SPRD for bug 455231/474232,Local Calendar can not Synced @{*/
        if (cursor.getString(NAME_COLUMN).equals("Local Calendar")
                || cursor.getString(OWNER_COLUMN).equals("Local Calendar")) {
            if (view != null && button != null) {
                setText(view, R.id.status, mCanNotSyncedText);
            ...
            if (view != null && button != null) {
                ...
                //SPRD: add for bug537029, the status of some CheckBoxes can not be changed
    ...
    protected void bindGroupView(View view, Context context, Cursor cursor, boolean isExpanded) {
        ...
        /* SPRD: Add  20150914 of bug 474232, add local account @{ */
        if (account.equals("Local Calendar")) {
            account = context.getResources().getString(R.string.local_account);
        }
        if (getLabelForType(accountType) == null) {
            accountType = context.getResources().getString(R.string.local_account);
        } else {
            accountType = getLabelForType(accountType).toString();
        }
