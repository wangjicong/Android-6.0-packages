...
public class AttendeesView extends LinearLayout implements View.OnClickListener {
    ...
    private View updateAttendeeView(AttendeeItem item) {
        ...
        /* SPRD Modify for bug451704/500118, if cache is not up to date, update it @{ */
        /* SPRD Modify for bug457060, contacts photo not update when delete in calendar @{ */
        /* Drawable badge = null;
        ...
        /* @} */
        mRecycledPhotos.put(item.mAttendee.mEmail, item.mBadge);
    ...
    private void addOneAttendee(Attendee attendee) {
        ...
        // SPRD Modify for bug451704/500118, if it has a cache, use mRecycledPhotos
        final AttendeeItem item = new AttendeeItem(attendee,
                mRecycledPhotos.get(attendee.mEmail) != null ? mRecycledPhotos
                        .get(attendee.mEmail) : mDefaultBadge);
