...
public class AlertActivity extends Activity implements OnClickListener {
    ...
    private DismissAlarmsReceiver receiver;
    ...
    protected void onResume() {
        ...
        receiver = new DismissAlarmsReceiver();
        IntentFilter filter = new IntentFilter(Utils.ACTION_CLOSE_EMPTY_DIALOGS);
        ...
        AsyncTask task = new AsyncTask<Context, Void, Void>() {
            ...
            protected Void doInBackground(Context ... params) {
                ...
                try {
                    ...
                    Log.d(TAG, "AlertActivity RuntimeException");
                }
                /* @} */
                return null;
            }
    ...
    /* SPRD: Modify for bug396165/502497, Cancel event reminders, dialog does not disappear. @{ */
    private class DismissAlarmsReceiver extends BroadcastReceiver {
        @Override
        public void onReceive(Context context, Intent intent) {

            String action = intent.getAction();
            if (action.equals(Utils.ACTION_CLOSE_EMPTY_DIALOGS)) {
                AlertActivity.this.finish();
            }
        }
    }
