...
public class AlertReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        /* SPRD: bug505674, request runtime permissions @} */
        mNeedRequestPermissions = Utils.checkPermissions(context);
        ...
        if (MAP_ACTION.equals(intent.getAction())) {
            ...
            if (eventId != -1) {
                ...
                if (geoIntent != null) {
                    /* SPRD: Add for bug532339, Is there a corresponding Activity can respond. @{ */
            ...
            if (eventId != -1) {
                ...
                if (callIntent != null) {
                    /*
                     * SPRD: Add 20150616 of bug 446869,Is there a corresponding
            ...
            /* SPRD: add for bug462566 , intent.getAction() can not be null. @{
            */
    ...
    private static PendingIntent createMapBroadcastIntent(Context context, URLSpan[] urlSpans,
        ...
        for (int span_i = 0; span_i < urlSpans.length; span_i++) {
            ...
            Intent geoIntent = createMapActivityIntent(context, urlSpans);
            /* SPRD: bug497377 NullPointerException. @{ */
            if (geoIntent != null && Utils.isIntentAvailable(context, geoIntent)) {
