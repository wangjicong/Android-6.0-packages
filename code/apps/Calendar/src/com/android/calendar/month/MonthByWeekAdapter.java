...
public class MonthByWeekAdapter extends SimpleWeeksAdapter {
    ...
    protected void onDayTapped(Time day) {
        /* SPRD: bug408840 limit date between 1970-1-1 and 2037-12-31 @{ */
        if (!Utils.isTimeInLimitation(day)) {
            Utils.showDateOutOfRangeToast(mActivity);
            return;
        }
        /* @} */
    ...
    protected class CalendarGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public void onLongPress(MotionEvent e) {
            if (mLongClickedView != null) {
                ...
                /* SPRD: bug408840  limit date between 1970-01-01 and 2037-12-31 @{ */
                if (day != null && Utils.isTimeInLimitation(day)) {
