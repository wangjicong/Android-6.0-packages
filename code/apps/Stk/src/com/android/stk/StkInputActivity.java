...
/* @}*/
/* SPRD: Add here for case 27.22.4.2.6 GET INKEY @{ */
...
public class StkInputActivity extends Activity implements View.OnClickListener,
    ...
    /* SPRD: Add here for case 27.22.4.2.6 GET INKEY @{ */
    private ImageView mPromptIconView = null;
    /* @} */
    ...
    public void onCreate(Bundle icicle) {
        ...
        /* SPRD: Modify here for case 27.22.4.2.6 GET INKEY @{ */
        ...
        /* SPRD: Add here for case 27.22.4.2.6 GET INKEY @{ */
        mPromptIconView = (ImageView) findViewById(R.id.prompt_icon);
        /* @} */
        mInstance = this;
    ...
    private void configInputDisplay() {
        ...
        if (mStkInput.icon != null) {
            ...
            //      mStkInput.icon));
            mPromptIconView.setImageBitmap(mStkInput.icon);
        } else {
            mPromptIconView.setVisibility(View.GONE);
        }
        /* @} */
        ...
        @Override public void onReceive(Context context, Intent intent) {
            ...
            /* SPRD: SIM standby changed install/uninstall  support @{*/
                ...
                boolean isStandby = Settings.Global.getInt(
                        context.getContentResolver(), Settings.Global.SIM_STANDBY + mSlotId, 1) == 1;
                CatLog.d(LOG_TAG, "SIM " + mSlotId + " isStandby="+isStandby);
                if(!isStandby){
