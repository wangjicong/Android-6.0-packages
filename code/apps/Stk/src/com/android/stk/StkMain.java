 ...
 public class StkMain extends Activity {
    ...
    private boolean isShowSTKListMenu() {
        ...
        for (int i = 0; i < simCount; i++) {
            // SPRD: Add this condition for NullPointerException.
            if (null == appService) {
            ...
            boolean isStandby = Settings.Global.getInt(
                        mContext.getContentResolver(), Settings.Global.SIM_STANDBY + i, 1) == 1;
            CatLog.d(LOG_TAG, "SIM " + i + " isStandby="+isStandby);
            if (mTm.hasIccCard(i) && appService != null && appService.getStkContext(i) != null
