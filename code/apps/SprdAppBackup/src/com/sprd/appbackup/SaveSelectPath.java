...
public class SaveSelectPath extends ListActivity {
    ...
    String externalStoragePath = Environment.getInternalStoragePath().getPath();//TCard
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (bundle != null) {
            ...
            if(!storage.endsWith("SD")){
                externalStoragePath = Environment.getInternalStoragePath().getPath();//TCard
            }else {
                externalStoragePath = Environment.getExternalStoragePath().getPath();//TCard
            }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        case KeyEvent.KEYCODE_BACK:
            ...
            if (!str.equals("/mnt")) {
                ...
                String internalStoragePath = Environment.getInternalStoragePath().getPath();//TCard
                //SPRD:Bug 255362, can back a invalid path when click back key @{
                String externalStoragePath = Environment.getExternalStoragePath().getPath();
