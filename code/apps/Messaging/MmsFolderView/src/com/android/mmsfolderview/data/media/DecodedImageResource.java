...
import com.android.mmsfolderview.ui.OrientedBitmapDrawable;
...
public class DecodedImageResource extends ImageResource {
    ...
    private static final String TAG = "DecodedImageResource";
    ...
    public byte[] getBytes() {
        ...
        try {
            ...
            Log.e(TAG, "Error trying to get the bitmap bytes " + e);
        } finally {
            releaseLock();
        }
        return null;
    ...
    private class EncodeImageRequest implements MediaRequest<ImageResource> {
        ...
        public ImageResource loadMediaBlocking(List<MediaRequest<ImageResource>> chainedRequests)
            ...
            try {
                ...
                // original bitmap.
                Log.e(TAG, "Error compressing bitmap", ex);
