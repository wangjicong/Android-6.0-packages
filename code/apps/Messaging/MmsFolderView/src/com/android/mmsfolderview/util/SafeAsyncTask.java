...
//
//    protected static final String TAG = "SafeAsyncTask";
...
//                        Log.d(TAG, String.format("%s timed out and is canceled",
//                                this));
...
//                Log.d(TAG, String.format("%s took %dms", this, executionTime));
