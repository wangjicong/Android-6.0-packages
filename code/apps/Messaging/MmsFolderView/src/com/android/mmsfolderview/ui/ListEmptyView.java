...
/**
 * A common reusable view that shows a hint image and text for an empty list
 * view.
 */
public class ListEmptyView extends LinearLayout {
    ...
    public void setIsVerticallyCentered(final boolean isVerticallyCentered) {
        int gravity = isVerticallyCentered ? Gravity.CENTER : Gravity.TOP
        ...
        getLayoutParams().height = isVerticallyCentered ? LayoutParams.WRAP_CONTENT
