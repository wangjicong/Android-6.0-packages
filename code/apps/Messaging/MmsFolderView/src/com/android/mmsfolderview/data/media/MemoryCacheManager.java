...
/**
 * Utility abstraction which allows MemoryCaches in an application to register
 * and then when there is memory pressure provide a callback to reclaim the
...
public class MemoryCacheManager {
    ...
    private static MemoryCacheManager mMemoryCacheManager;
    ...
    public void reclaimMemory() {
        // We're creating a cache copy in the lock to ensure we're not working
        // on a concurrently
        // modified set, then reclaim outside of the lock to minimize the time
        // within the lock.
