...
public class SortMsgListSwipeHelper implements OnItemTouchListener {
    ...
    private SortMsgListItemView mListItemView;

    public SortMsgListSwipeHelper(final RecyclerView recyclerView) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                if (!hasGestureSwipeTarget()) {
                    ...
                    final SortMsgListItemView child = (SortMsgListItemView) viewAtPoint;
                    if (viewAtPoint instanceof SortMsgListItemView &&
...
//        Assert.isTrue(mIsSwiping);
     ...
     * given viewHolder.
     */
    private void onSwipeGestureStart(final SortMsgListItemView itemView) {
     ...
     */
    private void onSwipeGestureEnd(final SortMsgListItemView itemView,
     ...
     */
    private void onSwipeAnimationStart(final SortMsgListItemView itemView) {
     ...
     */
    private void onSwipeAnimationEnd(final SortMsgListItemView itemView) {
     ...
     * the given velocityX.
     */
    private void animateDismiss(final SortMsgListItemView itemView, final float velocityX) {
//        Assert.isTrue(velocityX != 0);
     ...
     */
    private void animateDismiss(final SortMsgListItemView itemView, final int swipeDirection) {
     ...
     */
    private void animateDismiss(final SortMsgListItemView itemView,
...
//        Assert.isTrue(swipeDirection != SWIPE_DIRECTION_NONE);
        ...
        final ObjectAnimator animator = getSwipeTranslationXAnimator(
                itemView, animateTo, duration, IntentUiUtils.DEFAULT_INTERPOLATOR);
     ...
     */
    private void animateRestore(final SortMsgListItemView itemView,
        ...
        final ObjectAnimator animator = getSwipeTranslationXAnimator(
                itemView, 0f, duration, IntentUiUtils.DEFAULT_INTERPOLATOR);
        animator.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(final Animator animation) {
                       onSwipeAnimationEnd(itemView);
     ...
     */
    private ObjectAnimator getSwipeTranslationXAnimator(final SortMsgListItemView itemView,
...
//        Assert.isTrue(velocity != 0);
     ...
     */
    private void setHardwareAnimatingLayerType(final SortMsgListItemView itemView,
