...
public abstract class ImageRequestDescriptor extends MediaRequestDescriptor<ImageResource> {
    ...
    public ImageRequestDescriptor() {
        this(SortMsgDataCollector.UNSPECIFIED_SIZE, SortMsgDataCollector.UNSPECIFIED_SIZE,
                SortMsgDataCollector.UNSPECIFIED_SIZE, SortMsgDataCollector.UNSPECIFIED_SIZE, false, false, 0, 0);
    }
