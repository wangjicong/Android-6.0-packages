...
public class AudioAttachmentPlayPauseButton extends ViewSwitcher {
    ...
    private void updateAppearance() {
        mPlayButton.setImageDrawable(ConversationDrawables.get(mContext).getPlayButtonDrawable(
                mShowAsIncoming));
        mPauseButton.setImageDrawable(ConversationDrawables.get(mContext).getPauseButtonDrawable(
                mShowAsIncoming));
    }
}
