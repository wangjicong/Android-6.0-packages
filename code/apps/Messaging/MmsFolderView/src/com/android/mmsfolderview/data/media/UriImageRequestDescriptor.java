...
public class UriImageRequestDescriptor extends ImageRequestDescriptor {
    ...
    public UriImageRequestDescriptor(final Uri uri) {
        this(uri, SortMsgDataCollector.UNSPECIFIED_SIZE, SortMsgDataCollector.UNSPECIFIED_SIZE, false,
                false, false, 0, 0);
    }
    ...
    public UriImageRequestDescriptor(final Uri uri, final int desiredWidth,
            final int desiredHeight, final boolean cropToCircle, final int circleBackgroundColor,
            int circleStrokeColor) {
        this(uri, desiredWidth, desiredHeight, false, false, cropToCircle, circleBackgroundColor,
                circleStrokeColor);
    }
    ...
    public UriImageRequestDescriptor(final Uri uri, final int desiredWidth,
        ...
        this(uri, desiredWidth, desiredHeight, SortMsgDataCollector.UNSPECIFIED_SIZE,
                SortMsgDataCollector.UNSPECIFIED_SIZE, allowCompression, isStatic, cropToCircle,
     ...
     * 
     * @param uri the content Uri. Currently Bugle only supports local resources
     *            Uri (i.e. it has to begin with content: or android.resource:
    ...
    public UriImageRequestDescriptor(final Uri uri, final int desiredWidth,
        ...
        super(desiredWidth, desiredHeight, sourceWidth, sourceHeight, isStatic, cropToCircle,
                circleBackgroundColor, circleStrokeColor);
        this.uri = uri;
    ...
    public String getKey() {
        if (uri != null) {
            ...
            if (key != null) {
                return new StringBuilder().append(uri).append(KEY_PART_DELIMITER)
    ...
    /**
     * ID of the resource in MediaStore or null if this resource didn't come
     * from MediaStore
     */
