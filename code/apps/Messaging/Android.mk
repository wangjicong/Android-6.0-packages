...
$(shell cp -rf $(LOCAL_PATH)/sprd/com/* $(LOCAL_PATH)/src/com)
$(shell cp -rf $(LOCAL_PATH)/sprd/android/* $(LOCAL_PATH)/src/android)
...
LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := libmmspluginframework:libs/plugin-framework-v1.0.jar
...
# bug 478514: Add for MmsFolderView Feature -- Begin
LOCAL_STATIC_JAVA_LIBRARIES += libmmspluginframework
# bug 478514: Add for MmsFolderView Feature -- End
