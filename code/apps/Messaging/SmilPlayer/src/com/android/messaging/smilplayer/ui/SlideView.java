...
/*SPRD:Bug 317234 Modify layout for slideshow @{*/
import android.text.TextUtils;

/*@}*/
/*SPRD:Bug 375488 Add for drm @{*/
//import com.android.messaging.smilplayer.drm.DrmUiUtils;
/*@}*/
...
import com.android.messaging.smilplayer.ui.GifView;

//import com.sprd.mms.carrier.OperatorUtils;
import com.android.messaging.smilplayer.ui.GifPlayManager;
...
public class SlideView extends AbsoluteLayout implements
    ...
    public void setImage(String name, Bitmap bitmap) {
        ...
        /* SPRD:Bug 375488 Add for drm @{ */
        /*if (DrmUiUtils.getInstance(mContext).createDrmBitmap(name, bitmap) != null) {
            mImageView.setImageBitmap(DrmUiUtils.getInstance(mContext)
                    .createDrmBitmap(name, bitmap));
            return;
        }*/
        /* @} */
        try {
    ...
    // SPRD: gif
    public void setGifImage(String name, Uri uri) {
        if (mImageView == null) {
            mImageView = new ImageView(mContext);
            mImageView.setPadding(0, 5, 0, 5);
            if (DEBUG) {
    ...
    public void setMediaController(MediaControllerWrapper mediaController) {
    ...
    private void initAudioInfoView(String name) {
        ...
        /*SPRD:Bug 317234 Modify layout for slideshow @{*/
        audioName.setEllipsize(TextUtils.TruncateAt.valueOf("MIDDLE"));
        audioName.setSingleLine(true);
        /*@}*/
    ...
    public void setAudio(Uri audio, String name, Map<String, ?> extras) {
        ...
        Log.d(TAG, "audioName:" + name);
        if(DrmUtilsSprd.getInstance(mContext).isDrmSrc(name)){
            Toast.makeText(mContext,
                    mContext.getString(R.string.not_support_open_drm),
        ...
        try {
            ...
            Log.e(TAG, "The MediaPlayer cannot be initialized because of IllegalStateException.", e);
            if (mAudioPlayer != null) {
                mAudioPlayer.release();
                mAudioPlayer = null;
            }
    ...
    public void setText(String name, String text) {
        ...
        /* SPRD: Play activity don't selecting text. @{
         * // Let the text in Mms can be selected
        mTextView.setTextIsSelectable(true); @}*/

        // SPRD: Add this for Linkfy function.
        //MyURLSpan.setSpan(mContext, mTextView);
    }
    ...
    public void setGifImageVisibility(boolean visible) {
        if (mGifView != null) {
            if (mConformanceMode) {
                mGifView.setVisibility(visible ? View.VISIBLE : View.GONE);
            } else {
                mGifView.setVisibility(visible ? View.VISIBLE : View.INVISIBLE);
            }
        }
    }
    ...
    public void enableMMSConformanceMode(int textLeft, int textTop,
        ...
        if (imageLeft >= 0 && imageTop >= 0) {
            ...
            mVideoView = new VideoView(mContext);
            /* Add by SPRD for Bug:497398 2015.11.11 Start */
            mVideoView.setBackgroundColor(0xffeeeeee);
            ...
            /* Add by SPRD for Bug:497398 2015.11.11 End */
    ...
    /* @} */
    /* SPRD: Add for OOM of Bug 287577 @{ */
    protected void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        if (null != mGifPlayManager){
            mGifPlayManager.quitManager();
        }
    }
    /* @} */
    ...
    public class MyDisplayGifCallback implements GifPlayManager.DisplayGifCallback {
        ...
        public void displayGifFrame(Bitmap bm) {
            ...
            if (bm != null && !bm.isRecycled()) {
                final Bitmap temp = bm.copy(Config.RGB_565, false);
