...
public class SmilPlayerConfig {
    ...
    /** SPRD : modify for bug 356236 @{
      * org : private static int mRecipientLimit = 50;     // default value
    @}*/
    private static int mRecipientLimit = 100;
    ...
    private static int mHttpSocketTimeout = 180 * 1000;         // default to 1 min
    ...
    private static boolean mEnableSlideDuration = false;
    ...
    /* SPRD: not resize image for CMCC @{ */
//    private static final int MAX_IMAGE_HEIGHT_CMCC = 1920;
//    private static final int MAX_IMAGE_WIDTH_CMCC = 1080;
    /* @} */
    // set Mms adj
    private static int mMmsAdjValue = -1;
    // SPRD: Fixed for bug 206239
    private static int mPreSaveSlideSize = 250;
    // SPRD: optimization
    private static boolean mEnableAsyncUpdateConversation = true;
    ...
    /**
     * SPRD: Add this method for Optimization. @{
     */
    public static boolean isEnableAsyncUpdateConversation() {
        return mEnableAsyncUpdateConversation;
    }
    /** @} */

    // Fixed for bug 206239 begin
    public static int getPreSaveSlideSize(){
        return mPreSaveSlideSize;
    }
    public static int getMessageWithPduHeadSize(int size) {
        return SlideshowModel.SLIDESHOW_SLOP + size;
    }
    // Fixed for bug 206239 end

    public static int getMmsAdjValue() {
        return mMmsAdjValue;
    }
            ...
            while (true) {
                ...
                if ("name".equalsIgnoreCase(name)) {
                    if ("bool".equals(tag)) {
                        ...
                        /*Add by SPRD for Bug:519188  2015.01.11 Start */
                        else if("supportExternalRecipient".equalsIgnoreCase(value)) {
                            mExternalRecipientEnabled = "true".equalsIgnoreCase(text);
                        }
                        /*Add by SPRD for Bug:519188  2015.01.11 End */
...
//                            }
                        ...
                        } else if ("mmsAdjValue".equalsIgnoreCase(value)) {
                            mMmsAdjValue = Integer.parseInt(text);
                        }
    ...
    /*Add by SPRD for Bug:519188  2015.01.11 Start */
 // Configuration for recipient address.
    private static boolean mExternalRecipientEnabled = false;
    /**
    * Such as number from network:ID-54671
    * @return True if support external address, false if not.
    */
    public static boolean isExternalRecipientEnabled() {
        return mExternalRecipientEnabled;
    }
    public static boolean isTruncateRecipientEnabled() {
        return true;
    }
    public static boolean canPromptIfExistInvalidRecipient() {
        return true;
    }
    public static boolean canPromptIfChangedRecipient() {
        return true;
    }
    /*Add by SPRD for Bug:519188  2015.01.11 End */
}
