...
public class BugleApplication extends Application implements UncaughtExceptionHandler {
    ...
    public static Context mContext;//Add by SPRD for Bug:562203 Encode Type feature
    ...
    public void onCreate() {
        ...
        super.onCreate();
        mContext = getApplicationContext();//Add by SPRD for Bug:562203 Encode Type feature
     ...
     // bug 540833:-- Begin
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    LogUtil.e(TAG, "*-*-*-*getApplicationContext()="+getApplicationContext());
                    PluginsManager.setContext(BugleApplication.this);
                    PluginsManager.initPluginsManager();
                } catch (Exception e) {
                    LogUtil.e(TAG, "initPluginsManager Error", e);
                }
