...
public final class BuglePrefsKeys {
    ...
    /**
     * // bug 478514: Add for MmsFolderView Feature
     */
    public static final String IS_FROM_FOLDER_VIEW_REPLY = "is_from_folder_view_reply";
    public static final String IS_FOLDER_VIEW_MODE = "is_folder_view_mode";
    public static final String DEST_VIEW_MODE = "dest_view_mode";
    //the code to mark the states
    public static final int SIMSMS_STATE = 3;
    public static final int CONVERSATION_STATE = 0;
    public static final int FOLDERVIEW_STATE = 1;
}
