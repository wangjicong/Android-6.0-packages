...
public class ParticipantRefresh {
    ...
    private static final Runnable sFullRefreshRunnable = new Runnable() {
        ...
        public void run() {
            ...
            // add for bug 543691 begin
            System.out.println("will sync temptable data");
            Uri uri = Uri.parse("content://mms-sms/createTempTable");
            DataModel.get().getDatabase().getContext().getContentResolver()
    ...
    public static class ContactContentObserver extends ContentObserver {
        ...
        public void onChange(final boolean selfChange) {
            ...
            /* Add by SPRD for Bug:509314 2015.12.17 Start */
            refreshParticipantsIfNeeded();
            /* Add by SPRD for Bug:509314 2015.12.17 End */
        }
