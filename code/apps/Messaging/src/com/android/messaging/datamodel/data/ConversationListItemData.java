...
public class ConversationListItemData {
    ...
    public void bind(final Cursor cursor, final boolean ignoreDraft) {
        ...
        setConversationNameSprd(mOtherParticipantNormalizedDestination,mName,mParticipantContactId);
    ...
    public void setConversationNameSprd(String mOtherParticipantNormalizedDestination,String name, long contactid){
        FdnUtil fdnUtil = FdnUtil.getFdnUtilInstance();
        mName = fdnUtil.getCachFdnName(mOtherParticipantNormalizedDestination,name,contactid);
        if(TextUtils.isEmpty(mName)) {
            // name is original mName.
            mName = name;
        }
    }
