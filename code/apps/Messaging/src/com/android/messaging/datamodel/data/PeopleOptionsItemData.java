...
public class PeopleOptionsItemData {
    ...
    static int SETTINGS_COUNT_VALUE = 4;
    static {
        if (!MmsConfig.getKeepOrgSoundVibrate()) {
            SETTINGS_COUNT_VALUE = 2;
        }
    }
    ...
    public static final int SETTINGS_COUNT = SETTINGS_COUNT_VALUE;

    public static final int SETTING_BLOCKED_SPRD = 1;
    ...
    public void bind(
        ...
        /* SPRD: Modify for bug 509830 begin */
        if (!MmsConfig.getKeepOrgSoundVibrate()) {
            bindSPRD(cursor, otherParticipant, settingType);
        } else {
        /* SPRD: Modify for bug 509830 end */
            mSubtitle = null;
            mRingtoneUri = null;
            ...
            switch (settingType) {
                ...
                case SETTING_NOTIFICATION_SOUND_URI:
                    ...
                    Uri ringtoneUri = RingtoneUtil.getNotificationRingtoneUri(ringtoneString, ParticipantData.DEFAULT_SELF_SUB_ID);
