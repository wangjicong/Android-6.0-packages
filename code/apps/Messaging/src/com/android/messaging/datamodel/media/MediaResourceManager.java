...
public class MediaResourceManager {
    ...
    public <T extends RefCountedMediaResource> void requestMediaResourceAsync(
        ...
        String sheapgrowthlimit = SystemProperties.get("dalvik.vm.heapgrowthlimit");
        int iheapgrowthlimit=96;
        if (sheapgrowthlimit != null && !"".equals(sheapgrowthlimit)){
            iheapgrowthlimit=Integer.parseInt(sheapgrowthlimit.substring(0, sheapgrowthlimit.length()-1));
        }
        if(iheapgrowthlimit==48){
