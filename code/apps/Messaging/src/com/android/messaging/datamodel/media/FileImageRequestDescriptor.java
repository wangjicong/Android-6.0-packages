...
public class FileImageRequestDescriptor extends UriImageRequestDescriptor {
    ...
    public MediaRequest<ImageResource> buildSyncMediaRequest(final Context context) {
        FileImageRequest fileImageRequest = new FileImageRequest(context, this);
        if (isDrm){
            fileImageRequest.setDrmType(true);
            fileImageRequest.setDrmContentType(mDrmContentType);
            fileImageRequest.setDrmDataPath(mDrmDataPath);
            fileImageRequest.setDrmPreviewInPhotoViewActivity(mDrmPreviewInPhotoViewActivity);
            fileImageRequest.setDrmDecryptHandle(mDecryptHandle);
        }
