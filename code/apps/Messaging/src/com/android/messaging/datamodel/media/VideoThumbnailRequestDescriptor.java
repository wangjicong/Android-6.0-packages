...
public class VideoThumbnailRequestDescriptor extends UriImageRequestDescriptor {
    ...
    public MediaRequest<ImageResource> buildSyncMediaRequest(Context context) {
        VideoThumbnailRequest videoThumbnailRequest = new VideoThumbnailRequest(context, this);
        if (isDrm){
            videoThumbnailRequest.setDrmType(true);
            videoThumbnailRequest.setDrmContentType(mDrmContentType);
            videoThumbnailRequest.setDrmDataPath(mDrmDataPath);
        }
