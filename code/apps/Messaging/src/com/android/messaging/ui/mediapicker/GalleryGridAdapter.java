 ...
 */
public class GalleryGridAdapter extends CursorAdapter implements AbsListView.OnScrollListener{
    ...
    public void bindView(final View view, final Context context, final Cursor cursor) {
        ...
        galleryImageView.setScrollState(mScrollState);
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState){
         if (mScrollState>0 && scrollState ==0){
