...
public class MediaPicker extends Fragment implements DraftMessageSubscriptionDataProvider {
    ...
    public void onPause() {
        ...
        // spread: fixe for bug 516158 start
        /* Modify by SPRD for Bug:527745 2016.02.01 Start */
//        dismiss(false);
        Log.d(LogUtil.BUGLE_TAG + "/MediaPicker", "has permission:" + mHasPermission);
        if(mHasPermission) {
            dismiss(false);
        }
        /* Modify by SPRD for Bug:527745 2016.02.01 End */
        if(mListener != null){
...
//                    startingMediaType = MEDIA_TYPE_AUDIO;
    ...
    public void onRequestPermissionsResult(
        ...
        /* Add by SPRD for Bug:527745 2016.02.01 Start */
        setHasPermission(true);
        /* Add by SPRD for Bug:527745 2016.02.01 End */
        // Add for bug 525151
