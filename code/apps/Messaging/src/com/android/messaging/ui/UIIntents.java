...
public abstract class UIIntents {
    ...
    public static final String UI_INTENT_EXTRA_IS_FORWARDING_MMS = "is_forwarding_mms";
    public static final String UI_INTENT_EXTRA_FORWARDED_MMS_URI = "forwarded_mms_uri";
   ...
   public static final int REQUEST_PICK_VCALENDAR_PICKER = 1800;
    ...
    public abstract void launchFullScreenPhotoViewerForDrm(Activity activity, Uri initialPhoto,
            Rect initialPhotoBounds, Uri photosUri);
    /**
     * Launch an activity to show slide of a messaging which is mms 
     * @param isdrat indicates whether the SmilMainActivity just show the slide or not
     *        list   which conbime combined by a Mms or draf mms
     */
    public abstract void launchSmilMainActivity(Context context, boolean isdrat, Object object);
    /**
    ...
    public abstract PendingIntent getPendingIntentForSortMsgListActivity(final Context context,
            int notificationId);
    public abstract PendingIntent getPendingIntentForMessageDetailsActivity(final Context context,
            Intent intent);
    public abstract Intent getSortMsgListActivityIntent(Context context);
