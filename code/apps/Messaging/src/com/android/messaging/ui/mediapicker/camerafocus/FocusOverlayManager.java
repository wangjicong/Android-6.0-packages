...
public class FocusOverlayManager {
    ...
    public void pause(){
        Log.i(TAG, "pause FocusOverlayManager ");
        mPaused = true;
    }
    public void resume(){
        Log.i(TAG, "resume FocusOverlayManager ");
        mPaused = false;
    }
    ...
    private void calculateTapArea(int focusWidth, int focusHeight, float areaMultiple,
        ...
        Log.e("clamp", " focusWidth "+focusWidth+" focusHeight"+focusHeight+" x "+x+" y"+y+" previewWidth"+previewWidth+" previewHeight"+previewHeight+" left"+left+" top"+top);
