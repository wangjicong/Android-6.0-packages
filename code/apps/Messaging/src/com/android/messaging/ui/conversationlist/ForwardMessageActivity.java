...
public class ForwardMessageActivity extends BaseBugleActivity
    ...
    private String mForwardedMmsUri;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mForwardedMmsUri = getIntent().getStringExtra(UIIntents.UI_INTENT_EXTRA_FORWARDED_MMS_URI);
    }
    ...
    public void onConversationClick(final ConversationListData listData,
        ...
        final Intent intent = UIIntents.get().getIntentForConversationActivity(this,
                conversationListItemData.getConversationId(), mDraftMessage);
        if( null != mForwardedMmsUri ) {
            intent.putExtra(UIIntents.UI_INTENT_EXTRA_IS_FORWARDING_MMS, true)
                  .putExtra(UIIntents.UI_INTENT_EXTRA_FORWARDED_MMS_URI, mForwardedMmsUri);
        }
