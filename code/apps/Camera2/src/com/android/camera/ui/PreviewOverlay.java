...
public class PreviewOverlay extends View
    ...
    private class ZoomProcessor implements ScaleGestureDetector.OnScaleGestureListener {
        ...
        //ljb 20160530 add for Zoom
        private final Paint mTextPaint;
        private final int mTextSize;
        //ljb 20160530 end for Zoom        
        ...
        public ZoomProcessor() {
            ...
            //ljb 20160530 add for Zoom
            mTextSize = res.getDimensionPixelSize(R.dimen.zoom_value_text_size);
            //ljb 20160530 end for Zoom            
            mPaint = new Paint();
            ...
            mTextPaint.setAntiAlias(true);//qiuyaobo,20170421
            mTextPaint.setColor(Color.WHITE);
            mTextPaint.setTextSize(mTextSize);
            //ljb 20160530 endd for Zoom            
        }
