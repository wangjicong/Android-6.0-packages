...
import android.app.KeyguardManager;//qiuyaobo,20160727
/**
...
public class ModeListView extends FrameLayout
    ...
    private static final int GIF_MODE_INDEX = 7;
    ...
    private KeyguardManager mKeyguardManager;//qiuyaobo,20160727
    ...
    private class SelectedState extends ModeListState {
        public SelectedState(ModeSelectorItem selectedItem) {
            ...
            if (mScreenShotProvider != null) {
                if (modeId == GIF_MODE_INDEX
                        || mModeSwitchListener.getCurrentModeIndex() == GIF_MODE_INDEX) {
                    effect.setBackground(
                            mScreenShotProvider.getPreviewOverlayAndControls(),
        ...
        if (visibility == VISIBLE) {
            ...
            if (mModeSwitchListener != null) {
                ...
                for (int i = 0; i < mSupportedModes.size(); i++) {
                    ...
                    /* SPRD:Fix bug 539725 unhighlight other icon @*/
                    } else {
                        mModeSelectorItems[i].setSelected(false);
                    /* @}*/
                    }
    ...
    private class PeepholeAnimationEffect extends AnimationEffects {
        ...
        private void setupAnimators() {
             ...
             */
            if (AddCameraForCMCC.getInstance().isCMCCVersion()) {
                mRevealAlphaAnimator.setDuration(AddCameraForCMCC.getInstance().getAnimationDurationCmcc());
            } else {
                mRevealAlphaAnimator.setDuration(PEEP_HOLE_ANIMATION_DURATION_MS);
            }
            /* @} */
             ...
             */
            if (AddCameraForCMCC.getInstance().isCMCCVersion()) {
                mPeepHoleAnimator.setDuration(AddCameraForCMCC.getInstance().getAnimationDurationCmcc());
            } else {
                mPeepHoleAnimator.setDuration(PEEP_HOLE_ANIMATION_DURATION_MS);
            }
            /* @} */
        ...
        public void drawBackground(Canvas canvas) {
            if (mBackground != null && mBackgroundOverlay != null) {
                ...
                if (mCircleDrawable != null) {
                    // SPRD Bug:519334 Refactor Rotation UI of Camera.
                    mCircleDrawable.setDegree(mDegree);
                        ...
                        public void run() {
                            ...
                            if ((ModeListView.this.getContext() == null)
                                    || (ModeListView.this.getContext() != null
                                            ...
                                            && (((CameraActivity) ModeListView.this.getContext())
