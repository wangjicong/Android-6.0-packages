...
public class BottomBar extends FrameLayout {
    ...
    protected boolean setFrame(int left, int top, int right, int bottom) {
        LinearLayout uPanel = (LinearLayout) ((Activity) getContext())
                .findViewById(R.id.ucam_makeup_controls);
        if (uPanel != null) {
            uPanel.setPadding(0, uPanel.getPaddingTop(), 0, uPanel.getPaddingTop() * 17 / 15
                    + (bottom - top));
        }
