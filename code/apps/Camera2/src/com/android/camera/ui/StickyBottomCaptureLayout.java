...
public class StickyBottomCaptureLayout extends FrameLayout {
     ...
     */
    public void setCameraAppUI(CameraAppUI appUI) {
        mCameraAppUI = appUI;
    }
    ...
    private PointF getRoundedThumbnailPosition(
        ...
        final float beautyLayoutHeight = getResources().getDimension(R.dimen.mode_option_overlay_makeup_height);//SPRD: fix bug474672
        ...
        if (orientation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            if (mCameraAppUI != null && mCameraAppUI.getModuleIndex() == PhotoUI.UCAM_BEAUTY_MODULE_INDEX) {
                y -= beautyLayoutHeight;
            }
            /* @} */
        }
