...
public class IndicatorIconController
    ...
    private ImageView mExposureIndicatorN3;
    ...
    private void syncFlashIndicator() {
        ...
        if ((buttonManager.isEnabled(ButtonManager.BUTTON_FLASH)
            ...
            /*SPRD:fix bug528493 flash state is not consistent between hide and spread@{*/
                ...
                setIndicatorState(mController.getCameraScope(),
                        Keys.KEY_GIF_FLASH_MODE, mFlashIndicator,
                        mFlashIndicatorGifIcons, false);
            /*@}*/
            } else {
                setIndicatorState(mController.getCameraScope(),
    ...
    private void syncExposureIndicator() {
         ...
         */
        if (mExposureIndicatorN3 == null
                || mExposureIndicatorN2 == null
                || mExposureIndicatorN1 == null
                || mExposureIndicatorP1 == null
                || mExposureIndicatorP2 == null
                || mExposureIndicatorP3 == null) {
            Log.w(TAG, "Trying to sync exposure indicators that are not initialized.");
            return;
        }
        /* @} */
        ...
        // SPRD Bug:474711 Feature:Exposure Compensation.
        changeVisibility(mExposureIndicatorN3, View.GONE);
        ...
        // SPRD Bug:474711 Feature:Exposure Compensation.
        changeVisibility(mExposureIndicatorP3, View.GONE);
        ...
        if (buttonManager.isEnabled(ButtonManager.BUTTON_EXPOSURE_COMPENSATION)
            ...
            // SPRD Bug:474711 Feature:Exposure Compensation.
            Log.i(TAG, "compValue:" + compValue + ",comp:" + comp);
            ...
            switch (comp) {
                 ...
                 */
                case -3:
                    changeVisibility(mExposureIndicatorN3, View.VISIBLE);
                    break;
                /* @} */
                ...
                case 2:
                    ...
                    break;
                case 3:
                    changeVisibility(mExposureIndicatorP3, View.VISIBLE);
                    /* @} */
