...
public class FilmstripView extends ViewGroup {
    ...
    private void animateItemRemoval(int index) {
        ...
        if (removeAtBufferIndex >= BUFFER_CENTER
            ...
            if (inFullScreen()) {
            */
            if (inFullScreen() && mViewItems[BUFFER_CENTER] != null) {
    ...
    private class FilmstripGestures implements FilmstripGestureRecognizer.Listener {
        ...
        public boolean onUp(float x, float y) {
            ...
            //SPRD:fix bug519336 Scroll FilmStrip is not fullScreen
            if (mAdapterIndexUserIsScrollingOver == -1 && currId != 0) {
    ...
    /* SPRD: Add for Freeze Review Layout avoid scroll in FilmStripLayout */
    public boolean isInFreezeReview() {
        if (mActivity != null && mActivity.getCameraAppUI() != null) {
            return mActivity.getCameraAppUI().isInFreezeReview();
        }
        return false;
    }
}
