...
public class CameraApp extends Application {
    ...
    public void onCreate() {
         ...
         */
        CameraUtil.instance().initialize(this);

        // SPRD: add for 565002 that resetting camera defaults from CameraSettingsActivity
        // will lead to null exception
        Keys.setDefaults(CameraServicesImpl.instance().getSettingsManager(), this);

        UCamUtill.initialize(context);//SPRD: fix bug474674
