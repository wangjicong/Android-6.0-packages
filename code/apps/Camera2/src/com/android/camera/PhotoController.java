...
public interface PhotoController extends OnShutterButtonListener {
    ...
    public void onBeautyValueChanged(int value);//SPRD:fix bug 474672 add for ucam beauty

    public void onBeautyValueReset();//SPRD: Fix bug 513768 makeup module switch to normal photo module, makeup effect still works.
}
