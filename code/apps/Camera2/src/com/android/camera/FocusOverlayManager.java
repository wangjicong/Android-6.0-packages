...
/*SUN:jicong.wang modify SUN_REMOVE_CAMERA_AUTO_FOCUS */
...
public class FocusOverlayManager implements PreviewStatusListener.PreviewAreaChangedListener,
    ...
    public void updateFocusUI() {
        ...
        if (mState == STATE_IDLE) {
            ...
            if ((mState == STATE_SUCCESS || mState == STATE_FAIL) && mFocusRing.isPassiveFocusRunning()) {
    ...
    public void onAutoFocusMoving(boolean moving) {
        ...
        /*SUN:jicong.wang modify SUN_REMOVE_CAMERA_AUTO_FOCUS start {@*/
        if (OptConfig.SUN_REMOVE_CAMERA_AUTO_FOCUS) {
            Log.d(TAG,"SUN:jicong.wang SUN_REMOVE_CAMERA_AUTO_FOCUS remove camera2 auto focus function ");
            return;
        }
        /*SUN:jicong.wnag modify SUN_REMOVE_CAMERA_AUTO_FOCUS end @}*/
    ...
    public void onSingleTapUp(int x, int y) {
        ...
        if (!OptConfig.SUN_REMOVE_CAMERA_AUTO_FOCUS) {
            ...
            Log.d(TAG,"SUN:jicong.wang SUN_REMOVE_CAMERA_AUTO_FOCUS function>onSingleTapUp  remove camera2 auto focus function ");
        }
        /*SUN:jicong.wnag modify SUN_REMOVE_CAMERA_AUTO_FOCUS end @}*/            
