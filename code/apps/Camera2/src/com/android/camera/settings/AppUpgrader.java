...
public class AppUpgrader extends SettingsUpgrader {
    ...
    private void upgradeCameraSizeSetting(SettingsManager settingsManager,
        ...
        String default_size = context.getResources().getString(key.equals(Keys.KEY_PICTURE_SIZE_BACK)?R.string.pref_camera_back_picturesize_default : R.string.pref_camera_front_picturesize_default);
        if(default_size.split("x").length == 2){
             pictureSize = default_size;
         }
