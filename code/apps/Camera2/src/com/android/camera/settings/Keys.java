...
public class Keys {
    ...
    public static final String KEY_CAMERA_FOCUS_SOUND = "pref_focus_sound_key";//jxl add
...
/*sunvov:dlj add for 151014 start*/
    public static final String KEY_CAMERA_FULL_PREVIEW = "pref_camera_full_preview_key";
    public static final String KEY_VIDEO_FULL_PREVIEW = "pref_video_full_preview_key";
/*sunvov:dlj add for 151014 end*/
    /**
    ...
    public static void setDefaults(SettingsManager settingsManager, Context context) {
        ...
        if(OptConfig.SUN_C7359_C5S_FWVGA_FPT || OptConfig.SUN_CUSTOM_C7367_HWD_FWVGA_R8){//Kalyy 
