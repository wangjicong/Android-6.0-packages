...
import com.sprd.android.config.OptConfig;//SUN:jicong.wang add for panorama original
...
public class WideAnglePanoramaUI implements
    ...
    public void onStartCapture() {
        ...
        /*SUN:jicong.wang modify for panorama original start {@*/
        if(OptConfig.SUNVOV_PANORAMA_ORIGINAL){
            ...
            /* liujiabin 20160824 add for pano
             if (orientation == 0 || orientation == 180) {
                 if (mProgressLayout != null && mPanoBg != null && mCaptureProgressBar != null)
                     mProgressLayout.setPadding(0, 0, 0,
                             mPanoBg.getHeight() - mCaptureProgressBar.getHeight());
        ...
        /*SUN:jicong.wang modify for panorama original end @}*/
    ...
    private void setViews(Resources appRes) {
        ...
        /*SUN:jicong.wang modify for panorama original start {@*/             
        if (!OptConfig.SUNVOV_PANORAMA_ORIGINAL){        
            resetSize();//liujiabin 20160824 add for pano     
        }
        /*SUN:jicong.wang modify for panorama original end @}*/        
    }
    ...
    //liujiabin 20160824 add for pano
     private void resetSize() {
         ...
         if (Configuration.ORIENTATION_PORTRAIT == orientation) {
             FrameLayout.LayoutParams p = (FrameLayout.LayoutParams) mCaptureIndicator
                     .getLayoutParams();
             p.topMargin = 135;
             mCaptureIndicator.setLayoutParams(p);
             FrameLayout fl = (FrameLayout) mRootView
                     .findViewById(R.id.pano_pan_progress_bar_content);
             FrameLayout.LayoutParams p1 = (FrameLayout.LayoutParams) fl
                     .getLayoutParams();
             p1.bottomMargin = 135;
      ...
      //liujiabin 20160824 end for pano
