...
public class WideAnglePanoramaModule
    ...
    public static final float DEFAULT_SWEEP_ANGLE_FACTOR = 0.75f;
    /* @} */
...
//            }
    ...
    public HardwareSpec getHardwareSpec() {
        return new HardwareSpecImpl(getCameraProvider(), mCameraCapabilities,
                mAppController.getCameraFeatureConfig(), false);
    }
    ...
    private void setupCaptureParams(Parameters parameters) {
        ...
        int minFps = 5000;//(frameRates.get(last))[Parameters.PREVIEW_FPS_MIN_INDEX];//Kalyy Bug49337
        int maxFps = 30000;//(frameRates.get(last))[Parameters.PREVIEW_FPS_MAX_INDEX];//Kalyy Bug49337
        ...
        /* SPRD:fix bug 328907 adjust sweep angle @{ */
        mHorizontalViewAngle = parameters.getHorizontalViewAngle()/* DEFAULT_SWEEP_ANGLE_FACTOR */;
        mVerticalViewAngle = parameters.getVerticalViewAngle() /* DEFAULT_SWEEP_ANGLE_FACTOR */;
        /* @} */
    ...
    public void onPreviewUILayoutChange(int l, int t, int r, int b) {
        ...
        /*SPRD: Fix bug 539829 @{ */
        if ((mPreviewUIWidth == r - l) && (mPreviewUIHeight == b - t)) {
    ...
    private Uri savePanorama(byte[] jpegData, int width, int height, int orientation) {
        if (jpegData != null) {
            ...
            return Storage.addImageToMediaStore(mContentResolver, filename, mTimeTaken, loc,
                    orientation,
                    jpegLength, filepath, width, height, FilmstripItemData.MIME_TYPE_JPEG);
        }
        return null;
    }
    ...
    public MosaicJpeg generateFinalMosaic(boolean highRes) {
        ...
        if (!highRes && width == 152 && height == 112) { // SPRD:Fix bug 455384
            return null;
        }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_MEDIA_EJECT)) {
                ...
                if (Environment.getExternalStoragePath() != null) {
                    externalPath = Environment.getExternalStoragePath().getAbsolutePath();
                }
