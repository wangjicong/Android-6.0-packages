...
import com.ucamera.ucam.modules.ui.GifUI;
...
import com.ucamera.ucam.thumbnail.BaseImage;
...
//    private RotateImageView mGifListButton;
    ...
    private boolean isStartEditActicity = false;
        ...
        public void handleMessage(Message msg) {
            ...
            case SET_BITMAP_TO_ADAPTER: {
                ...
                if(mAdapter.getItemCount() == numOfPics){
                    if(SWITCH_CONTINUE_MODE && mShutterSound != null){
...
//        mGifListButton.setOrientation(orientation, true);
    ...
    public Bitmap yuv2Bitmap(byte[] yuvData, int width, int height) {
        return Bitmap.createBitmap(ImageProcessJni.Yuv2RGB888(yuvData, width, height), width, height, Bitmap.Config.RGB_565);
    }
