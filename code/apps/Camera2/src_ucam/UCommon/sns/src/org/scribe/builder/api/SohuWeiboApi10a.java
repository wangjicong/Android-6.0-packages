...
public class SohuWeiboApi10a extends DefaultApi10a {
    ...
    private static final String AUTHORIZE_URL = "http://api.t.sohu.com/oauth/authorize?clientType=phone&oauth_token=%s";
    ...
    public String getLogoutUrl(Token accessToken) {
        return "http://api.t.sohu.com/account/end_session.json";
    }
}
