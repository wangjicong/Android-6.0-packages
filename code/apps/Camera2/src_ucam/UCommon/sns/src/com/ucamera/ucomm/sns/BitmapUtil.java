...
public class BitmapUtil {
    ...
    private int getImageDegreeByUri(Uri target) {
        ...
        if (filepath != null) {
            return Util.getExifOrientation(filepath);
        } else {
    ...
    public Bitmap createBitmap(Uri uri) {
        Bitmap bitmap = null;
        String filePath = getDefaultPathAccordUri(uri);
        if(filePath != null) {
            bitmap = ThumbnailUtils.createImageThumbnail(filePath, Thumbnails.MINI_KIND);
        }
