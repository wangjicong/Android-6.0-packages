...
public class SelectPhoneAccountDialogFragment extends DialogFragment {
    ...
    public static void showAccountDialog(FragmentManager fragmentManager, int titleResId,
        ...
        dissmissDialog();
        mFragment = new SelectPhoneAccountDialogFragment(titleResId, canSetDefault, accountHandles, listener);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (account.getAddress() == null ||
                ...
                holder.numberTextView.setText(
                        PhoneNumberUtils.createTtsSpannable(account.getAddress().getSchemeSpecificPart()));
            }
