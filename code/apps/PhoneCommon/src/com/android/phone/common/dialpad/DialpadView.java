...
import com.sprd.android.config.OptConfig;//qiuyaobo,20170516
...
public class DialpadView extends LinearLayout {
    ...
    private void setupKeypad() {
		...
		/*SUN jxl add for ru dialpad start*/		
        final int[] letterIds_ru = new int[] {R.string.dialpad_0_letters, R.string.dialpad_1_letters,
                R.string.dialpad_2_letters_ru, R.string.dialpad_3_letters_ru, R.string.dialpad_4_letters_ru,
                R.string.dialpad_5_letters_ru, R.string.dialpad_6_letters_ru, R.string.dialpad_7_letters_ru,
                R.string.dialpad_8_letters_ru, R.string.dialpad_9_letters_ru,
                R.string.dialpad_star_letters, R.string.dialpad_pound_letters};  
		/*SUN jxl add for ru dialpad end*/		      
        ...
        for (int i = 0; i < mButtonIds.length; i++) {
			...
			/*SUN jxl add for ru dialpad start*/
            lettersView_ru = (TextView) dialpadKey.findViewById(R.id.dialpad_key_letters_ru);
			/*SUN jxl add for ru dialpad end*/
			...
			/*SUN jxl add for ru dialpad start*/
            if (lettersView_ru != null&& mButtonIds[i] != R.id.pound && mButtonIds[i] != R.id.star) {
            		if("ru".equals(currentLocale.getLanguage())){
                	lettersView_ru.setText(resources.getString(letterIds_ru[i]));
              	}else{
              		lettersView_ru.setVisibility(View.GONE);
              	}
            }
			
			if(lettersView_ru != null && !OptConfig.SUN_CUSTOM_C7356_XT_HVGA_SUPPORT){
				lettersView_ru.setVisibility(View.GONE);
			}
			/*SUN jxl add for ru dialpad end*/
        }
    ...
    public void setCanDigitsBeEdited(boolean canBeEdited) {
        ...
        digits.setCursorVisible(false);
				...
				//qiuyaobo,20170516,begin	
				if(OptConfig.SUN_CUSTOM_C7367_QHD_R9){
		        DialpadKeyButton dialpadKey;
		        TextView numberView;
		        TextView lettersView;				
		        for (int i = 0; i < mButtonIds.length; i++) {
		            ...
		            lettersView = (TextView) dialpadKey.findViewById(R.id.dialpad_key_letters);
		            if (lettersView != null)
		 								lettersView.setVisibility(canBeEdited ? View.VISIBLE : View.INVISIBLE);
		        }
		        setShowVoicemailButton(canBeEdited);
		    }    
        //qiuyaobo,20170516,end
