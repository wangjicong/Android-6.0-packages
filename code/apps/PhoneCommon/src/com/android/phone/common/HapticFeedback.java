...
public class HapticFeedback {
    ...
    /*SUN:jicong.wang add for vibrate time start {@ */
    private int mSunvov_vibrate_time;
    /*SUN:jicong.wang add for vibrate time end @}*/
    /**
    ...
    public void init(Context context, boolean enabled) {
        ...
        if (enabled) {
            ...
            /*SUN:jicong.wang add for vibrate time start {@ */
            int mSunvov_vibrate_time = context.getResources().getInteger(com.android.internal.R.integer.config_dialpadVibePattern);
            if(mSunvov_vibrate_time>0){
                mHapticPattern = new long[] {mSunvov_vibrate_time};
            } else 
            /*SUN:jicong.wang add for vibrate time end @} */
