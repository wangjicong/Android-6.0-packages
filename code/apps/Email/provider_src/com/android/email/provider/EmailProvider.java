        ...
        try {
            switch (match) {
                ...
                case BODY_ID: {
                    ...
                    } else if (map.containsKey(BodyColumns.HTML_CONTENT) ||
...
//                    }
    ...
    private Cursor uiLocalSearch(Uri uri, String[] projection, boolean unseenOnly) {
        ...
        if (isVirtualMailbox(mailboxId)) {
            ...
            c = db.rawQuery(genQueryMailboxMessages(projection, unseenOnly, selection),
                    new String[] {
                        id
                    });
        }

        return new EmailConversationCursor(context, c, folder, mailboxId);
    }
    /* @} */
