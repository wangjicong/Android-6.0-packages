...
public final class PermissionAppsFragment extends PermissionsFrameFragment implements Callback,
    ...
    public void onResume() {
        super.onResume();
        /* SPRD 513855 app permision deny, crash after package is uninstalled@{ */
        if (!checkPackage(mPackage) && mDialog != null) {
            mDialog.dismiss();
        }
        /* @} */
        mPermissionApps.refresh(true);
        ...
        if (newValue == Boolean.TRUE) {
            ...
            if (grantedByDefault || (!app.hasRuntimePermissions() && !mHasConfirmedRevoke)) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
                        builder.setMessage(grantedByDefault ? R.string.system_warning
                                : R.string.old_sdk_deny_warning);
                        builder.setNegativeButton(R.string.cancel, null);
                        builder.setPositiveButton(R.string.grant_dialog_button_deny,
                                new OnClickListener() {
                            @Override
