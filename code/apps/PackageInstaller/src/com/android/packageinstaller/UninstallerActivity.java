...
public class UninstallerActivity extends Activity {
    ...
    public static class UninstallAlertDialogFragment extends DialogFragment implements
        ...
        //SPRD 522187 fix crash in app info screen
        private boolean mIsAppAvailable = true;
        @Override
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            final PackageManager pm = getActivity().getPackageManager();
            final DialogInfo dialogInfo = ((UninstallerActivity) getActivity()).mDialogInfo;
            /* SPRD 522187 fix crash in app info screen @{ */
            mIsAppAvailable = (dialogInfo == null || dialogInfo.appInfo == null) ? false : true;
            Log.i(TAG, "UninstallAlertDialogFragment mIsAppAvailable " + mIsAppAvailable);
            final CharSequence appLabel = mIsAppAvailable ? dialogInfo.appInfo.loadLabel(pm) : "";
            /* @} */
        ...
        public void onResume(){
            super.onResume();
            if (getActivity() != null && !mIsAppAvailable) {
                getActivity().finish();
            }
        }
        /* @} */
