...
public abstract class ContactEntryListAdapter extends IndexerListAdapter {
    ...
    public void changeCursor(int partitionIndex, Cursor cursor) {
        ...
        /*
         * SPRD: Bug387410 Add contacts starred,could not displayed all contacts photo.
...
//        }
    ...
    protected View newHeaderView(Context context, int partition, Cursor cursor,
        ...
        /* SPRD: add for bug474264
         * Orig:
        View view = inflater.inflate(R.layout.directory_header, parent, false);
         * @{
         */
        View view = inflater.inflate(R.layout.directory_header_overlay, parent, false);
        /**
         * @}
         */
    ...
    */
        ...
        if (itemType == 1) {
            ...
            quickContact.assignContactUri(UriUtils.parseUriOrNull(cursor.getString(lookUpKeyColumn)));
            quickContact.setImageResource(R.drawable.calllog_item_img);
            return;
        }
        ...
        if (photoId != 0 || photoUriColumn == -1) {
            ...
            */
            ...
            if (accountType != null
                ...
                getPhotoLoader().loadPhoto(quickContact, photoUri, -1, mDarkTheme, mCircularPhotos,null,
    ...
    protected Uri getContactUri(int partitionIndex, Cursor cursor,
        ...
        if (contactId == -1 && lookupKey == null) {
            uri = UriUtils.parseUriOrNull(cursor.getString(PhoneNumberListAdapter.PhoneQuery.CACHED_LOOKUP_URI));
        }
        /* @} */
        return uri;
    }
    ...
    /**
    * SPRD:Bug 474752 Add multi-selection feature for Contacts.
    *
    * @{
    */
    ...
    public void updateChecked() {
     ...
     public TreeSet<Long> updateChecked(TreeSet<Long> mCheckedItems) {
        int count = getCount();
        ArrayList<Long> list = getCurrentItems();
       ArrayList<Long> delList = new ArrayList<Long>();
        if (!mCheckedItems.isEmpty()) {
    ...
    public void checkAll(boolean checked, int offset) {
        if (checked) {
            ...
            int count = getCount();
            // SPRD:Bug538355 Select one contacts ,select all->Cannel All and
            // the selected contacts can't be removed
            // Original code:for (; offset < count; ++offset) {
            for (int i = 0; i < count; ++i) {
                Long contactId = getContactId(i);
                if (contactId != 0) {
                    if (mCheckedItems.size() == 0) {
