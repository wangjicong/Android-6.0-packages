...
public class Contact {
     ...
     */
    /**
     * SPRD:Bug474795 Copy contacts between to accounts.
     *
    ...
    */
    public ArrayList<ContentValues> getAllContentValues() {
        ...
        for (RawContact rawContact : mRawContacts) {
            ...
            // If the photo was loaded using the URI, create an entry for the photo binary data.
            if (mPhotoId == 0 && mPhotoBinaryData != null) {
                ContentValues photo = new ContentValues();
                photo.put(Data.MIMETYPE, Photo.CONTENT_ITEM_TYPE);
                photo.put(Photo.PHOTO, mPhotoBinaryData);
    ...
    */
    ...
    public boolean isReadOnly() {
        ...
        for (RawContact rawContact : mRawContacts) {
            isReadOnly = isReadOnly || rawContact.isReadOnly();
        }
        return isReadOnly;
    }
}
