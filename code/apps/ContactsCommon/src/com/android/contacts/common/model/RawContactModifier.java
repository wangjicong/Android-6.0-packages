...
public class RawContactModifier {
    ...
    public static void parseExtras(Context context, AccountType accountType, RawContactDelta state,
        ...
        /*
         * SPRD: Bug468146 Crash when add contacts with org or note from Truecaller.
         * Original Android code:
        if (hasOrg && RawContactModifier.canInsert(state, kindOrg)) {
         * @{
         */
        if (hasOrg && kindOrg != null && RawContactModifier.canInsert(state, kindOrg)) {
        /*
         * @}
         */
         ...
         * @{
         */
        if (hasNotes && kindNotes != null && RawContactModifier.canInsert(state, kindNotes)) {
        /*
         * @}
         */
        ...
        /*
         * SPRD: bug429368 Click on a URL to save to contacts, the Web site does not automatically
         * added to the contacts inside. WebSite.
         * @{
         */
    ...
    private static void parseValues(
        ...
        for (ContentValues values : dataValueList) {
            ...
            /**
             * SPRD: Bug431655 Set picture from the gallery as contacts'avatar only for no_sim contacts.
             *
             * Original Android code:
            ...
            if ((kind.typeOverallMax != 1) || GroupMembership.CONTENT_ITEM_TYPE.equals(mimeType)) {
                ...
                /**
                 * SPRD:Bug535487 switch between edit and compact-edit Group information lost
                 * Original :if (kind.typeOverallMax != -1)
                 *
                 * @{
                 */
