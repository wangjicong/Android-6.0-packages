...
public class RawContactDelta implements Parcelable {
    ...
    public String getAccountName() {
	    ...
	    if(OptConfig.SUNVOV_CUSTOM_C7301_XLL_FWVGA){
		    String s = getValues().getAsString(RawContacts.ACCOUNT_NAME);
		    s = s.replace("SIM1","Master");
		    s = s.replace("SIM2","Slave");           
    ...
    /**
     * SPRD: Bug 421795 Add features with multiSelection activity in Contacts.
     * @{
     */
