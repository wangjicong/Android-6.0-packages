...
public class PhoneNumberListAdapter extends ContactEntryListAdapter {
    ...
    private static final Uri REGULAR_MATCH_URI = Uri.parse(CallLog.Calls.CONTENT_URI + "/regularmatch");
    private static final Uri CALLABLE_MATCH_URI = Uri.parse(CallLog.Calls.CONTENT_URI + "/callabledialmatch");
    /* @} */
    ...
    public void configureLoader(CursorLoader loader, long directoryId) {
        ...
        if (isExtendedDirectory(directoryId)) {
            ...
            /* SPRD: Matching callLog when search in dialpad feature @{ */
            Log.d(TAG,"[Projection]isExtendedDirectory = true");
            /* @} */
        } else {
            ...
            loader.setUri(builder.build());
            /* SPRD: Matching callLog when search in dialpad feature @{ */
            Log.d(TAG, "[Projection] getContactNameDisplayOrder() = " + getContactNameDisplayOrder() + " mIsDialMatchMode =" + mIsDialMatchMode);
            /* @} */
            ...
            if (getContactNameDisplayOrder() == ContactsPreferences.DISPLAY_ORDER_PRIMARY) {
                ...
                * @orig
                * loader.setProjection(PhoneQuery.PROJECTION_PRIMARY); */
                loader.setProjection(mIsDialMatchMode ? PhoneQuery.PROJECTION_DIALMATCH:PhoneQuery.PROJECTION_PRIMARY);
            } else {
                /* SPRD: Matching callLog when search in dialpad feature @{
                * @orig
    ...
    protected void bindView(View itemView, int partition, Cursor cursor, int position) {
        Log.d("PerformanceTest", new SimpleDateFormat("yyyyMMdd-HH:mm:ss:SSS") .format(new Date()) + " PhoneNumberListAdapter bindView begin");
