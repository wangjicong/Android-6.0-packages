...
public abstract class AccountTypeManager {
    ...
    */
    ...
    protected int[] simSdnIconRes = {
            R.drawable.icon_sim1_sdn_sprd, R.drawable.icon_sim2_sdn_sprd,
            R.drawable.icon_sim3_sdn_sprd, R.drawable.icon_sim4_sdn_sprd, R.drawable.icon_sim5_sdn_sprd
    };
    ...
    */
    ...
    /* SPRD:443449 orange_ef porting 188582 @{ */
    public String iccAasUri =  null;
    public String iccSneUri =  null;
    public static final String ACTION_LOAD_AAS = "android.intent.action.LOAD_AAS";
    ...
    */
    ...
    public abstract ArrayList<SimAas> getAasList();
    public abstract int getSneSize();
    public abstract Uri insertAas(Context context, String aas);
    public abstract boolean updateAas(Context context, String aasIndex, String aas);
    public abstract boolean deleteAas(Context context, String aasIndex, String aas);
...
class AccountTypeManagerImpl extends AccountTypeManager
    ...
    */
    ...
    /* SPRD:443449 orange_ef anr/aas/sne @{ */
    private static final int MESSAGE_LOAD_AAS = 2;
    private static final int MESSAGE_UPDATE_AAS_IN_CONTACTS = 3;
    /* @} */
    ...
    private final Runnable mCheckFilterValidityRunnable = new Runnable () {
        @Override
        public void run() {
            /* SPRD: add for bug522082 @{ */
            if (mContext != null && mSimAccounts != null && mSimAccounts.size() > 0) {
                ContactPhotoManager.getInstance(mContext).clearDefaultProviderForAccout(mContext);
            }
            /* @} */
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
             ...
             * @{
             */
            if (intent.getAction().equals(ACTION_LOAD_AAS)) {
    ...
    public AccountTypeManagerImpl(Context context) {
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case MESSAGE_UPDATE_AAS_IN_CONTACTS:
                        ...
                        updateContactData((Context)obj[0], (String)obj[1], (String)obj[2]);
                        break;
                    /* @} */
                }
            }
        ...
        mContext.registerReceiver(mBroadcastReceiver, aasFilter);
        /* @} */
    ...
    public void loadAasList(Context context, Account account) {
        ...
        iccAasUri = AccountManager.get(context).getUserData(account,"icc_aas_uri");

        //avoid NPE
        if (iccAasUri == null) {
            Log.d(TAG,"loadAasList: iccAasUri is null, so return");
            return;
        }

        Cursor aasCursor = resolver.query(Uri.parse(iccAasUri), new String[]{"aas","index"}, null, null, null);
        aasList.clear();
    ...
    protected void loadAccountsInBackground() {
        ...
        for (SyncAdapterType sync : syncs) {
            ...
            */
                ...
                /* SPRD:443449 orange_ef anr/aas/sne @{ */
                Account[] usimAccounts = mAccountManager.getAccounts();
                for (Account account : usimAccounts) {
                    if (account.type.endsWith(ACCOUNT_USIM)) {
                        loadAasList(mContext, account);
                        querySneSize(mContext, account);
                        break;
                    }
                }
                /* @} */
                ...
                Log.d(TAG, "has PhoneAccountType");
         ...
         * @{
         */
        final List<AccountWithDataSet> simAccounts = new ArrayList();
        /**
         * @}
         */
    ...
    */
    ...
    private Drawable getSimIcon(String accountType, String accountName, boolean isSdn) {
        ...
        if (accountType.equalsIgnoreCase(ACCOUNT_SIM) || accountType.equalsIgnoreCase(ACCOUNT_USIM)) {
            ...
            if (simNum == 1) {
                return mContext.getResources().getDrawable(R.drawable.icon_sim_sprd);
            }
            for (int i = 0; i < simNum; i++) {
                if ((i < simIconRes.length) &&
                        accountName.equalsIgnoreCase(NAME_SIM + (i + 1))) {
                    if (isSdn) {
                        return mContext.getResources().getDrawable(simSdnIconRes[i]);
                    } else {
   ...
   public ArrayList<AccountWithDataSet> getAccountsWithNoSim(boolean contactWritableOnly) {
        ensureAccountsLoaded();
        ArrayList<AccountWithDataSet> accountWithNoSim = new ArrayList();
    ...
    */
    ...
    public Uri insertAas(Context context, String aas) {
        ...
        values.put("aas", aas);
        Uri uri = resolver.insert(Uri.parse(iccAasUri), values);
        return uri;
    }
    ...
    public boolean updateAas(Context context, String aasIndex, String aas) {
        ...
        int update = resolver.update(Uri.parse(iccAasUri), values, null, null);
        if (update > 0) {
    ...
    public boolean deleteAas(Context context, String aasIndex, String aas) {
        ContentResolver resolver = context.getContentResolver();
        int update = resolver.delete(Uri.parse(iccAasUri), String.valueOf(aasIndex), null);
        if (update > 0) {
            return true;
        }
        return false;
