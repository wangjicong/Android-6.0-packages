...
public final class ContactListFilter implements Comparable<ContactListFilter>, Parcelable {
    ...
    */
    ...
    public static final int FILTER_TYPE_GROUP_MEMBER_ONLY_PHONE_NUMBER = -8;
    ...
    public static ContactListFilter createGroupFilterOnlyPhoneNumber(Long groupId) {
        return new ContactListFilter(ContactListFilter.FILTER_TYPE_GROUP_MEMBER_ONLY_PHONE_NUMBER, null,null,null,null,
                null, groupId);
    }
