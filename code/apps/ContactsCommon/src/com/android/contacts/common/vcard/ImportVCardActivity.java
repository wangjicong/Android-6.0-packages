...
public class ImportVCardActivity extends Activity implements ImportVCardDialogFragment.Listener {
    ...
    private class VCardCacheThread extends Thread
        ...
        public void run() {
            ...
            try {
                ...
                mWakeLock.release();
                /*
                 * SPRD Bug501964 while contacts ready to import, go to
                 * Settings and change language, back to import interface
                 * and save, back and Contacts crash.
                 * @orig
                ...
                try {
                    ...
                    Log.e(LOG_TAG,"change lauguage exception : " + e.getMessage());
                }
                /*
                 * @}
                 */
    ...
    protected void onCreate(Bundle bundle) {
        ...
        int mSatisfiedPermissionLength =
                RequestImportVCardPermissionsActivity.requiredPermission().length;
        for (String permission : RequestImportVCardPermissionsActivity.requiredPermission()) {
            if (checkSelfPermission(permission)
                != PackageManager.PERMISSION_GRANTED) {
                mSatisfiedPermissionLength--;
            }
        }
        if (mSatisfiedPermissionLength != RequestImportVCardPermissionsActivity
        ...
        if (mIsNeedPromptPermissionMessage && mIsAllPermissionSatisfied) {
            showToast(R.string.re_import_contact);
    ...
    private void showToast(final int message) {
        mMainHandler.post(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(ImportVCardActivity.this, message, Toast.LENGTH_LONG)
                        .show();
            }
        });
    }
