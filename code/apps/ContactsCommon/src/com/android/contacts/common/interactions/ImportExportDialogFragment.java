...
public class ImportExportDialogFragment extends DialogFragment
    ...
    */
    ...
    private boolean handleImportRequest(int resId, int subscriptionId) {
         ...
         * @{
         */
        AccountSelectionUtil.doImport(getActivity(), resId, AccountTypeManager.getInstance(getActivity())
    ...
    private boolean hasExchangeAccount() {
        ...
        AccountTypeManager atm = AccountTypeManager.getInstance(getActivity());
