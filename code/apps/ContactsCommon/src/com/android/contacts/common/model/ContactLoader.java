...
public class ContactLoader extends AsyncTaskLoader<Contact> {
    ...
    private static class ContactQuery {
        static final String[] COLUMNS = new String[] {
                ...
                Data.LAST_TIME_USED,
                /**
                 * SPRD:474795 Copy feature and quick activity menu of SIM contacts.
                 *
                 * @{
                 **/
         ...
         * @{
         **/
        public final static int DISPLAY_ACCOUNT_NAME = 64;
        public final static int DISPLAY_ACCOUNT_TYPE = 65;
        /**
         * @}
         */
        public final static int RAW_CONTACT_IS_READ_ONLY = 66;
    }
    ...
    private Contact loadContactHeaderData(final Cursor cursor, Uri contactUri) {
        ...
        */
        ...
        final String isSdn = cursor.getString(ContactQuery.SYNC1);
        return new Contact(mRequestedUri, contactUri, lookupUri, directoryId, lookupKey,
                contactId, nameRawContactId, displayNameSource, photoId, photoUri, displayName,
                altDisplayName, phoneticName, starred, presence, sendToVoicemail,
                customRingtone, isUserProfile, displayAccountName, displayAccountType, "sdn".equals(isSdn));
        /**
         * @}
         */
    }
    ...
    private ContentValues loadRawContactValues(Cursor cursor) {
        ...
        cursorColumnToContentValues(cursor, cv, ContactQuery.RAW_CONTACT_IS_READ_ONLY);
        return cv;
    }
