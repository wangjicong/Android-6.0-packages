...
public class USimAccountType extends SimAccountType {
    ...
    public USimAccountType(Context context, String resPackageName) {
        ...
        try {
            ...
            /* @} */
            if (isGroupMembershipEditable()) addDataKindEmail(context);
            if (isEmaiFieldEditable()) addDataKindGroupMembership(context);
            mIsInitialized = true;
...
//        }
    ...
    protected DataKind addDataKindPhone(Context context) throws DefinitionException {
         ...
         * @{
         */
        if (EFDisplaySupportUtils.getInstance().isEFDisplaySupport()) {
