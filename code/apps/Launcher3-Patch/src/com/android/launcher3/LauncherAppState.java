...
public class LauncherAppState {
    ...
    static void setLauncherAppsProvider(VolteAppsProvider provider) {
        LauncherAppStateUtils.getInstance().setLauncherCustomeProvider(provider);
    }
    ...
    public static VolteAppsProvider getLauncherAppsProvider() {
        return LauncherAppStateUtils.getInstance().getLauncherAppsCustomeProvider();
    }
    ...
    public boolean getCircularSlidingStatus() {
        ...
        /*SUN:jicong.wang add for page CircularSlidingStatus {@*/
        return sContext.getResources().getBoolean(R.bool.def_circular_slideing_status);
        // return sp.getBoolean(CIRCULAR_SLIDING_STATUS, true);//wangxing
        /*SUN:jicong.wang add for page CircularSlidingStatus @}*/
    }
