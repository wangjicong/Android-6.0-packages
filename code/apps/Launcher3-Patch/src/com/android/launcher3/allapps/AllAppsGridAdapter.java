...
import com.sprd.android.config.OptConfig;//jlb
...
public class AllAppsGridAdapter extends RecyclerView.Adapter<AllAppsGridAdapter.ViewHolder> {
        ...
        switch (viewType) {
            ...
            case ICON_VIEW_TYPE: {
               ...
               if(OptConfig.SUNVOV_MainmenuBgTransparent){
                   icon.setTextColor(mLauncher.getResources().getColor(R.color.workspace_icon_text_color));
               }
               /*sprdFAQ83963: Main menu background transparent--up160602@}*/                
            ...
            case FOLDER_VIEW_TYPE: {
                return new ViewHolder(AllAppsGridAdapterUtils.getInstance().getFolderIcon(mLauncher, parent,
                        mTouchListener, mIconClickListener, mIconLongClickListener));
            }
            default:
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            case ICON_VIEW_TYPE: {
                AppInfo info = (AppInfo)mApps.getAdapterItems().get(position).appInfo;
            ...
            case EMPTY_SEARCH_VIEW_TYPE:
                ...
                break;
            case FOLDER_VIEW_TYPE:
                AllAppsGridAdapterUtils.getInstance().bindFolderInfo(holder, mApps, position);
                break;
        }
    }
