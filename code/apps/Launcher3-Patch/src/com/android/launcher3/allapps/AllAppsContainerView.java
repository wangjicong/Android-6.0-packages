...
public class AllAppsContainerView extends BaseContainerView implements DragSource,
    ...
    public void setApps2Folder(List<AppInfo> apps, List<ItemInfo> items) {
        PluginAllAppsContainerView.getInstance().setApps2Folder(apps, items, mApps);
    }

    public void setApps2Folder(List<ItemInfo> items) {
        PluginAllAppsContainerView.getInstance().setApps2Folder(items, mApps);
    }
    ...
    public Folder getOpenFolder() {
        return PluginAllAppsContainerView.getInstance().getOpenFolder(mAdapter);
    }
    /**
    ...
    protected void onUpdateBackgroundAndPaddings(Rect searchBarBounds, Rect padding) {
        ...
        /*sprdFAQ83963:Main menu background transparent--up160602@{*/
        if(!OptConfig.SUNVOV_MainmenuBgTransparent){
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
		...
		/*SUN:jicong.wang add for search enable */
        if (mSearchBarController != null && !mSearchBarController.isSearchFieldFocused() &&
    ...
    public boolean onLongClick(View v) {
        ...
        mLauncher.showWorkspaceAndHotseat();
        // Start the drag
    ...
    public void beginDraggingFromFolder(View child) {
        PluginAllAppsContainerView.getInstance().beginDraggingFromFolder(child, mLauncher, mIconLastTouchPos, this);
    }

    public void enterSpringLoadedIfNeeded() {
        PluginAllAppsContainerView.getInstance().enterSpringLoadedIfNeeded(this, mLauncher);
    }
