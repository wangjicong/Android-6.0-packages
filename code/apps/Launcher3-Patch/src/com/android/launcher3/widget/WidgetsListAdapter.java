...
public class WidgetsListAdapter extends Adapter<WidgetsRowViewHolder> {
    ...
    public int getItemCount() {
        if (mWidgetsModel == null) {
            Log.w(TAG, "getItemCount mWidgetsModel is null");
            return 0;
        }
    ...
    public void onBindViewHolder(WidgetsRowViewHolder holder, int pos) {
        if (mWidgetsModel == null) {
            Log.w(TAG, "onBindViewHolder mWidgetsModel is null");
            return;
        }
    ...
    /*SPRD: bug540900 ,launcher will crash when add the searsh-box widget. @{*/
    public PendingAddWidgetInfo getPawiTag(PendingAddWidgetInfo pawi) {
        LauncherAppWidgetProviderInfo info = pawi.info;
        return new PendingAddWidgetInfo(mLauncher, info, null);
    }
    /* @} */
