...
public class WorkspaceStateTransitionAnimation {
    ...
    private void animateWorkspace(final TransitionStates states, int toPage, final boolean animated,
        ...
        if (animated) {
            ...
            /* SPRD: bug371310 2014-11-19 Feature circular sliding. @{ */
            LauncherViewPropertyAnimator circularSlidingPanelAlpha = 
                   new LauncherViewPropertyAnimator(circularSlidingPanel).alpha(finalOverviewPanelAlpha);
            circularSlidingPanelAlpha.addListener(new AlphaUpdateListener(circularSlidingPanel,accessibilityEnabled));
            /* SPRD: bug371310 2014-11-19 Feature circular sliding. @} */
            ...
            if (layerViews != null) {
                ...
                // SPRD: bug371310 2014-11-19 Feature circular sliding.
                layerViews.put(circularSlidingPanel, LauncherStateTransitionAnimation.BUILD_AND_SET_LAYER);
            } else {
                // Otherwise let the animator handle layer management.
                hotseatAlpha.withLayer();
                overviewPanelAlpha.withLayer();
                // SPRD: bug371310 2014-11-19 Feature circular sliding.
                circularSlidingPanelAlpha.withLayer();
            }
            ...
            // SPRD: bug371310 2014-11-19 Feature circular sliding.
           // mStateAnimator.play(circularSlidingPanelAlpha);
           ...
           // AlphaUpdateListener.updateVisibility(circularSlidingPanel, accessibilityEnabled);
            /* SPRD: bug371310 2014-11-19 Feature circular sliding. @} */
            if (pageIndicator != null) {
