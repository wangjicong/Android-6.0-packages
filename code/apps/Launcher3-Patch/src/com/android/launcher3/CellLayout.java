...
import com.android.launcher3.extension.ExtensionApplication;
...
public class CellLayout extends ViewGroup implements BubbleTextShadowHandler {
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        /*SUN:jicong.wang add for hotseat icon size same with shortcut icon start {@*/
        if (!res.getBoolean(R.bool.sunvov_hotseat_shortcut_icon_size_same)){        
            mHotseatScale = (float) grid.hotseatIconSizePx / grid.iconSizePx;
        }
        /*SUN:jicong.wang add for hotseat icon size same with shortcut icon end @}*/
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        /** ADD: For support Launcher3-Patch Portable START ++++ **/
        if (ExtensionApplication.ENABLE_PLUGIN && isDragTarget() && mLauncher.mState == Launcher.State.WORKSPACE
                && mLauncher.getWorkspace().getState() == Workspace.State.NORMAL) {
            if (((BaseLauncher) mLauncher).onTouchCellLayout(this, ev)) {
                return true;
            }
        }
        /** ADD: For support Launcher3-Patch Portable END   ++++ **/
