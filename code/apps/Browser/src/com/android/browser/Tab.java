...
class Tab implements PictureListener {
    ...
    private final WebViewClient mWebViewClient = new WebViewClient() {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            Log.i(LOGTAG, "WebChromeClient.onPageStarted: url is: " + url);
            mInPageLoad = true;
        ...
        public void onPageFinished(WebView view, String url) {
            Log.i(LOGTAG, "WebChromeClient.onPageFinished: url is: " + url);
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
             ...
             */
            if (isSnapshot()) {
                Log.d(LOGTAG,"TAB--------mWebViewClient->shouldOverrideUrlLoading()  isSnapshot, url = " + url);
                if (url != null && Util.isMatches(Util.WEB_URL.matcher(url))) {
                    setlive(true);
                }
                return false;
            }
            /*@}*/
            Log.d(LOGTAG,"TAB--------mWebViewClient->shouldOverrideUrlLoading()  url = "+url);
        ...
        public void doUpdateVisitedHistory(WebView view, String url,
             ...
             *@{
             */
            Tab tab = mWebViewController.getTabControl().getCurrentTab();
    ...
    /* SPRD:522198 re-show the permissions prompt if needed(e.g:system caonfig changed)@{ */
    public void reShowGeolocationPermissionsPrompt(){
        if (mInForeground&&(mGeolocationPermissionsPrompt!=null)) {
            mGeolocationPermissionsPrompt.reShowPrompt();
        }
    }
    /* }@ */
    ...
    private final WebChromeClient mWebChromeClient = new WebChromeClient() {
        ...
        private void createWindow(final boolean dialog, final Message msg) {
            ...
            if (dialog) {
                 ...
                 *@{
                 */
                final Tab newTab = mWebViewController.openTab(Controller.NEW_WINDOW,
                        Tab.this, true, true);
                /*@}*/
            ...
            try {
                ...
                Log.e(LOGTAG, "createWindow" + ex.toString());
            }
        }
                    ...
                    new AlertDialog.OnClickListener() {
                        public void onClick(DialogInterface d, int which) {
                            try {
                                ...
                                Log.e(LOGTAG, "onCreateWindow" + ex.toString());
                            }
                        }
                    };
        ...
        public void onReceivedTitle(WebView view, final String title) {
            ...
            /* Fix Bug:496858 Visit YouTube, play anyone video,change "http://m." into "http://ss",prompt "The download link not found" 2015.11.10 start */
            mCurrentState.mUrl = view.getUrl();
            /* Fix Bug:496858 Visit YouTube, play anyone video,change "http://m." into "http://ss",prompt "The download link not found" 2015.11.10 end */
        ...
        public void onPermissionRequest(PermissionRequest request) {
            ...
            getPermissionsPrompt().show(request, mWebViewController.getActivity());
        }
        ...
        public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
            Log.i(LOGTAG, "WebChromeClient.onConsoleMessage: consoleMessage is: " + consoleMessage);
            if (mInForeground) {
        ...
        mWebBackForwardListClient = new WebBackForwardListClient() {
            ...
            public void onNewHistoryItem(WebHistoryItem item) {
                if (mClearHistoryUrlPattern != null) {
                    boolean match =
                        Util.isMatches(mClearHistoryUrlPattern.matcher(item.getOriginalUrl()));
                    if (LOGD_ENABLED) {
    ...
    public ContentValues createSnapshotValues() {
        ...
        values.put(Snapshots.PATH, "");
        values.put(Snapshots.ROOT_PATH, "");
        values.put(Snapshots.BACKGROUND, "");
    ...
    public void loadUrl(String url, Map<String, String> headers) {
         ...
         *@{
         */
        if((null != url)&&(url.equals(Controller.HOME_URL))){
            mWebViewController.openTab(url, false, true, true);
            return;
        }
        /*@}*/
        if (mMainView != null) {
    ...
    protected void capture() {
        ...
        float scaleH = mCaptureHeight/ (float) mMainView.getHeight();
