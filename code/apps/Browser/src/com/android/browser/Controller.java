...
public class Controller
    ...
    public static final boolean SUPPORT_SELECT_DOWNLOAD_PATH = true;
    /*
     ...
     *@{
     */
    public static final boolean SUPPORT_OVERLAY_DOWNLOAD_FILE = true;
     ...
     *@{
     */
    public final static int EDIT_SPEEDDIAL = 8;
    private DefaultHomeView mDefaultHomeView = null;
    public static final String HOME_URL = "browser:home";
    public static final String NEW_WINDOW = "new_window_from_webkit";
    /*@}*/
                    ...
                    case FOCUS_NODE_HREF:
                    {
                        ...
                        switch (msg.arg1) {
                            ...
                            case R.id.download_context_menu_id:
                                 ...
                                 *@{
                                 */
                                if (SUPPORT_SELECT_DOWNLOAD_PATH){
                                    if (url != null){
                                    ...
                                    DownloadHandler.onDownloadStart(Controller.this, mActivity, url,
                                            null, null, null, view.isPrivateBrowsingEnabled(),false);
                                } else {
    ...
    public void onResume() {
        ...
        String saveEngine =Settings.Global.getString(mActivity.getContentResolver(),
                DATABASE_SEARCH_ENGINE);
        mSettings.setSearchEnginerName(saveEngine);
    ...
    public void onDestroy() {
         ...
         *@{
         */
        if(mDefaultHomeView != null){
            mDefaultHomeView.destroy();
            mDefaultHomeView = null;
        }
        /*@}*/
    ...
    public void onPageStarted(Tab tab, WebView view, Bitmap favicon) {
         ...
         */
        View currentView;
        if (Util.SUPPORT_NAVIGATION_TAB){
            currentView = tab.getAttachedView();
        }else{
            currentView = tab.getWebView();
        }
        if(currentView != null){
         ...
         */
        UI localUI = mUi;
        localUI.updateMenuBarState(tab.canGoBack(), tab.canGoForward());
        /*@}*/
    }
    ...
    public boolean shouldOverrideUrlLoading(Tab tab, WebView view, String url) {
        Log.d("UrlHandler","UrlHandler-------->shouldOverrideUrlLoading()  url = "+url);
        /**
         *Add for bottom bar
         *@{
         */
    ...
    public void onDownloadStart(Tab tab, String url, String userAgent,
        ...
        if(SUPPORT_SELECT_DOWNLOAD_PATH){
            ...
            boolean normalMimeType = BrowserPlugInDrm.getInstance().getMimeType(mimetype);
            if ((mimetype != null && !mimetype.equals("application/vnd.oma.dd+xml")
                ...
                DownloadHandler.onDownloadStart(this, mActivity, url, userAgent, contentDisposition, mimetype, false,false);
            }else{
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (intent != null && (extras = intent.getExtras()) != null) {
                        ...
                        if (title != null && url != null) {
                            if(mDefaultHomeView != null){
                                mDefaultHomeView.updateRow(extras);
                            }
                        }
                    }
                }
    ...
    public void onCreateContextMenu(ContextMenu menu, View v,
        ...
        if(v instanceof GridView){
            ...
            View view = i.targetView;
            if(view instanceof SpeedDialItem){
                if(mDefaultHomeView == null){
                    Log.w(LOGTAG,"mDefaultHomeView is null do not show ContextMenu");
                    return;
                }
                int position = i.position + 1;
                if(position == mDefaultHomeView.getCount()&& mDefaultHomeView.getExtraOffset() == 1){
                    Log.i(LOGTAG,"position:" + position);
                    return;
                }
                inflater.inflate(R.menu.speed_dial_context, menu);
            }
            return;
        }
        /*@}*/
    ...
    */
    ...
    public void updateMenuState(Tab tab, Menu menu) {
        ...
        if (tab != null) {
             ...
             *@{
             */
            isLive = !tab.isSnapshot() && !tab.isDefaultHome();
            /*@}*/
        }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            */
             ...
             *@{
             */
            case R.id.open_speed_context_menu_id:
                i = (AdapterView.AdapterContextMenuInfo) item
                            .getMenuInfo();
                // If we have no menu info, we can't tell which item was
                // selected.
                if (i == null || mDefaultHomeView == null) {
                      result = false;
                      break;
                }
                mDefaultHomeView.openSpeedItem(i.position);
                break;
            case R.id.edit_speed_context_menu_id:
                i = (AdapterView.AdapterContextMenuInfo) item.getMenuInfo();
                // If we have no menu info, we can't tell which item was
                // selected.
                if (i == null || mDefaultHomeView == null) {
                    result = false;
                ...
                mDefaultHomeView.editSpeedItem(i.position);
                break;
            case R.id.delete_speed_context_menu_id:
                i = (AdapterView.AdapterContextMenuInfo) item
                        .getMenuInfo();
                // If we have no menu info, we can't tell which item was
                // selected.
                ...
                mDefaultHomeView.deleteSpeedItem(i.position);
                break;
            /*@}*/
            default:
    ...
    boolean isInLoad() {
        ...
        /**
          ...
          *@{
          */
        return (tab != null) && tab.inPageLoad()&& (!(tab.isDefaultHome()));
        /*@}*/
    }
    ...
    private static class Download implements OnMenuItemClickListener {
        ...
        public boolean onMenuItemClick(MenuItem item) {
             ...
             */
            if(SUPPORT_SELECT_DOWNLOAD_PATH){
                DownloadHandler.onDownloadStart(mController, mActivity, mText, null, null, null, mPrivateBrowsing,false);
            }else{
    ...
    public void setActiveTab(Tab tab) {
        ...
        if (tab != null) {
             ...
             *@{
             */
            mUi.updateMenuBarState(tab.canGoBack(), tab.canGoForward());
            /*@}*/
        }
    }
    ...
    public Tab openTab(UrlData urlData) {
        ...
        if (tab == null) {
            /**
              ...
              *@{
              */
            if(isDefaultHomeUrl(urlData.mUrl)){
                tab = createNewDeaultHomeTab(true);
                return tab;
            }else{
                tab = createNewTab(false, true, true);
            }
    ...
    public Tab openTab(String url, boolean incognito, boolean setActive,
        ...
        if (tab != null) {
            ...
            /**
              ...
              *@{
              */
            if ((url != null)&&(!url.equals(NEW_WINDOW))) {
            /*@}*/
                loadUrl(tab, url);
            }
        }
    ...
    public void closeTab(Tab tab) {
        ...
        if(mDefaultHomeView != null){
            ...
            int count = mTabControl.getTabCount();
            for(int i=0; i<count; i++){
                Tab temp =  mTabControl.getTab(i);
                if(temp != null && temp.isDefaultHome()){
                    hasHomeView= true;
                    break;
                }
            }
    ...
    protected void loadUrl(Tab tab, String url, Map<String, String> headers) {
         ...
         *@{
         */
        if(tab != null && tab.isDefaultHome() && HOME_URL.equals(url)){
            return;
        }
        /*@}*/
        if (tab != null) {
...
//          case KeyEvent.KEYCODE_Z:    // unused
    ...
    private String getGlobalStorageLocation(){
        ...
        Log.d(LOGTAG, "----getGlobalStorageLocation--- -:"+selectedLocation);
    ...
    public String getDownloadPath(){
        if(Util.USE_SYETEM_STORGE_PATH){
             ...
             if(globalStorageLocation.equals(STORAGE_SDCARD))
                path = Environment.getExternalStoragePath() + "/Download/";
            else
                path = Environment.getInternalStoragePath() + "/Download/";
            return path;
         }else{
    ...
    public void onDownloadStartNotChoosePath(String url, String userAgent,
            String contentDisposition, String mimetype, boolean privateBrowsing,final boolean closeOnExit)
    {
        ...
        checkDownloadFileIsExists(Controller.this,mActivity, mUrl, mUserAgent, mContentDisposition,
            mMimeType, mPrivateBrowsing, closeOnExit);
    }
    ...
    public void onDownloadStartSavePath(String url, String userAgent, String contentDisposition, String mimetype, boolean privateBrowsing,final boolean closeOnExit){
        ...
        mDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (DataUri.isDataUri(mUrl)) {
                    ...
                    if(SUPPORT_OVERLAY_DOWNLOAD_FILE){
        ...
        if (mDownloadDialog == null){
            ...
            if(!mActivity.isFinishing()){
                ...
                new FetchContentLength(mActivity, mUrl, mUserAgent, mPrivateBrowsing, mDownloadDialog).start();
            }
        }
    }

    private void selectDownloadStorage(){
        showStorage(INTERNAL,SD);
    }
    ...
    public void onDownloadSucessReceiver(Context context , Intent intent){
        ...
        if(OMA_DD_DOWNLOAD_ACTION.equals(intent.getAction())){
            ...
            path = BrowserPlugInDrm.getInstance().getFilePath(path,str,filename);
     ...
     *@{
     */
    public DefaultHomeView getDefaultHomeView(){
        if(mDefaultHomeView == null){
            mDefaultHomeView = new DefaultHomeView(mActivity, this);
        }
        return mDefaultHomeView;
    }

    boolean isDefaultHomeUrl(String url){
        return (url==null && mSettings.getHomePage().equals(HOME_URL))
                || (url != null && url.equals(HOME_URL));
    }

    public DefaultHomeTab createNewDeaultHomeTab(boolean setActive) {

        DefaultHomeTab tab = null;
        if (mTabControl.canCreateNewTab()) {

            tab = mTabControl.createDefaultHomeTab();
    ...
    public void goBacktoHomePage(Tab tab) {
        /**
        *Add for bottom bar
        *@{
        */
