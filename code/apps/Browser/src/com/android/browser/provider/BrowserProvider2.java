...
import com.android.browser.SpeedDial;
...
public class BrowserProvider2 extends SQLiteContentProvider {
    static final String TAG = "BrowserProvider2";
     ...
     *@{
     */
    public static final String TABLE_FILE_SAVE_PATH ="filesavepath";
    private static final int URI_MATCH_FILESAVEPATH = 3;
    private static final int URI_MATCH_FILESAVEPATH_ID = 13;
    /*@}*/
     ...
     *@{
     */
    private static final int URI_MATCH_SPEED_DIAL = 4;
    private static final int URI_MATCH_SPEED_DIAL_ID = 14;
    private static final String TABLE_SPEED_DIAL = "speeddial";
    /*@}*/
    ...
    static {
         ...
         *@{
         */
        matcher.addURI("browser", "filesavepath",URI_MATCH_FILESAVEPATH);
        matcher.addURI("browser", "filesavepath/#",URI_MATCH_FILESAVEPATH_ID);
        /*@}*/
         ...
         *@{
         */
        matcher.addURI(authority, "speeddial",URI_MATCH_SPEED_DIAL);
        matcher.addURI(authority, "speeddial/#",URI_MATCH_SPEED_DIAL_ID);
        /*@}*/
    ...
    final class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
             ...
             *@{
             */
            db.execSQL("CREATE TABLE "+ TABLE_FILE_SAVE_PATH +" (" +
                    "_id INTEGER PRIMARY KEY," +
                    "savepath TEXT" +
                    ");");
            createDefaultSavePath(db);
            /*@}*/
             ...
             *@{
             */
            db.execSQL("CREATE TABLE " + TABLE_SPEED_DIAL + "(" +
                    "_id INTEGER PRIMARY KEY," +
                    "title TEXT," +
                    "url TEXT, " +
                    SpeedDial.FAVICON + " BLOB" +
                    ");");
            /*@}*/
         ...
         *@{
         */
        void createDefaultSavePath(SQLiteDatabase db){
            String path = "";
            ...
            db.insert(TABLE_FILE_SAVE_PATH,null, argsSavepath);
        }
        /*@}*/
        ...
        private void addDefaultBookmarks(SQLiteDatabase db, long parentId) {
            ...
            CharSequence[] bookmarks = SprdBrowserBookmarkAddonStub.getInstance().getBookmarks();
            if (bookmarks == null) {
                bookmarks = res.getTextArray(R.array.bookmarks);
            }
            TypedArray preloads = SprdBrowserBookmarkAddonStub.getInstance().getPreloads();
            if(preloads == null ){
            ...
            try {
                ...
                for (int i = 0; i < size; i = i + 2) {
                    ...
                    try {
                         ...
                         *@{
                         */
                        thumb = SprdBrowserBookmarkAddonStub.getInstance().readRaw(thumbId);
                        if (thumb == null ) {
                            thumb = readRaw(res, thumbId);
                        }
                        /*@}*/
                    ...
                    try {
                         ...
                         *@{
                         */
                        favicon = SprdBrowserBookmarkAddonStub.getInstance().readRaw(faviconId);
                        if (favicon == null) {
                            favicon = readRaw(res, faviconId);
                        }
                        /*@}*/
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
             ...
             *@{
             */
           case URI_MATCH_FILESAVEPATH:
                return "vnd.android.cursor.dir/filesavepath";
           case URI_MATCH_FILESAVEPATH_ID:
                return "vnd.android.cursor.item/filesavepath";
            /*@}*/
            /**
             * Add for navigation tab
             *@{
             */
            case URI_MATCH_SPEED_DIAL:
                return SpeedDial.CONTENT_TYPE;
            case URI_MATCH_SPEED_DIAL_ID:
                return SpeedDial.CONTENT_ITEM_TYPE;
            /*@}*/
        }
        return null;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        if (DEBUG_LOG) {
            String projectionsString = Arrays.toString(projection);
            String selectionArgsString = Arrays.toString(selectionArgs);
            if (uri != null) {
                Log.e(TAG,
                    "query()  for url is " +  uri.toString()
                     + " , projection : " + projectionsString
                     + " , selection : "  + selection
        ...
        switch (match) {
            ...
            case BOOKMARKS_SUGGESTIONS: {
                /*modify for bug496655 Spreadst suggest search begin*/
                //return doSuggestQuery(selection, selectionArgs, limit);
                return doSuggestQueryView(selectionArgs);
                /*modify for bug496655 Spreadst suggest search end*/
            }
            ...
            case URI_MATCH_FILESAVEPATH:
            case URI_MATCH_FILESAVEPATH_ID:{
                qb.setTables(TABLE_FILE_SAVE_PATH);
                break;
            }
            /*@}*/
            /**
             ...
             */
            case URI_MATCH_SPEED_DIAL_ID:
                selection = DatabaseUtils.concatenateWhere(selection, TABLE_SPEED_DIAL + "._id=?");
                selectionArgs = DatabaseUtils.appendSelectionArgs(selectionArgs,
                        new String[] { Long.toString(ContentUris.parseId(uri)) });
                qb.setTables(TABLE_SPEED_DIAL);
                break;
    ...
    public int deleteInTransaction(Uri uri, String selection, String[] selectionArgs,
        ...
        switch (match) {
             ...
             */
            case URI_MATCH_FILESAVEPATH: {
                deleted = db.delete(TABLE_FILE_SAVE_PATH, selection, selectionArgs);
                break;
            }
            /*@}*/
            /**
            ...
            case URI_MATCH_SPEED_DIAL_ID:
                ...
                selectionArgs = DatabaseUtils.appendSelectionArgs(selectionArgs,
                        new String[] { Long.toString(ContentUris.parseId(uri)) });
                deleted = db.delete(TABLE_SPEED_DIAL, selection, selectionArgs);
                break;
            case URI_MATCH_SPEED_DIAL:
                deleted = db.delete(TABLE_SPEED_DIAL, selection, selectionArgs);
                break;
    ...
    public Uri insertInTransaction(Uri uri, ContentValues values, boolean callerIsSyncAdapter) {
        ...
        switch (match) {
             ...
             */
            case URI_MATCH_FILESAVEPATH: {
                long rowID = db.insert(TABLE_FILE_SAVE_PATH, "url",
                        values);
                if (rowID > 0) {
                    uri = ContentUris.withAppendedId(Uri.parse("content://browser/filesavepath"),
                            rowID);
                }
                break;
            }
             ...
             */
            case URI_MATCH_SPEED_DIAL:{
                id = db.insert(TABLE_SPEED_DIAL, null, values);
                break;
            }
            /*@}*/
            default: {
    ...
    public int updateInTransaction(Uri uri, ContentValues values, String selection,
        ...
        switch (match) {
             ...
             */
            case URI_MATCH_FILESAVEPATH: {
                modified = db.update(TABLE_FILE_SAVE_PATH, values,
                        selection,selectionArgs);
                break;
            }
            /*@}*/
            ...
            case URI_MATCH_SPEED_DIAL_ID: {
                ...
                selectionArgs = DatabaseUtils.appendSelectionArgs(selectionArgs,
                        new String[] { Long.toString(ContentUris.parseId(uri)) });
                modified = db.update(TABLE_SPEED_DIAL, values,
                        selection, selectionArgs);
                break;
            }
            case URI_MATCH_SPEED_DIAL: {
    ...
    private static final String SQL_WHERE_ACCOUNT_HAS_BOOKMARKS =
      ...
      /*add for bug496655 Spreadst suggest search begin*/
      private static final String  SUGGEST_SELECTION_VIEW =
          "url LIKE ? OR url LIKE ? OR url LIKE ? OR url LIKE ?"
          + " OR title LIKE ? ";

      private static final String[] SUGGEST_PROJECTION_VIEW = new String[] {
          "_id",
          "url",
          "title",
          bookmarkOrHistoryLiteralView(),
          "date"};

      private static final String SUGGEST_ORDER_BY_VIEW =
          " date DESC";
      private static final String SUGGEST_ORDER_BY =
            TABLE_HISTORY + "." + History.DATE_LAST_VISITED + " DESC";
      private static final String MAX_SUGGESTIONS_SHOW ="10";

      static final String bookmarkOrHistoryLiteralView() {
          return "CASE WHEN bookmark = 1 THEN \""
                  + Integer.toString(R.drawable.ic_bookmark_off_holo_dark) + "\" ELSE \""
                  + Integer.toString(R.drawable.ic_history_holo_dark) + "\" END";
      }

      private Cursor doSuggestQueryView(String[] selectionArgs){
          String selection = null;
          if (selectionArgs != null && !TextUtils.isEmpty(selectionArgs[0])) {
              String like = selectionArgs[0] + "%";
              if (selectionArgs[0].startsWith("http")
                      || selectionArgs[0].startsWith("file")) {
                  selectionArgs[0] = like;
                  ...
                  // To match against titles.
                  selectionArgs[4] = "%"+like;
                  selection = SUGGEST_SELECTION_VIEW;
              }
          }

          Cursor c = mOpenHelper.getReadableDatabase().query(VIEW_OMNIBOX_SUGGESTIONS,
                  SUGGEST_PROJECTION_VIEW, selection, selectionArgs, null, null,
                  SUGGEST_ORDER_BY_VIEW, MAX_SUGGESTIONS_SHOW);

          return new SuggestionsCursor(c);
      }
      /*add for bug496655 Spreadst suggest search end*/
}
