...
public class Util {
    ...
    /*@}*/
    public static final boolean USE_SYETEM_STORGE_PATH = true;
    ...
    /**
     * Add for navigation tab SearchEngine and homepage for CMCC/CUCC
     *@{
     */
    public static boolean SUPPORT_NAVIGATION_TAB = SystemProperties.getBoolean("ro.browser.navigationtab",true);
    public static String HOMEPAGE_OPERATOR_CUST = SystemProperties.get("ro.browser.homepagecust","default");
    public static String ENGINE_OPERATOR_CUST = SystemProperties.get("ro.browser.enginecust","default");
    /*@}*/
        ...
        lengthFilter[0] = new InputFilter.LengthFilter(size) {
            ...
            public CharSequence filter(CharSequence source, int start, int end,
                ...
                if(source != null && source.length() > 0 && dest != null && dest.length() == size) {
                    Toast.makeText(context, R.string.url_too_long, Toast.LENGTH_SHORT).show();
                }
