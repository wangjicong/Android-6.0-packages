...
class TabControl {
     ...
     *@{
     */
    public OnTabCountChangedListener mOnTabCountChangedListener;
    /*@}*/
     ...
     *@{
     */
    public void setOnTabCountChangedListener(OnTabCountChangedListener paramListener) {
        mOnTabCountChangedListener = paramListener;
    }

    public static abstract interface OnTabCountChangedListener {
        public abstract void onTabCountChanged();
    }
    /*@}*/
     ...
     *@{
     */
    DefaultHomeTab createDefaultHomeTab() {
        DefaultHomeTab t = new DefaultHomeTab(mController);
        mTabs.add(t);
         /**
         *Add for bottom bar
         *@{
