...
public class BookmarkUtils {
     ...
     * @param folder of delete bookmark or folder
     ...
     */
        /**
         *Modify for remove bookmark in folder
    ...
    static void displayRemoveBookmarkDialog( final long id, final String title,
        final Context context, final Message msg, final long folder) {
        String message = (folder == 1) ? context.getString(R.string.delete_folder_warning,title):context.getString(R.string.delete_bookmark_warning,title);
        new AlertDialog.Builder(context)
