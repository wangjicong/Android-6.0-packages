...
import com.sprd.android.config.OptConfig;//qiuyaobo,20161103
    ...
    */
    ...
    private void setHomePage() {
        ...
        */
        ...
        //qiuyaobo,20161103,begin //qiuyaobo,20170505,begin
        if(true /*OptConfig.SUN_SUBCUSTOM_S7358_HWD_V6_HD_SKK || OptConfig.SUN_CUSTOM_C7367_HWD_FWVGA_R8 || OptConfig.SUN_CUSTOM_C7367_HWD_FWVGA_R2*/ ) {
             sFactoryResetUrl = mContext.getResources().getString(R.string.homepage_base);       	  
        }
        //qiuyaobo,20161103,end  //qiuyaobo,20170505,end
    ...
    */
    ...
    public String getSearchEngineName() {
         ...
         */
         ...
         /*SUN:jicong.wang modify for default search engine start {@*/        
        String default_value = mContext.getResources().getString(R.string.enginecust);  
        if (default_value.equalsIgnoreCase("baidu")){            
            return mPrefs.getString(PREF_SEARCH_ENGINE, SearchEngine.BAIDU);
        } else if (default_value.equalsIgnoreCase("google")){
            return mPrefs.getString(PREF_SEARCH_ENGINE, SearchEngine.GOOGLE);
        }  
        /*SUN:jicong.wang modify for default search engine end @}*/
