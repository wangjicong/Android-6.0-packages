...
public abstract class BaseUi implements UI {
    ...
    private FrameLayout mMenubarContainer;
    //public boolean isMenuBarShow = false;
    /*@}*/
    ...
    public BaseUi(Activity browser, UiController controller) {
         ...
         *@{
         */
        mMenubarContainer = (FrameLayout) frameLayout.findViewById(
                R.id.menubar_container);
        /*@}*/
    ...
    public void onResume() {
         ...
         */
        if (mMenuBar == null)
            mMenuBar = new MenuBar(mActivity, mUiController, this, mTabControl,mContentView);
        if (Util.SUPPORT_BOTTOM_BAR && !BrowserActivity.isTablet(mActivity))
        ...
        if (ct != null) {
            setActiveTab(ct);
            /*Add for bottom bar*/
            UI localUI = mUiController.getUi();
            localUI.updateMenuBarState(ct.canGoBack(), ct.canGoForward());
            mTabControl.mOnTabCountChangedListener.onTabCountChanged();
            /*@}*/
        }
    ...
    public void onTabDataChanged(Tab tab) {
         ...
         *@{
         */
        if(!mNavigationBar.isEditingUrl()){
            setUrlTitle(tab);
        }
        /*@}*/
        setFavicon(tab);
    ...
    public void onPageStopped(Tab tab) {
        ...
        */
        mTitleBar.setProgress(PageProgressView.MAX_PROGRESS);
    }
    ...
    public void onHideCustomView() {
        ...
        if (mCustomView == null)
            return;
        /* Modify for Bug:502998 Set full screen by the value of BrowserSettings 2015.11.23 start */
        //setFullscreen(false);
        setFullscreen(BrowserSettings.getInstance().useFullscreen());
        /* Modify for Bug:502998 Set full screen by the value of BrowserSettings 2015.11.23 end */
        FrameLayout decor = (FrameLayout) mActivity.getWindow().getDecorView();
     ...
     *@{
     */
    public void updateMenuBarState(boolean Boolean1, boolean Boolean2) {
    }

    public void updateStoploadingState(boolean Boolean1) {
    }
    /*@}*/
     ...
     *@{
     */
    public void addFixedMenuBar(View view) {
        mMenubarContainer.addView(view);
    }
    /*@}*/
}
