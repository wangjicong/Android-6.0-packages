...
public class PhoneUi extends BaseUi {
    ...
    /* SPRD:497959 override onResume  when showingNavScreen, hide softinputmode  @{ */
    @Override
    ...
    public void setActiveTab(final Tab tab) {
        ...
        if (mUseQuickControls) {
            ...
            if(view instanceof WebView ){
                ((BrowserWebView)view).setTitleBar(null);
            }else if(view instanceof DefaultHomeView){
                ((DefaultHomeView)view).setEmbeddedTitleBar(null);
            }else{
                //should never happen
                Log.w(LOGTAG, "removeTabFromContentView mainView:" + view.getClass().getName());
            }
            /*@}*/
             ...
             */
            if(view instanceof WebView ){
                ((BrowserWebView)view).setTitleBar(mTitleBar);
            }else if(view instanceof DefaultHomeView){
                ((DefaultHomeView)view).setEmbeddedTitleBar(null);//SPRD:274641
            }else{
                //should never happen
                Log.w(LOGTAG, "removeTabFromContentView mainView:" + view.getClass().getName());
            }
    ...
    public void updateMenuState(Tab tab, Menu menu) {
         ...
         *@{
         */
        if ((abm != null) && (mTabControl != null) && (mTabControl.getCurrentTab() != null)) {
            abm.setVisible((tab != null) && !tab.isSnapshot() && !showingNavScreen()
                    && !mTabControl.getCurrentTab().isDefaultHome());
        }
        /*@}*/
        ...
        /* Fix Bug:528181 Function is repeated 2016.01.23 */
        if (newtab != null) {
        ...
        //temp remove snapshot menu
        MenuItem snapshot = menu.findItem(R.id.snapshots_menu_id);
    ...
    public void onActionModeStarted(ActionMode mode) {
        if (!isEditingUrl()) {
            ...
            //hide for bug487993 ,no animation.
    ...
    public void showWeb(boolean animate) {
        ...
        if (mTabControl.getTabCount() > 0) {
            Log.d(LOGTAG,"showWeb, tab count is "+mTabControl.getTabCount());
    ...
    void showNavScreen() {
        ...
        if(mActiveTab == null ){
            Log.d(LOGTAG,"showNavScreen, mActiveTab is null");
            return ;
        }
        mActiveTab.capture();
        if (mAnimScreen == null) {
     ...
     *@{
     */
    public void updateMenuBarState(boolean canGoBack,boolean canGoForward) {
        if (mMenuBar != null)
            mMenuBar.changeMenuBarState(canGoBack, canGoForward);
    }

    public void updateStoploadingState(boolean update) {
        if (mMenuBar != null)
            mMenuBar.changeStoploadingState(update);
    }
    /*@}*/
