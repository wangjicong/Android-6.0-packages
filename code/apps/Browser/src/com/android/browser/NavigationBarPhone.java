...
public class NavigationBarPhone extends NavigationBarBase implements
    ...
    void setDisplayTitle(String title) {
         ...
         *@{
         */
        if(title != null && title.endsWith(Controller.HOME_URL)){
            title = mContext.getResources().getString(R.string.home_view_title);
        }
        String  url = null;
        String urlTile = null;
        ...
        if((urlTile != null) && urlTile.equals(mContext.getResources().getString(R.string.home_view_title))){
            title = urlTile;
        }
        /*@}*/
