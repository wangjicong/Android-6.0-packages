...
public class BrowserActivity extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        Log.i(LOGTAG, this + " onCreate, has state: "
                + (icicle == null ? "false" : "true"));
        super.onCreate(icicle);

        if (shouldIgnoreIntents()) {
            Log.i(LOGTAG, "shouldIgnoreIntents, finish");
            finish();
            return;
        }
         ...
         *@{
         */
        if (IntentHandler.handleWebSearchIntent(this, null, getIntent(),null)) {
        /*@}*/
            Log.i(LOGTAG, "handleWebSearchIntent, finish");
            finish();
            return;
        }
        ...
        Log.i(LOGTAG, "BrowserActivity.onCreate end");
    }
    ...
    protected void onNewIntent(Intent intent) {
        Log.i(LOGTAG, "BrowserActivity.onNewIntent");
    ...
    private boolean shouldIgnoreIntents() {
        ...
        Log.i(LOGTAG, "ignore intents: " + ignore);
        return ignore;
    }
    ...
    protected void onResume() {
        super.onResume();
        Log.i(LOGTAG, "BrowserActivity.onResume: this=" + this);
    ...
    protected void onPause() {
        Log.i(LOGTAG, "BrowserActivity.onPause");
        mController.onPause();
        super.onPause();
    }
    ...
    protected void onDestroy() {
        Log.i(LOGTAG, "BrowserActivity.onDestroy: this=" + this);
        super.onDestroy();
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        /* SPRD:522198 re-show the permissions prompt if locale changed@{ */
