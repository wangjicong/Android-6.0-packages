...
public final class CallLogListItemViewHolder extends RecyclerView.ViewHolder
    ...
    // SPRD: add for blacklist.
    public View addToBlacklistButtonView;
    ...
    // SPRD: add the new feature for import call log to blacklist
    private static final String CALL_FIRE_WALL_PACKAGE_NAME = "com.sprd.firewall";
    ...
    public void inflateActionViewStub() {
        ...
        if (stub != null) {
            ...
            /** SPRD: add for blacklist. @{ */
            addToBlacklistButtonView = actionsView.findViewById(R.id.add_to_blacklist_action);
            /* SPRD: add for bug 507966 to hide addToBlacklistButton on guest mode @{ */
            UserManager userManager = (UserManager)
                    mContext.getSystemService(Context.USER_SERVICE);
            // SPRD: modify for new feature for import call log to blacklist
            addToBlacklistButtonView.setVisibility(
                    (userManager.isSystemUser() && isCallFireWallInstalled())
                    ? View.VISIBLE : View.GONE);
            if(OptConfig.SUN_C7359_C5S_FWVGA_FPT){//Kalyy
                addToBlacklistButtonView.setVisibility(View.GONE);
            }
            /* @} */
            /* @} */
        }
    ...
    private boolean isCallFireWallInstalled() {
        ...
        try {
            mContext.getPackageManager().getPackageInfo(
                    CALL_FIRE_WALL_PACKAGE_NAME, PackageManager.GET_ACTIVITIES);
            installed = true;
    ...
    private void bindActionButtons() {
        ...
        if (callType == Calls.VOICEMAIL_TYPE && mVoicemailPlaybackPresenter != null) {
            ...
            /** SPRD: add for blacklist. @{ */
            DialerBlackListUtil.getInstance(mContext).addBlackItem(
                    mContext, addToBlacklistButtonView, number, nameOrNumber);
            /* @} */
        }
