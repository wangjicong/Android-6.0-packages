...
public class SearchFragment extends PhoneNumberPickerFragment {
    ...
    public void onAttach(Activity activity) {
        ...
        /* SPRD: Porting DIALER SEARCH FEATURE,Do not show emptyiew @ {*/
    ...
    public void onStart() {
        super.onStart();
        // SPRD: modify for bug544208
        setShowEmptyListForNullQuery(true);
        // SPRD: modify for bug528960
        setSearchMode(!TextUtils.isEmpty(getQueryString())
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        /* SPRD: add for bug515554 @{ */
        if (mEmptyView == null) {
            View defaultEmptyView = getEmptyView();
            ViewGroup container = null;
            if (defaultEmptyView != null) {
                container = (ViewGroup) defaultEmptyView.getParent();
                container.removeView(defaultEmptyView);
            }

            if (container == null) {
                container = (ViewGroup) getListView().getParent();
            }
        ...
        switch (shortcutType) {
            case DialerPhoneNumberListAdapter.SHORTCUT_INVALID:
                ...
                * break; */
                ...
                int itemTypeIndex = item.getColumnIndex("item_type");
                ...
                if (itemType == 1) {
                    ...
                    if (listener != null) {
                        listener.onCallNumberDirectly(callNumber);
                    }
                }
                break;
            /* @} */
