...
public class AllContactsFragment extends ContactEntryListFragment<ContactEntryListAdapter>
        implements OnEmptyViewActionButtonClickedListener, ContactPhotoManager.SimAccountCallBack {
    ...
    public void onAttach(Activity activity) {
        ...
        ContactPhotoManager.getInstance(activity).setSimAccountCallBack(this);
        mContext = activity;
    ...
    public void onDetach() {
        super.onDetach();
        ContactPhotoManager.getInstance(mContext).setSimAccountCallBack(null);
    }
