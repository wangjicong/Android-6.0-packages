...
public class SmartDialSearchFragment extends SearchFragment
    ...
    /* SPRD: add for bug565731 @{*/
    @Override
    public void onResume() {
        super.onResume();
        mFdnCacheRefreshListener = new FdnCacheRefreshListener();
        if (getActivity() != null) {
            FdnNumberHelper.getInstance(getActivity()).
                    addOnFdnCacheRefreshListener(mFdnCacheRefreshListener);
        }
    }
    ...
    public void onPause() {
        super.onPause();
        if (getActivity() != null && mFdnCacheRefreshListener != null) {
            FdnNumberHelper.getInstance(getActivity()).
                    removeOnFdnCacheRefreshListener(mFdnCacheRefreshListener);
        }
    }

    private class FdnCacheRefreshListener implements FdnNumberHelper.OnFdnCacheRefreshListener {
        @Override
        public void OnFdnCacheRefresh() {
            if (PermissionsUtil.hasContactsPermissions(getActivity())) {
                if (mSmartDialCursorLoader != null) {
                    mSmartDialCursorLoader.forceLoad();
                }
            }
        }
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        if (id == getDirectoryLoaderId()) {
            ...
            * SmartDialCursorLoader loader = new SmartDialCursorLoader(super.getContext()); */
            SmartDialCursorLoader loader = new SmartDialCursorLoader(super.getContext(), true);
            /* @} */
            mSmartDialCursorLoader = loader;
