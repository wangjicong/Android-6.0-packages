...
public class SpeedDialFragment extends Fragment implements OnItemClickListener,
    ...
    private class FdnCacheRefreshListener implements FdnNumberHelper.OnFdnCacheRefreshListener {
        ...
        public void OnFdnCacheRefresh() {
            if (PermissionsUtil.hasContactsPermissions(getActivity())
                    && getLoaderManager().getLoader(LOADER_ID_CONTACT_TILE) != null) {
    ...
    public void onResume() {
        ...
        if (getActivity() != null) {
            ...
            FdnNumberHelper.getInstance(getActivity()).addOnFdnCacheRefreshListener(
                    mFdnCacheRefreshListener);
        }
    ...
    public void onPause() {
        ...
        if (getActivity() != null && mFdnCacheRefreshListener != null) {
            FdnNumberHelper.getInstance(getActivity()).removeOnFdnCacheRefreshListener(
                    mFdnCacheRefreshListener);
        }
    }
