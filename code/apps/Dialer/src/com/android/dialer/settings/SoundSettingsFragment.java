        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_UPDATE_RINGTONE_SUMMARY:
                    ...
                    CharSequence summary = (CharSequence) msg.obj;
                    if (summary != null) {
                        CharSequence target = "%";
                        CharSequence replacement = "%%";
                        if (summary.toString().contains(target)) {
                            summary = summary.toString().replace(target, replacement);
                        }
                    }
                    mRingtonePreference.setSummary(summary);
                    /* @} */
                    break;
            }
        }
