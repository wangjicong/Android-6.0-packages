...
public class ActivityMusic extends Activity implements OnSeekBarChangeListener {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        for (short i = 0; i < numPresets; i++) {
            ...
            /* SPRD: bug fix 494927 add for string @{ */
            Log.v(TAG, "mEQPresetNames is :  " + mEQPresetNames[i]);
    ...
    private void equalizerBandsInit(View eqcontainer) {
        ...
        for (int band = 0; band < mNumberEqualizerBands; band++) {
            ...
            /* SPRD: add for bug508113 add the selection @{ */
            ((TextView) eqcontainer.findViewById(EQViewElementIds[band][0])).setTextSize(TypedValue.
                    COMPLEX_UNIT_DIP, 15);
            /* @} */
