...
public class ControlPanelEffect {
    ...
    /* SPRD:Fix bug 500362 Add   save flat equalizer to be default @{ */
    private final static int PRESET_EQUALIZER_CURRENT_PRESET_DEFAULT = 3; // flat
    /* SPRD:Fix bug 500362 @} */
    // EQ defaults
    ...
    public static void initEffectsPreferences(final Context context, final String packageName,
        ...
        try {
            ...
            synchronized (mEQInitLock) {
                ...
                /* SPRD:Fix bug 500362 When first launch MusicFX, 5 Nand-Equalizers are on 0 dB, the default preset equalizer should be flat = 3 @{ */
