...
public abstract class AbstractActivityController implements ActivityController,
    ...
    /* SPRD:bug475886 add local search function @{ */
    /** Key to store an account in a bundle */
    private final String BUNDLE_QUERY = "query";
    /** Key to store a folder in a bundle */
    private final String BUNDLE_APPROACH = "approach";
    /* @} */
    /**
    ...
    protected void onFolderChanged(Folder folder, final boolean force) {
        ...
        if (!TextUtils.isEmpty(pendingQuery)) {
            mConvListContext = ConversationListContext.forSearchQuery(mAccount, folder,
                    pendingQuery);
    ...
    private void setListContext(Folder folder, String query, boolean isLocal, int approach) {
            ...
            if (!TextUtils.isEmpty(query)) {
                ...
                mConvListContext = ConversationListContext.forFolder(mAccount, folder);
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (target.size() > 0 &&
            ...
            if (id == R.id.archive) {
                ...
                /* SPRD: Modify Bug493368, display correctly the move_to menu. @{ */
    ...
    private class ConversationListLoaderCallbacks implements
        ...
        public Loader<ConversationCursor> onCreateLoader(int id, Bundle args) {
            ...
            if (id == LOADER_LOCAL_SEARCH_CONVERSATION_LIST) {
                ...
                uri = folder.getLocalSearchUri(query, approach);
        ...
        public void onLoadFinished(Loader<ConversationCursor> loader, ConversationCursor data) {
            ...
            final ConversationListFragment convList = getConversationListFragment();
            if (convList != null) {
                convList.updateSearchHeader(loader.getId() == LOADER_LOCAL_SEARCH_CONVERSATION_LIST);
            }
            /* @} */
                ...
                case LOADER_SEARCH:
                    if (data != null && data.getCount() > 0) {
                        ...
                        mConvListContext.setSearchApproach(mActivity.getIntent().getIntExtra(
                                ConversationListContext.EXTRA_SEARCH_APPROACH, SearchParams.DEFAULT_SEARCH_APPROACH));
                        showConversationList(mConvListContext);
                        mActivity.invalidateOptionsMenu();
