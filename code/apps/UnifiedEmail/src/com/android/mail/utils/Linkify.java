...
public class Linkify {
    ...
    /* SPRD: Support @{*/
    public static final int WEB_URLS_SPRD = 0x10;
    /* @} */
    ...
    public static final int ALL = WEB_URLS_SPRD | EMAIL_ADDRESSES | PHONE_NUMBERS | MAP_ADDRESSES;
    /* @} */
    ...
    public static final boolean addLinks(Spannable text, int mask) {
        ...
        /* SPRD: add for mms text @{ */
        if ((mask & WEB_URLS_SPRD) != 0) {
