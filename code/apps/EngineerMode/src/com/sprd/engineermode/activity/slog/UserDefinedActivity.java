...
import com.sprd.engineermode.debuglog.PCLogSettingsActivity;
...
public class UserDefinedActivity extends  Activity  implements View.OnClickListener{
	...
	public void onClick(View v) {
		...
		switch(v.getId()){
			...
			case R.id.btn_commit:
				...
				Toast.makeText(getApplicationContext(), "custom scene is open", Toast.LENGTH_LONG).show();
				break;
			...
			case R.id.rl_gps_log:
				if(!SlogCore.isSupportGPS()){
					Toast.makeText(getApplicationContext(), "Not supported GPS Log！", Toast.LENGTH_SHORT).show();
					return ;
				}
			...
			case R.id.tv_memory_leak:
				Intent im = new Intent(this,com.sprd.engineermode.debuglog.slogui.SdSettingsActivity.class);
				startActivity(im);
				//setMemoryLeak();
				break;
	...
	private void setIQMode(){
		new AlertDialog.Builder(this).setTitle("IQ Mode").setItems(
			new String[] { "WCDMA IQ", "GSM IQ" },new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog,
						...
						switch(which){
							case 0:
								iq = new Intent(getApplication(),com.sprd.engineermode.debuglog.WCDMAIQActivity.class);
								break;
							case 1:
								iq = new Intent(getApplication(),com.sprd.engineermode.debuglog.GSMIQActivity.class);
								break;
						}
						startActivity(iq);
					}   
	...
	private int whichLevel(String x){
		if(x.equals("Debug"))return 0;
		else if(x.equals("Full"))return 1;
		else if(x.equals("Special"))return 2;
		else if(x.equals("Custom"))return 3;
		return 0;
	}
	
	private void setCpLogLevel(){
		new AlertDialog.Builder(this).setTitle("Log Filter").
		setSingleChoiceItems(new String[]{"Debug","Full","Special","Custom"},
				whichLevel(SlogInfo.self().mySharedPreferences.getString("logFilter", "Debug")) , 
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						switch(which){
							case 0:
			                    ...
			                    .commit();
								Toast.makeText(getApplicationContext(), "set Debug", Toast.LENGTH_SHORT).show();
								IATUtils.sendATCmd("AT+SPLOGLEVEL="+SlogCore.LOG_DEBUG_CMD, "atchannel0");
							...
							case 1:
			                    ...
			                    .commit();
								Toast.makeText(getApplicationContext(), "set Full", Toast.LENGTH_SHORT).show();
								IATUtils.sendATCmd("AT+SPLOGLEVEL="+SlogCore.LOG_FULL_CMD, "atchannel0");
								tvCpLogLevel.setText("Log Level Filter \n   Full");
								break;
							case 2:
			                    ...
			                    .commit();
								Toast.makeText(getApplicationContext(), "set Special", Toast.LENGTH_SHORT).show();
								Intent intentSpecialSet = new Intent("android.intent.action.SPECIAL");
							...
							case 3:
			                    ...
			                    .commit();
								Toast.makeText(getApplicationContext(), "set Custom", Toast.LENGTH_SHORT).show();
	...
	public int getDspOutput(){
        ...
        String atResponse = EngineerModeProtocol.sendAt(engconstents.ENG_AT_GETDSPLOG1,
                "atchannel0");
        String responValue = EngineerModeProtocol.analysisResponse(atResponse,EngineerModeProtocol.GET_DSP_LOG);
    ...
    private String analysisResponse(String response, int type) {
        ...
        if(response==null)return IATUtils.AT_FAIL;
                ...
                if (mService != null) {
                    try {
                       ...
                       // mShowSnap.setEnabled(general);
                        mService.setNotification(NOTIFICATION_SNAP, true);
	...
	//@Override
	public void onSlogServiceDisconnected() {
		// TODO Auto-generated method stub
		//super();
		return ;
	}
