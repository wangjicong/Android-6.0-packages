...
public class SlogInfo {
    ...
    public static SlogInfo self(){
        if(slogInfo==null)
        {
            ...
            slogInfo.readData();
            slogInfo.slogStartTime = new Date();
        }
        startSlogDaemon();
    ...
    private Date slogStartTime ;
    
    public void resetStartTime(){
    	slogStartTime = new Date();
    }
        ...
        switch (s){
            ...
            case normal:
            	if(SlogCore.isSupportGPS()){
            		return "main log, event log, system log, radio log, kernel log, bt hci log, modem log, dsp log, wcn log, gnss log";
            	}else{
            		return "main log, event log, system log, radio log, kernel log, bt hci log, modem log, dsp log, wcn log";
            	}
            case data:
                return "main log, event log, system log, radio log, kernel log, apcap log, modem log, dsp log, cpcap log";
            case voice:
                return "main log, event log, system log, radio log, kernel log, modem log, dsp log, dsp pcm data, arm pcm data";
            case modem:
                return "Output Modem Log from Uart!";
            case wcn:
                return "Output WCN Log from Uart!";
            case sim:
                return "main log, event log, system log, radio log, kernel log, modem log, dsp log, SIM drive Log";
            case customer:
            {
            	String info  = "";
    ...
    public Date getSlogStartTime(){
        return slogStartTime;
    }

    public static synchronized void update() {
        SlogAction.writeSlogConfig();
        SlogAction.reloadCache(null);
    }
