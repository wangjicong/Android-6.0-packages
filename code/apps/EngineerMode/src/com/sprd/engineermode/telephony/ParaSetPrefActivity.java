...
public class ParaSetPrefActivity extends PreferenceActivity implements
    ...
    private EMSwitchPreference mSleepModePreference;
    ...
    private boolean isSupportLTE = SystemProperties.get("persist.radio.ssda.mode").equals(
            "tdd-csfb")
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSleepModePreference = (EMSwitchPreference) findPreference(SLEEP_MODE);
        mSleepModePreference.setOnPreferenceChangeListener(this);
   ...
   protected void onStart() {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference instanceof EMSwitchPreference) {
            ...
            if (key.equals(SLEEP_MODE)) {
                if (!mSleepModePreference.isChecked()) {
                    acquireWakeLock();
                    Toast.makeText(ParaSetPrefActivity.this, "success", Toast.LENGTH_SHORT)
                            .show();
                } else {
                    releaseWakeLock();
                    Toast.makeText(ParaSetPrefActivity.this, "success", Toast.LENGTH_SHORT)
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference.getKey().endsWith(MANUAL_MODE)) {
            ...
            /*
             * SPRD: modify 20140514 Spreadtrum of 312036 EngineerMode, para
             * set-manual assert show the result of processing @{
             */
            ...
            if(SystemProperties.getBoolean("persist.sys.sprd.modemreset", false)){
                mProgress = ProgressDialog.show(ParaSetPrefActivity.this, "modem assert...", "Please wait...", false, false);
    ...
    public static class ModemAssertReceiver extends BroadcastReceiver {
        /*
         * if modem reset not open, manual assert can do only one time
         * if modem reset open, manual assert enable when receive broadcast with com.sprd.modemassert.MODEM_STAT_CHANGE action
         */
        @Override
