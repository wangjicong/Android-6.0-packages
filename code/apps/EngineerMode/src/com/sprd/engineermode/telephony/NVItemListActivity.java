...
import com.sprd.engineermode.debuglog.FirBandModeSetActivity;
...
//        }
    ...
    private void processSpengmd008() {
        ...
        addItem(mItemNamesList[6], getval(SPENGMD008_UMTS_CIPHER,spengmd[22]));
        addItem(mItemNamesList[10], getval(SPENGMD008_UE_FACH,spengmd[23]));
    }
    ...
    private void processSpengmdvolte(){
        ...
        */
        ...
        if ( (volte_supported[1].equals("1"))||(volte_supported1[1].equals("1"))) {
