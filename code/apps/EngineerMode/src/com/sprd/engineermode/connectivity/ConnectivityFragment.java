...
public class ConnectivityFragment extends PreferenceFragment implements
    ...
    private static final String KEY_SOFTAP_WIFI_CHANNEL = "softap wifi channel";
    ...
    private Preference mSoftwifiChannel;
...
//                    mSoftwifiChannel.setEnabled(true);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.connectivity, container, false);
        ...
        mStartService.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                mProgress = ProgressDialog.show(mContext, "Start wcnd_eng service", "Please wait...", true, true);
                checkServiceStatus();
            }
        });
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSoftwifiChannel = (Preference) findPreference(KEY_SOFTAP_WIFI_CHANNEL);
        mSoftwifiChannel.setEnabled(false);
