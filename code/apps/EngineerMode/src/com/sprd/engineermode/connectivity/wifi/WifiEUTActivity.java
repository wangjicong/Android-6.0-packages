        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case INIT_TEST_STATUS:
                    if (WifiEUTHelper.insmodeWifi() && WifiEUTHelper.wifiStart()) {
                        ...
                        mResult = WifiEUTHelper.wifiGetStatus();
                            ...
                            mUiThread.post(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    Toast.makeText(WifiEUTActivity.this,
                                            "GET_Power_Save_Mode Fail", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    } else {
                ...
                case DISABLED_POWER_SAVE:
                    mResult = WifiEUTHelper.wifiSetStatusOff();
                ...
                case ENABLED_POWER_SAVE:
                    mResult = WifiEUTHelper.wifiSetStatusOn();
                ...
                case DEINIT_TEST_STATUS:
                    if (!WifiEUTHelper.wifiStop() || !WifiEUTHelper.remodeWifi()) {
                        Toast.makeText(WifiEUTActivity.this,
