...
public class GCFGActivity extends PreferenceActivity implements
OnSharedPreferenceChangeListener,Preference.OnPreferenceClickListener {

    private static final String TAG="GCFGActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = this;
        addPreferencesFromResource(R.xml.pref_gcf_g);
    ...
    public boolean onPreferenceClick(Preference pref) {
        /**
         * NetMode Select dynamic loading Activity 1) LTE:LTEActivity 2)
         * Other:NetModeSelectActivity
         */
