        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (modemType == TelephonyManagerSprd.MODEM_TYPE_TDSCDMA
                        || TelephonyManager.getRadioCapbility() == TelephonyManager.RadioCapbility.TDD_CSFB
                ...
                if (modemType == TelephonyManagerSprd.MODEM_TYPE_WCDMA 
                        || TelephonyManager.getRadioCapbility() == TelephonyManager.RadioCapbility.FDD_CSFB
                        || TelephonyManager.getRadioCapbility() == TelephonyManager.RadioCapbility.CSFB) {
                    str += "WCDMA ";
