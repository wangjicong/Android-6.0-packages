...
public class SwitchBaseActivity extends Activity {
    ...
    public static final String POWER_ON_PATH = "/data/com.sprd.engineermode/shared_prefs/power_on.xml";
    public static final String POWER_ON_NAME = "power_on_info.xml";
    public static final String POWER_OFF_PATH = "/data/com.sprd.engineermode/shared_prefs/power_off.xml";
