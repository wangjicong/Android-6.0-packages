...
public class IOTActivity extends PreferenceActivity implements
    ...
    private boolean isSupportCSFB = SystemProperties.get("persist.radio.ssda.mode").equals(
            "tdd-csfb")
    ...
    private boolean isSupportLTE = "svlte".equals(SystemProperties.get("persist.radio.ssda.mode"))
            || "tdd-csfb".equals(SystemProperties.get("persist.radio.ssda.mode"))
            || "fdd-csfb".equals(SystemProperties.get("persist.radio.ssda.mode"))
            || "csfb".equals(SystemProperties.get("persist.radio.ssda.mode"));
