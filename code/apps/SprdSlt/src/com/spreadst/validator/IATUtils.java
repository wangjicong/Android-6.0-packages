...
public class IATUtils {
    ...
    public static synchronized String sendATCmd(String cmd, String serverName) {
        ...
        int oemResplength = mTelephonyManager.invokeOemRilRequestStrings(
                phoneId, oemReq, oemResp);
        if (oemResplength < 0) {
            Log.d(TAG, "the return value of AT is error");
            strTmp = "the return value of AT is error";
