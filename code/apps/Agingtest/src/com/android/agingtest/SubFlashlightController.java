...
public class SubFlashlightController {
    private static final String TAG = "SubFlashlightController";
    ...
    public SubFlashlightController(Context context) {
        mContext = context;
    ...
    private final CameraManager.AvailabilityCallback mAvailabilityCallback =
        ...
        private void setCameraAvailable(boolean available) {
            boolean changed;
            synchronized (SubFlashlightController.this) {
