...
public class OtaPreParser {
 ...
 // private Intent mIntent;
    ...
    public OtaPreParser(Intent intent, int serviceId) {
        ...
        if (DEBUG) {
            Log.d(TAG, "ota : " + this);
            Log.d(TAG, " header : " + IccUtils.bytesToHexString(mHeader));
            Log.d(TAG, " data : " + IccUtils.bytesToHexString(mData));
            Log.d(TAG, " sec = " + sec + "\n mMac = " + mMac);
    ...
    private int checkPin(byte[] localPin, byte[] pushData, String macData) {
        ...
        try {
            ...
            if (DEBUG) {
                Log.d(TAG, "checkPin localPin:" + IccUtils.bytesToHexString(localPin));
