...
public class WbxmlParser implements XmlPullParser {
    ...
    public void clearData() {
        System.out.println("enter WbxmlParser clearData()");
        elementStack = null;
        nspStack = null;
        nspCounts = null;
        attributes = null;
    ...
    public void require(int type, String namespace, String name) throws XmlPullParserException,
        ...
        if (type != this.type || (namespace != null && !namespace.equals(getNamespace()))
            ...
            exception("expected: "
                    + (type == WAP_EXTENSION ? "WAP Ext."
                            : (TYPES[type] + " {" + namespace + "}" + name)));
    }
    ...
    private final boolean adjustNsp() throws XmlPullParserException {
        ...
        if (any) {
            for (int i = (attributeCount << 2) - 4; i >= 0; i -= 4) {
                ...
                if (cut == 0)
                    throw new RuntimeException("illegal attribute name: " + attrName + " at "
                            + this);
                    ...
                    if (attrNs == null)
                        throw new RuntimeException("Undefined Prefix: " + attrPrefix + " in "
                                + this);
    ...
    public void readAttr() throws IOException, XmlPullParserException {
        ...
        while (id != 1) {
            ...
            id = readByte();
            while (id > 128 || id == Wbxml.SWITCH_PAGE || id == Wbxml.ENTITY || id == Wbxml.STR_I
                    || id == Wbxml.STR_T || (id >= Wbxml.EXT_I_0 && id <= Wbxml.EXT_I_2)
    ...
    String readStrT() throws IOException {
        ...
        // some cache hit rate
        // This will help to minimize the Strings created when invoking
        // readStrT() repeatedly
        if (cacheStringTable == null) {
            // Lazy init if device is not using StringTable but inline 0x03
            // strings
