...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    public void onClick(View v) {
        Object tag = v.getTag();
        if (tag instanceof ShortcutInfo || tag instanceof AppInfo) {
            mLauncher.onClick(v);
        }
    }
    ...
    private boolean beginDrag(View v, boolean accessible) {
        ...
        if (tag instanceof ShortcutInfo) {
            ...
            return FolderPlugins.getInstance().beginDrag(this, tag, v, mLauncher);
        }
        return true;
    }
    ...
    public void doneEditingFolderName(boolean commit) {
        ...
        FolderPlugins.getInstance().updateItem(mInfo, mLauncher);
    ...
    public void bind(FolderInfo info) {
        ...
        ArrayList<ItemInfo> overflow = mContent.bindItems(children);

        // If our folder has too many items we prune them from the list. This is an issue
        // when upgrading from the old Folders implementation which could contain an unlimited
        // number of items.
        for (ItemInfo item: overflow) {
            mInfo.remove(item);
        ...
        // Save folder location information to database.
        FolderPlugins.getInstance().saveFolderLocation(this, mInfo,mLauncher);
    ...
    public void beginExternalDrag(ItemInfo item) {
        mCurrentDragInfo = item;
    ...
    public void onDropCompleted(final View target, final DragObject d,
        ...
        if(FolderPlugins.getInstance().deferDragView(mInfo, successfulDrop, d)) {
            return;
        }
    ...
    @Thunk void replaceFolderWithFinalItem() {
        ...
        Runnable onCompleteRunnable = new Runnable() {
            ...
            public void run() {
                ...
                if (getItemCount() == 1) {
                    ItemInfo finalItem = mInfo.contents.get(0);
