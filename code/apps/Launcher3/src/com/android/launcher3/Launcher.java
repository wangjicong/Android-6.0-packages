...
public class Launcher extends Activity
    ...
    //jxl add
    private void showFirstRunKisa() {
        final String key = "dexp_kisa_started";
        if (!mSharedPrefs.getBoolean(key, false)) {
            // We should update the shared preferences on a background thread
            new Thread("updateKavThread") {
                public void run() {
            ...
            final String kisaPackage = "com.kms.free";
            Intent kisaIntent = getPackageManager().getLaunchIntentForPackage(kisaPackage);
