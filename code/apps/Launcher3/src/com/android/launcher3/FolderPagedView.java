...
public class FolderPagedView extends PagedView {
    ...
    public FolderPagedView(Context context, AttributeSet attrs) {
        ...
        /* SPRD:bug 498406, rows - 1 when screen is land and folder rows more than 1 @{ */
        if (isScreenChange() == true && profile.numFolderRows > 1) {
            mMaxCountY = profile.numFolderRows-1;
        } else {
    ...
    /* SPRD:bug 498406, check the screen is changed or not.
     * If land screen, retrun true.else return false @{ */
     ...
     */
    public ArrayList<ItemInfo> bindItems(ArrayList<ItemInfo> items) {
        ArrayList<View> icons = new ArrayList<View>();
        ArrayList<ItemInfo> extra = new ArrayList<ItemInfo>();
     ...
     */
    public int allocateRankForNewItem(ItemInfo info) {
