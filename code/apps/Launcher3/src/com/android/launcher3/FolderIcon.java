...
public class FolderIcon extends FrameLayout implements FolderListener {
    @Thunk public Launcher mLauncher;
    @Thunk public Folder mFolder;
    ...
    @Thunk public ImageView mPreviewBackground;
    @Thunk public BubbleTextView mFolderName;
    ...
    @Thunk private ArrayList<ItemInfo> mHiddenItems = new ArrayList<ItemInfo>();
    ...
    public static FolderIcon fromXml(int resId, Launcher launcher, ViewGroup group) {
        return FolderIconPlugin.getInstance().fromXml(resId, launcher, group);
    }

    public void bindFolderInfo(FolderInfo folderInfo) {
        //FolderIconPlugin.getInstance().bindFolderInfo(folderInfo, mInfo, mLauncher, mFolder, mFolderName, this);
        DeviceProfile grid = mLauncher.getDeviceProfile();
        mFolderName.setText(folderInfo.title);
        FrameLayout.LayoutParams lp = (FrameLayout.LayoutParams) mPreviewBackground.getLayoutParams();
        lp.topMargin = grid.folderBackgroundOffset;
        lp.width = grid.folderIconSizePx;
        lp.height = grid.folderIconSizePx;
        ...
        setTag(folderInfo);
        mInfo = folderInfo;
        setContentDescription(String.format(mLauncher.getString(R.string.folder_name_format),
                folderInfo.title));
    ...
    OnAlarmListener mOnOpenListener = new OnAlarmListener() {
        public void onAlarm(Alarm alarm) {
            ...
            if (mDragInfo instanceof AppInfo) {
                ...
                item = FolderIconPlugin.getInstance().onAlarm(item, mDragInfo, mInfo);
                /* @} */
            } else {
                // ShortcutInfo or AppInfo
                item = mDragInfo;
            }
    ...
    public void performCreateAnimation(final ItemInfo destInfo, final View destView,
            final ItemInfo srcInfo, final DragView srcView, Rect dstRect,
    ...
    private void onDrop(final ItemInfo item, DragView animateView, Rect finalRect,
    ...
    public void onDrop(DragObject d) {
        ItemInfo item = null;
        item = FolderIconPlugin.getInstance().setItem(d, mInfo);
        mFolder.notifyDrop();
    ...
    public void setFolderEnable(boolean enable){
        FolderIconPlugin.getInstance().setFolderEnable(enable, mFolder);
    }
