...
public class HolographicOutlineHelper {
    ...
    Bitmap createMediumDropShadow(BubbleTextView view) {
        ...
        Log.d("HolographicOutlineHelper","createMediumDropShadow() rect.width() = "+rect.width()+";rect.height = "+rect.height());

        int bitmapWidth = (int) (rect.width() * view.getScaleX());
        int bitmapHeight = (int) (rect.height() * view.getScaleY());

        Log.d("HolographicOutlineHelper","createMediumDropShadow() bitmapWidth = "+bitmapWidth+";bitmapHeight = "+bitmapHeight);
        int key = (bitmapWidth << 16) | bitmapHeight;
        Bitmap cache = mBitmapCache.get(key);
        if (cache == null) {
            /*SPRD:fix bug 500045 , java.lang.IllegalArgumentException: width and height must be > 0@{*/
        ...
        /*SPRD:fix bug 500045 , java.lang.IllegalArgumentException: width and height must be > 0@{*/
        if( cache == null ){
            Log.d("HolographicOutlineHelper","cache is null,return null!");
            return null;
        }
        /*SPRD:fix bug 500045 , java.lang.IllegalArgumentException: width and height must be > 0@}*/
