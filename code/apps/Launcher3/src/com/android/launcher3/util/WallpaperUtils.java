...
import com.sprd.android.config.OptConfig;//Kalyy 20160920
/**
    ...
    public static Point getDefaultWallpaperSize(Resources res, WindowManager windowManager) {
        if (sDefaultWallpaperSize == null) {
            ...
            if (res.getConfiguration().smallestScreenWidthDp >= 720) {
                ...
                if(OptConfig.SUN_C7359_C5D_FWVGA_CHERRY || OptConfig.SUN_SUBCUSTOM_C7356_TYC_S412_ZX || OptConfig.SUN_SUBCUSTOM_C7356_TYC_S417_WVGA){//Kalyy 20160920
                    defaultWidth = 480;
                }else if(OptConfig.SUN_S7358_HWD_HD_V19){
                    defaultWidth = 720;
                }else{
