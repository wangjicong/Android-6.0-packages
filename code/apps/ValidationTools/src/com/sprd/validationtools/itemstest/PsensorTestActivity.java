...
import com.sprd.android.config.OptConfig;//ljb 20160526 add
...
public class PsensorTestActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(OptConfig.SUN_NO_LSENSOR){//ljb 20160602 add
             valueIllumination.setVisibility(View.GONE);
             lsensorProgressBar.setVisibility(View.GONE);
        }
        ...
        pListener = new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent event) {
                ...
                if ((mSensorMax - mSensorMin) > 0
                    ...
                    storeRusult(true);
                    finish();
                }else if(mIsCloseDone && mIsDistantDone&&OptConfig.SUN_NO_LSENSOR){//ljb 20160612 add
                    Toast.makeText(mContext, R.string.text_pass, Toast.LENGTH_SHORT).show();
                                storeRusult(true);
                                finish();
                }
