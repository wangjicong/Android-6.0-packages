    ...
    private void initial() {
        new Thread(new Runnable() {
            ...
            public void run() {
                int modemType;
                try{
                    modemType= Integer.parseInt(SystemProperties.get("ril.radio.modemtype"));
                }catch (Exception e){
                    modemType = 1;
                }

                //TelephonyManagerSprd.getModemType();
                RadioFeatures radioFeatures = TelephonyManager
                        .getRadioFeatures(0);
                ...
                if (modemType == TelephonyManagerSprd.MODEM_TYPE_WCDMA || radioFeatures == RadioFeatures.LTE_FDD_AND_W_AND_GSM_CSFB
                        || radioFeatures == RadioFeatures.TD_LTE_AND_W_AND_GSM_CSFB
                        || radioFeatures == RadioFeatures.TD_LTE_AND_LTE_FDD_AND_W_AND_GSM_CSFB
                        || radioFeatures == RadioFeatures.TD_LTE_AND_LTE_FDD_AND_TD_AND_GSM_CSFB
                        || radioFeatures == RadioFeatures.TD_LTE_AND_LTE_FDD_AND_W_AND_TD_AND_GSM_CSFB
                        || radioFeatures == RadioFeatures.WCDMA_ONLY || radioFeatures == RadioFeatures.WCDMA_AND_GSM) {
                    str += "WCDMA ";
