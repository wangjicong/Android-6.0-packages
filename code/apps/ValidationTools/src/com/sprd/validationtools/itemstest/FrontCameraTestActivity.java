...
public class FrontCameraTestActivity extends BaseActivity implements TextureView.SurfaceTextureListener{
    ...
    private Runnable mR = new Runnable() {
        public void run() {
            showResultDialog(getString(R.string.font_msg_text));
        }
    };
...
//        mSurfaceView = (SurfaceView) findViewById(R.id.surfaceView);
        ...
        /*SUN:jicong.wang modify for front camera flash start {@*/
        if (OptConfig.SUN_FRONT_CAMERA_FLASH){
            mLightMsg.setText(R.string.light_msg_text);
        } else {
            mLightMsg.setText(R.string.font_msg_text);
        }
        /*SUN:jicong.wang modify for front camera flash end @}*/
//        startCamera();
        mHandler = new Handler();
        //mHandler.postDelayed(mR, 5000);
    }
    ...
    private void startCamera() {
        ...
        if (mCamera != null) {
            ...
            //qiuyaobo,20160719,begin
            /*SUN:jicong.wang modify for front camera flash start {@*/            
            if (OptConfig.SUN_FRONT_CAMERA_FLASH){
                parameters.setFlashMode(Parameters.FLASH_MODE_TORCH/*Camera.Parameters.FLASH_MODE_TORCH*/);
            } else {
                parameters.setFlashMode(Parameters.FLASH_MODE_OFF/*Camera.Parameters.FLASH_MODE_TORCH*/);
            }
            /*SUN:jicong.wang modify for front camera flash end @}*/
            //qiuyaobo,20160719,end
