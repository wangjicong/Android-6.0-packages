...
public class HandleApiCalls extends Activity {
    ...
    private void handleSetAlarm(Intent intent) {
        ...
        /* SPRD: Bug 509170 Illegal format conversion exception for CTS @{ */
        ...
        if (hour < 0 || hour > 23 || minutes < 0 || minutes > 59) {
            ...
            if (language.endsWith("zh")) {
                ...
                Voice.notifyFailure(this, getString(R.string.invalid_time, " ", minutes, hour));
            } else {
                Voice.notifyFailure(this, getString(R.string.invalid_time, hour, minutes, " "));
            }
            /* @} */
    ...
    private void setupInstance(AlarmInstance instance, boolean skipUi) {
        ...
        AlarmShutDownManager.createOrUpdateShutDownFile(this, instance);
        /* @} */
