...
public final class AlarmNotifications {
    ...
    public static void showAlarmNotification(Context context, AlarmInstance instance) {
        ...
        if (typeShutdownAlarm != null
                && typeShutdownAlarm.equals("alarm")) {
              // Setup fullscreen intent
             fullScreenIntent = AlarmInstance.createIntent(context, AlarmShutDownActivity.class, instance.mId);
             ...
             nm.cancel(instance.hashCode());
             nm.notify(instance.hashCode(), notification.build());//ljb 20170213 add
            ...
            // Setup fullscreen intent
            fullScreenIntent = AlarmInstance.createIntent(context, AlarmActivity.class,
                    instance.mId);
            // set action, so we can be different then content pending intent
            fullScreenIntent.setAction("fullscreen_activity");
            fullScreenIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK |
