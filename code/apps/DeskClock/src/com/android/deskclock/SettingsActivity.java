    ...
    public static class PrefsFragment extends PreferenceFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (AplicationSupportChange.SUPPORT_ALARM_ALERT_LONG) {
                addPreferencesFromResource(R.xml.settings_sprd);
            } else {
                addPreferencesFromResource(R.xml.settings);
            }
            /* @} */
            ...
            // SPRD Bug 494903 when execute onCreate() need getAllTimezones() again
            //if (mTimezones == null) {
        ...
        private class TimeZoneRow implements Comparable<TimeZoneRow> {
            ...
            public TimeZoneRow(String id, String name) {
                ...
                /* SPRD: bug 474417 wordclock time zone same with calendar and settings timezone @{
                 * @orig
                mOffset = tz.getOffset(mTime);
                */
                mOffset = TimeZonePlugin.getInstance(getActivity()).getTimezoneOffset(tz, mTime);
