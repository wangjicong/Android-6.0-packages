...
public class TimerFragment extends DeskClockFragment implements OnSharedPreferenceChangeListener {
    ...
    // SPRD Bug 496397 When the time of Timer to reach, but delay play ringtone
        ...
        public void run() {
            ...
            for (int i = 0; i < mAdapter.getCount(); i++) {
                ...
                if (t.mState == TimerObj.STATE_RUNNING || t.mState == TimerObj.STATE_TIMESUP) {
                    ...
                    /* SPRD Bug 496397 When the time of Timer to reach, but delay play ringtone @{ */
                    isTimesUp = ((t.mState == TimerObj.STATE_TIMESUP) ? true : false);
                    /* @} */
                    if (t.mView != null) {
                ...
                /* SPRD Bug 496397 When the time of Timer to reach, but delay play ringtone @{ */
                if (t.mTimeLeft <= 0 && !isTimesUp && getActivity() != null) {
                    updateTimerState(t, Timers.TIMES_UP);
                }
                /* @} */
                // The blinking
    ...
    public void onFabClick(View view) {
        if (mLastView != mTimerView) {
            /* SPRD: Bug 527852 click delete and play in same time, timer error @{ */
