...
public class TimerItemFragment extends Fragment {
    ...
    private void onLabelPressed(TimerObj t) {
        ...
        /* SPRD: Bug 508749,520385,522260 java.lang.IllegalStateException: Can not perform this action after onSaveInstanceState @{ */
        if (newFragment != null && !newFragment.isAdded()) {
            newFragment.showAllowingStateLoss(getFragmentManager(), dialogTag);
        }
        /* @} */
    }
}
