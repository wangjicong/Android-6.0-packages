...
public class TimerReceiver extends BroadcastReceiver {
    ...
    /* SPRD: bug 541727 change Alarm Alert interface @{ */
    private static TimerObj liveTimerObj;
    /* @} */
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        if (Timers.NOTIF_IN_USE_SHOW.equals(actionType)) {
            ...
            return;
            /* SPRD: bug 541727 change Alarm Alert interface @{ */
        } else if (("com.android.gallery3d.app.MovieActivity.onPause").equals(actionType)) {
            Log.d(TAG, "receive com.android.gallery3d.app.MovieActivity.onPause,isLiveTimerAlert:"+liveTimerObj);
            if (liveTimerObj != null) {
                startTimerAlert(context,liveTimerObj, prefs);
            }
        }
        /* @} */
        ...
        if (Timers.TIMES_UP.equals(actionType)) {
            ...
            /* SPRD: bug 541727 change Alarm Alert interface @{ */
            if (isLiveMoveTopActivity(context)) {
                liveTimerObj = t;
                Vibrator vibrator = (Vibrator) context.getSystemService(Service.VIBRATOR_SERVICE);
                vibrator.vibrate(3000);
                 return;
            }
            startTimerAlert(context,t,prefs);
            /* @} */
    ...
    private void startTimerAlert(Context context, TimerObj t, SharedPreferences prefs) {
        ...
        // SPRD: Bug 521975 check the callstate of sim card when timer come
        if (!checkCallIsUsing()) {
