...
public class AsyncRingtonePlayer {
    ...
    private static Uri getFallbackRingtoneUri(Context context) {
        ...
        return Uri.parse("android.resource://" + packageName + "/" + R.raw.cesium);
        /* @} */
    }
    ...
    private static class RingtonePlaybackDelegate implements PlaybackDelegate {
        ...
        // SPRD Bug 498479 when delete deskclock ring in filemanager, not recover default ring
        ...
        public void play(Context context, Uri ringtoneUri) {
            ...
            /* SPRD Bug 498479,528419 when delete deskclock ring in filemanager, not recover default ring @{ */
            mLocalPlayer = new MediaPlayer();

            try {
                mLocalPlayer.setDataSource(context, ringtoneUri);
            } catch (SecurityException | IOException e) {
                String alarmUriString = Settings.System.getString(context.getContentResolver(),
                        Settings.System.DEFAULT_ALARM);
                ringtoneUri = (alarmUriString != null ? Uri.parse(alarmUriString) : null);
            } finally {
