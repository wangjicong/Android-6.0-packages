...
public class TouchInterceptor extends ListView {
    ...
    public TouchInterceptor(Context context, AttributeSet attrs) {
        this(context, attrs, -1); // the default remove mode is -1
    }

    public TouchInterceptor(Context context, AttributeSet attrs, int removeMode) {
        super(context, attrs);
        ...
        if (mDragListener != null || mDropListener != null) {
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    if (x < BitmapFactory.decodeResource(this.getResources(),
                            R.drawable.citylist_tile_drag).getWidth()) {
                    ...
                    if (itemnum >= 0) {
                        ...
                        if (y > mLowerBound) {
                            ...
                            if (getFirstVisiblePosition() == 0
                                    && (null != getChildAt(0) && getChildAt(0).getTop() >= getPaddingTop())) {
    ...
    private void startDragging(Bitmap bm, int x, int y) {
        ...
        //v.setBackgroundResource(R.drawable.citylist_tile_drag);
