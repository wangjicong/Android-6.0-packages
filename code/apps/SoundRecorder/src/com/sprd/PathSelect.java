...
//      requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    private void initializeList(){
        String sdState = Environment.getExternalStoragePathState();
        String internalState = Environment.getInternalStoragePathState();
        File internalPath = Environment.getInternalStoragePath();
        File externalPath = Environment.getExternalStoragePath();
