...
public class EditorUiUtils {
    ...
    public static Pair<String,String> getAccountInfo(Context context, boolean isProfile,
        ...
        if (isProfile) {
            ...
            return new Pair<>(
                    context.getString(R.string.label_phone, accountName),
        ...
        if (!TextUtils.isEmpty(accountName)) {
            ...
            /**
             * Sprd492739 DUT Shows Chinese character in contacts edit page.
             *
             * @{
             */
            } else if (PhoneAccountType.ACCOUNT_TYPE.equals(accountType.accountType)) {
                return new Pair<>(
                        context.getString(R.string.label_phone, accountNameDisplayLabel),
