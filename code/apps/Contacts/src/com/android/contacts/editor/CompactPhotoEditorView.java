...
public class CompactPhotoEditorView extends RelativeLayout implements View.OnClickListener {
    ...
    public void setPhoto(Bitmap bitmap) {
        ...
        if (compressed != null) {
            ...
            /**
             * sprd Bug517844 after join with exist contact and set new photo_image, this
             * contact with email couldn't be saved.
             */
            mValuesDelta.put(ContactsContract.Data.MIMETYPE, Photo.CONTENT_ITEM_TYPE);
            /**
             *
             */
        }
