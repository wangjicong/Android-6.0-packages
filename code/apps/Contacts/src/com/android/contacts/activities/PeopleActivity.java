 ...
 */
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        /**
         * SPRD: 534357 DUT shows option for merge even when single contact is selected.
         * Original Android code:
    ...
    private void shareSelectedContacts() {
        ...
        for (Long contactId : mAllFragment.getSelectedContactIds()) {
            ...
            /**
             * SPRD:Bug520489 If lookupUri is null, contact may be FC.
             * @{
             */
            if (lookupUri == null) {
                return;
...
//                break;
    ...
    protected void onSaveInstanceState(Bundle outState) {
        /**
         * SPRD:Bug509659 Bring java.lang.IllegalStateException in contacts while monkey test.
         *
    ...
    */
        ...
        public void onJoinStart() {
               ...
               mProgressDialog = IndeterminateProgressDialog.show(
                                getFragmentManager(), getString(R.string.merge_inprocess),
