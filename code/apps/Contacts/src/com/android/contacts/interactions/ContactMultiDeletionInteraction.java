...
public class ContactMultiDeletionInteraction extends Fragment
     ...
     * @{
     */
    public static boolean isMultiContactsDeleting = false;
    /**
     * @}
     */
    ...
    public void setContactIds(TreeSet<Long> contactIds) {
        ...
        if (isStarted()) {
            ...
            /**
             * SPRD:Bug520489 when loading contacts to be deleted, user should not have other operation.
             * @{
             */
            isMultiContactsDeleting = true;
            /**
             * @}
             */
