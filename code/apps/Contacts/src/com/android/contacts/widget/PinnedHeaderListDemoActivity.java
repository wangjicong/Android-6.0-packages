...
public class PinnedHeaderListDemoActivity extends ListActivity {
    /**
     * SPRD:Bug492887 Add extras null value judgement.
     * @{
     */
    private static final String TAG = PinnedHeaderListDemoActivity.class.getSimpleName();
    /**
     * @
     */
    ...
    protected void onCreate(Bundle bundle) {
        ...
        /**
         * SPRD:Bug492887 Remove exception throw,finish the activity.
         * Original code:
            throw new IllegalArgumentException("Missing required extras");
         * @{
         */
        Log.d(TAG, "IllegalArgumentException:missing required extras");
        finish();
        return;
        /**
         * @}
