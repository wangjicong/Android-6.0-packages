...
public class MultiSelectContactsListFragment extends DefaultContactBrowseListFragment
    ...
    /**
     * sprd Bug505678 join local contacts and SIM contacts,scroll and rotate screen, join
     * complete and set photo for this contact, Contacts app FC.
     *
     * @{
     */
    private static final String EXTRA_KEY_SELECTED_CONTACTS_ID_TYPE = "selected_contacts_id_type";
    /**
     * @}
     */
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
             ...
             * @{
             */
            final HashMap<Long,String> selectedContactIdAndTypes = (HashMap<Long,String>)
                    savedInstanceState.getSerializable(EXTRA_KEY_SELECTED_CONTACTS_ID_TYPE);
            getAdapter().setSelectedContactIdAndTypes(selectedContactIdAndTypes);
            /**
             * @}
             */
            if (mCheckBoxListListener != null) {
    ...
    */
    public HashMap<Long,String> getSelectedContactIdAndTypes() {
        final MultiSelectEntryContactListAdapter adapter = getAdapter();
        return adapter.getSelectedContactIdAndTypes();
    }
    /**
    * @}
    */
    ...
    public void onSaveInstanceState(Bundle outState) {
         ...
         * @{
         */
        outState.putSerializable(EXTRA_KEY_SELECTED_CONTACTS_ID_TYPE, getSelectedContactIdAndTypes());
        /**
         * @}
         */
    }
    ...
    protected boolean onItemLongClick(int position, long id) {
         ...
         * @{
         */
        if (!getAdapter().isLocalContact(position, null)) {
            return false;
        }
        /*
         * @}
         */
        if (getAdapter().isContactReadOnly(position, null)) {
            return false;
        }
    ...
    public void onResume() {
        ...
        if(getActivity() != null && (getActivity() instanceof PeopleActivity) &&
                ((PeopleActivity)getActivity()).mDeduplication) {
            ((PeopleActivity)getActivity()).mDeduplication = false;
            reloadData();
        }
    }
    /**
