 ...
 */
    ...
    //add for Bug 539814 If there's only a fixed number,the contacts can't save
    public int violatePhoneNumberType(RawContactDeltaList set) {
        ...
        for (RawContactDelta state : set) {
            ...
            /**
             * SPRD:Bug539814 If there's only a fixed number,the contacts can't saved
             * @{
             */
            if (!TextUtils.isEmpty(FixedNumberTpye[0])
