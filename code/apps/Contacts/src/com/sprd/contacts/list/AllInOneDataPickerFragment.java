            ...
            if (adjPosition >= 0 && isMultiTabCalling) {
                if (!isChecked
                    ...
                    Toast.makeText(mContext,mContext.getString(
                                    ...
                                    mCheckedLimitCount), Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (!isChecked && ((ContactSelectionActivity) getActivity()).mCheckedLimitCount <= 0) {
                    Toast.makeText(mContext,mContext.getString(
                                    R.string.contacts_selection_for_mms_limit,
                                    mCheckedLimitCount), Toast.LENGTH_SHORT).show();
                    return;
                ...
                getAdapter().setChecked(adjPosition, !isChecked);
                ((ContactSelectionActivity) getActivity()).mCheckedLimitCount = ((isChecked == true) ? ((ContactSelectionActivity) getActivity()).mCheckedLimitCount + 1 : ((ContactSelectionActivity) getActivity()).mCheckedLimitCount - 1);
            }
            refreshRevertButton();
