...
public class AllInOneDataListAdapter extends ContactEntryListAdapter {
    ...
    public void configureLoader(CursorLoader loader, long directoryId) {
        ...
        /**
         * Bug449857 Set CursorLoader's sort order.
         * @{
         */
    ...
    protected void bindPhoto(final ContactListItemView view, Cursor cursor) {
        ...
        if (accountType != null
             ...
             *  getPhotoLoader().loadThumbnail(view.getPhotoView(), photoId, false, false,null,
                        getPhotoLoader().getDefaultPhotoProviderForAccount(mContext, account));
             *  @{ */
            getPhotoLoader().loadThumbnail(view.getPhotoView(), photoId, false, true,null,
