...
import android.provider.Settings.System;//Kalyy
...
public class FmMainActivity extends Activity implements FmFavoriteEditDialog.EditFavoriteListener, FmFavoriteFreqEditDialog.EditFavoriteFreqListener{
    ...
    private TextView mAirplaneTxt = null;//Kalyy Bug 49819
	
    private ImageView mAirplaneImgView = null;//Kalyy Bug 49819

    private View mAirplaneImgViewWrap = null;//Kalyy Bug 49819
    ...
    private RelativeLayout mAirplaneLayout = null;//Kalyy Bug 49819

    private LinearLayout mNoEarphoneTextLayout = null;
	
    private LinearLayout mAirplaneTextLayout = null;//Kalyy Bug 49819
        ...
        public void handleMessage(Message msg) {
            Log.d(TAG,
                    "mHandler.handleMessage, what = " + msg.what + ",hashcode:"
                            + mHandler.hashCode());
            Bundle bundle;
            boolean isAirplane = isAirplaneMode();//Kalyy
            switch (msg.what) {
                /**
                ...
                case FmListener.MSGID_SWITCH_ANTENNA:
                    ...
                    break;
                //Kalyy Bug 49819
                case FmListener.MSGID_SWITCH_AIRPLANE:
                    if(isAirplane){
                        if (mIsActivityForeground) {
                            cancelMainAnimation();
                            playAirplaneOnAnimation();
                        } else {
    ...
    //Kalyy Bug 49819
    private class AirplaneOnListener implements AnimationListener {
        @Override
        public void onAnimationEnd(Animation animation) {
            if(isAirplaneMode()){
                return;
        ...
        @Override
        public void onAnimationStart(Animation animation) {
            mAirplaneImgViewWrap.setElevation(0);
        }
    }

    private class AirplaneOffListener implements AnimationListener {
        ...
        public void onAnimationEnd(Animation animation) {
            ...
            Animation anim = AnimationUtils.loadAnimation(mContext,
                    R.anim.noeaphone_alpha_in);
            mAirplaneLayout.startAnimation(anim);
        }
        ...
        @Override
        public void onAnimationStart(Animation animation) {
            mAirplaneImgViewWrap.setElevation(mMiddleShadowSize);
        }
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (strFreq.length() == 0) {
                                    ...
                                    if (FmUtils.isValidStation(iFreq)) {
                                        ...
                                        showToast(getString(OptConfig.SUN_SUBCUSTOM_S7358_HWD_MITO_QHD || OptConfig.SUNVOV_CUSTOM_C7368_BP_MITO_FWVGA?R.string.range_error_other:R.string.range_error));//sunvov:dlj add for change toast for fm88.0~107.9
                                    }
                                }
                            }
                        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.fm_record_list:
                 ...
                 * @}
                 */
				/*Bug53353:FM radio in the absence of a recording file, view the "saved recording", directly play the existing music files--up170517@{*/
...
//                }
    ...
    private boolean isAirplaneMode() {
        boolean sIsAirplaneMode = System.getInt(mContext.getContentResolver(), System.AIRPLANE_MODE_ON, 0) != 0;
        return sIsAirplaneMode;
    }
    //Kalyy Bug 49819
    /**
    ...
    private void initUiComponent() {
        ...
        //Kalyy Bug 49819
        mAirplaneLayout = (RelativeLayout) findViewById(R.id.airplane);
        mAirplaneTxt = (TextView) findViewById(R.id.airplane_text);
        mAirplaneImgView = (ImageView) findViewById(R.id.airplane_img);
        mAirplaneImgViewWrap = findViewById(R.id.airplane_middle);
        mAirplaneTextLayout = (LinearLayout) findViewById(R.id.airplane_bottom);
        //Kalyy Bug 49819
    ...
    private void playMainAnimation() {
        ...
        if (mAirplaneLayout.isShown()) {
            Animation animation = AnimationUtils.loadAnimation(mContext,
                R.anim.noeaphone_alpha_out);
            mAirplaneTxt.startAnimation(animation);
            mAirplaneImgView.startAnimation(animation);
            animation.setAnimationListener(new AirplaneOnListener());
            mAirplaneTextLayout.startAnimation(animation);
        }
        //Kalyy Bug 49819
    }
    ...
    private void cancelMainAnimation() {
        ...
        //Kalyy Bug 49819
        mAirplaneTxt.clearAnimation();
        mAirplaneImgView.clearAnimation();
        mAirplaneTextLayout.clearAnimation();
        //Kalyy Bug 49819
    }
    ...
    //Kalyy Bug 49819
    private void playAirplaneOnAnimation() {
        if (null == mService) {
            return;
        }
        if (mAirplaneLayout.isShown()) {
        ...
        if (mMainLayout.isShown()) {
            Animation animation = AnimationUtils.loadAnimation(mContext, R.anim.main_alpha_out);
        	mMainLayout.startAnimation(animation);
            animation.setAnimationListener(new AirplaneOffListener());
            mBtnPlayContainer.startAnimation(animation);
        }
        if (mNoHeadsetLayout.isShown()) {
            Animation animation = AnimationUtils.loadAnimation(mContext,
    ...
    private void changeToMainLayout() {
        ...
        //Kalyy Bug 49819
        mAirplaneTextLayout.setVisibility(View.GONE);
        mAirplaneImgView.setVisibility(View.GONE);
        mAirplaneImgViewWrap.setVisibility(View.GONE);
    ...
    private void changeToAirplaneLayout() {
        ...
        mNoHeadsetLayout.setVisibility(View.GONE);
        mNoHeadsetImgViewWrap.setElevation(0);
        mAirplaneTextLayout.setVisibility(View.VISIBLE);
        mAirplaneImgView.setVisibility(View.VISIBLE);
        mAirplaneImgViewWrap.setVisibility(View.VISIBLE);
        mAirplaneLayout.setVisibility(View.VISIBLE);
        mAirplaneImgViewWrap.setElevation(mMiddleShadowSize);
    }
    //Kalyy Bug 49819
...
//                    }
	...
	private void openSavedRecordings() {
		...
		try {
			playMusicIntent.putExtras(extras);
			playMusicIntent.setClassName("com.google.android.music", "com.google.android.music.ui.TrackContainerActivity");
			playMusicIntent.setType("vnd.android.cursor.dir/playlist");
			startActivity(playMusicIntent);
		} catch (ActivityNotFoundException e1) {
			try {
				...
				playMusicIntent.setClassName("com.android.music", "com.android.music.PlaylistBrowserActivity");
				startActivity(playMusicIntent);
			} catch (ActivityNotFoundException e2) {
				try {
					playMusicIntent = new Intent(Intent.ACTION_VIEW);
