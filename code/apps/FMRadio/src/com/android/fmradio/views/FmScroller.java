...
public class FmScroller extends FrameLayout {
    ...
    private static final int ON_PLAY_ANIMATION_DELAY = 0;
    ...
    private void collapseHeader() {
        if (getHeaderHeight() != mMinimumHeaderHeight) {
            ...
            if(OptConfig.SUN_HVGA_CAMERA){
          			animator = ObjectAnimator.ofInt(this, "headerHeight",
                    mMinimumHeaderHeight-65);
          	}else{
          			animator = ObjectAnimator.ofInt(this, "headerHeight",
        ...
        mPopupMenu.setOnMenuItemClickListener(new OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.setfreq:
                        if (mEventListener != null) {
                            mEventListener.onSetFreq(frequency);
                        }
                    /**
                     * @}
                     */
    ...
    public interface EventListener {
        ...
        /**
         * SPRD: bug496334, change station frequency.
         * Callback when click gridview item to change freqency
         *
         * @param frequency The frequency want to change
         */
        void onSetFreq(int frequency);
    }
    ...
    private class Adjuster {
        ...
        private class FirstRangeAdjuster {
            ...
            public FirstRangeAdjuster() {
                ...
                mFmDescriptionStartPaddingLeft = mFrequencyText.getPaddingStart();
            ...
            private void handleScrollLandscapeMode() {
                ...
                /**
                 * SPRD: bug509502 Change station value clickable area.
                 * Original Android code:
                mFrequencyText.setPadding((int) (addPadding + mFmDescriptionStartPaddingLeft),
                        (int) (newMargin), mFrequencyText.getPaddingEnd(),
                        mFrequencyText.getPaddingBottom());
                 * @{
                 */
                RelativeLayout.LayoutParams freqlp = (android.widget.RelativeLayout.LayoutParams) mFrequencyText.getLayoutParams();
                freqlp.topMargin = (int) (newMargin);
                freqlp.leftMargin = (int) (addPadding + mFmDescriptionStartPaddingLeft);
                mFrequencyText.setLayoutParams(freqlp);
                /**
                 * @}
                 */
                ...
                * @{
                */
                RelativeLayout.LayoutParams rdslp = (android.widget.RelativeLayout.LayoutParams) mStationRdsText.getLayoutParams();
                if (currentHeight <= targetHeight) {
                    String stationName = "" + mStationNameText.getText();
                    int stationNameTextWidth = mStationNameText.getPaddingLeft();
                    if (!stationName.equals("")) {
                    ...
                    rdslp.topMargin = (int) (newMargin + lastHeight);
                    rdslp.leftMargin = (int) stationNameTextWidth;
                    mStationRdsText.setLayoutParams(rdslp);
                } else {
                    rdslp.topMargin = (int) (newMargin + lastHeight);
                    rdslp.leftMargin = (int) (16 * mDensity);
                    mStationRdsText.setLayoutParams(rdslp);
                }
                /**
                 * @}
        ...
        private float setNewPadding(TextView current, float newMargin) {
             ...
             * @{
             */
            RelativeLayout.LayoutParams lp = (android.widget.RelativeLayout.LayoutParams) current.getLayoutParams();
            lp.topMargin = (int) (newMargin);
