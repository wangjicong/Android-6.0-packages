...
#define FMR_CONFIG_FILE "/system/priv-app/FMRadio/fm.conf"
...
{   
    ...
    LOGI("chip: %d, band: %d, low_band: %d, high_band: %d, seek_space: %d, max_scan_num: %d, seek_lev: %d, scan_sort: %d, short_ana_sup: %d, rssi_th_l2: %d, mFakeCounter:%d ",  \
...
#if 0 /* the orignal code, use for getting settings from libcustom.so  */
int FMR_get_cfgs(int idx)
{
    int ret = -1;
    ...
    // FMLIB_CORE: chip: 26152, band: 1, low_band: 875, high_band: 1080, seek_space: 1, max_scan_num: 40, seek_lev: 4, scan_sort: 0, short_ana_sup: 0, rssi_th_l2: -102 
    LOGI("chip: %d, band: %d, low_band: %d, high_band: %d, seek_space: %d, max_scan_num: %d, seek_lev: %d, scan_sort: %d, short_ana_sup: %d, rssi_th_l2: %d ",  \
		pfmr_data[idx]->cfg_data.chip,  \
		pfmr_data[idx]->cfg_data.band,  \
		pfmr_data[idx]->cfg_data.low_band, \
		pfmr_data[idx]->cfg_data.high_band, \
