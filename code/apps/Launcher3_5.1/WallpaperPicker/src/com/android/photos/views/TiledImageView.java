...
public class TiledImageView extends FrameLayout {
    ...
    public void setTileSource(TileSource source, Runnable isReadyCallback) {
        ...
        synchronized (mLock) {
            /* SPRD: bug378048 2014-12-06 Porting 336304 texture must release by the thread that generate it. @{ */
            // use the same thread to release the uploaded texture.
            if (mRenderer.source != null) {
                mGLSurfaceView.queueEvent(new ReleaseTextureRunnable(mRenderer.source.getPreview()));
            }
            /* SPRD: bug378048 2014-12-06 Porting 336304 texture must release by the thread that generate it. @} */
    ...
    /* SPRD: bug378048 2014-12-06 Porting 336304 texture must release by the thread that generate it. @{ */
    private static class ReleaseTextureRunnable implements Runnable {
        private BasicTexture mTexture;

        public ReleaseTextureRunnable(BasicTexture texture) {
            mTexture = texture;
        }
