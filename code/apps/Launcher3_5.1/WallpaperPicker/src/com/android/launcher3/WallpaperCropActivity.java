...
public class WallpaperCropActivity extends Activity {
        ...
        actionBar.getCustomView().setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        /* SPRD: bug378042 2014-12-06 Porting 294597 avoid multi-click. @{ */
                        // only allow click once to avoid generate more than one background task.
    ...
    static protected Point getDefaultWallpaperSize(Resources res, WindowManager windowManager) {
        if (sDefaultWallpaperSize == null) {
            ...
            if (isScreenLarge(res)) {
                ...
                if(OptConfig.SUNVOV_C7359_C5D_JIVI){//ljb 20160920 add
                   defaultWidth = 480;
                }else{
    ...
    protected void setWallpaper(Uri uri, final boolean finishActivityWhenDone, int target) { // xihe, 20160706, lock screen wallpaper, SPCSS00295086
        ...
        BitmapCropTask cropTask = new BitmapCropTask(
                this, uri, null, rotation, 0, 0, true, false, null, target); // xihe, 20160706, lock screen wallpaper, SPCSS00295086
        final Point bounds = cropTask.getImageBounds();

        /* SPRD: bug393939 2015-02-02 Bugfix Security exception cause set wallpaper fail. @{ */
        Runnable onEndCrop = new ConditionalRunnable() {
            @Override
            public void run() {
                /* SPRD: bug476794 2015-09-22 Bugfix NullPointerException cause Launcher FC. @{ */
                if (mCondition && bounds != null) {
    ...
    protected void cropImageAndSetWallpaper(Uri uri,
            OnBitmapCroppedHandler onBitmapCroppedHandler, final boolean finishActivityWhenDone, int target) { // xihe, 20160706, lock screen wallpaper, SPCSS00295086
        ...
        Runnable onEndCrop = new ConditionalRunnable() {
            @Override
            public void run() {
                // TODO: chenwei if set wallpaper failed, not call updateWallpaperDimentsions
                if (mCondition) {
        ...
        // inSize maybe a fake bounds of the picture when the internal decoder is
        // DumbBitmapRegionDecoder, we need to notify the BitmapCropTask to handle
        // it properly.
        cropTask.setSuggestBitmapBounds(inSize);
    ...
    protected static class BitmapCropTask extends AsyncTask<Void, Void, Boolean> {
        ...
        private void init(RectF cropBounds, int rotation, int outWidth, int outHeight,
            ...
            /* SPRD: bug397871 2015-01-23 Bugfix limit least crop width/height to 1px. @{ */
        ...
        public Point getImageBounds() {
            /* SPRD: bug375727 2014-12-05 Bugfix avoid OOM when handle in-memory decode. @{ */
            // It will return fake bounds when the picture is two large to handle in
            // DumbBitmapRegionDecoder, so here we also return the fake bounds, or it
            // will cause unexpected scale when save the picture as wallpaper or when
            // create it as a thumbnail image.
            if (mSuggestedBounds != null) {
        ...
        /* SPRD: bug375727 2014-12-05 Bugfix avoid OOM when handle in-memory decode. @{ */
        public void setSuggestBitmapBounds(Point inSize) {
            mSuggestedBounds = new Point(inSize.x, inSize.y);
        }
        /* SPRD: bug375727 2014-12-05 Bugfix avoid OOM when handle in-memory decode. @} */
        ...
        public boolean cropBitmap() {
            ...
            if (mSetWallpaper && mNoCrop) {
                ...
                if (crop == null) {
                    ...
                    /* SPRD: bug375727 2014-12-05 Bugfix avoid OOM when handle in-memory decode. @{ */
                    if (decoder == null) {
                        // scaleDownSampleSize is always calculated by the origin bounds of the picture.
                        // Here we need to find a scale value to avoid OOM if the picture is two large
                        // to handle.
                        BitmapFactory.Options opts = Utils.getPropertyBitmapFactoryOptions(
                                mContext, mInUri, mInFilePath, mResources, mInResId,
                                mInImageBytes, scaleDownSampleSize);

                        // SPRD: bug381427 2014-12-15 Bugfix avoid carsh when picture has wrong size.
                        ...
                        // reset not just decode bounds before reuse the opts return
                        // by Utils.getPropertyBitmapFactoryOptions
                        opts.inJustDecodeBounds = false;

                        is = regenerateInputStream();
                        if (is != null) {
                            fullSize = BitmapFactory.decodeStream(is, null, opts);
                            Utils.closeSilently(is);
                        }
                    }
                ...
                if (mOutWidth > 0 && mOutHeight > 0 || mRotation > 0) {
                    ...
                    if (tmp != null) {
                        ...
                        // SPRD: bug375727 2014-12-05 Bugfix avoid OOM when handle in-memory decode.
                        // no need crop any more, recycle the bitmap for use memory efficiently.
                        crop.recycle();
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (mOnEndRunnable != null) {
                if (mOnEndRunnable instanceof ConditionalRunnable) {
                    ((ConditionalRunnable) mOnEndRunnable).setCondition(result);
                }
                mOnEndRunnable.run();
            }
            /* SPRD: bug393939 2015-02-02 Bugfix Security exception cause set wallpaper fail. @} */
    ...
    private abstract class ConditionalRunnable implements Runnable {
        protected boolean mCondition = true;
