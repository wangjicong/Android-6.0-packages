...
LOCAL_PACKAGE_NAME := Launcher3_5.1
#LOCAL_CERTIFICATE := shared

LOCAL_OVERRIDES_PACKAGES := Launcher2 Home Launcher3

LOCAL_PROGUARD_FLAG_FILES := proguard.flags
# SPRD: bug413347 2015-03-19 Become system app.
...
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := launcher_protoutil_lib_5.1
...
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := launcher_protoutil_5.1

include $(BUILD_SYSTEM)/base_rules.mk

$(LOCAL_BUILT_MODULE): launcher_protoutil_lib_5.1
