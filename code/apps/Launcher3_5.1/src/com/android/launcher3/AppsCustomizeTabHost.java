...
public class AppsCustomizeTabHost extends FrameLayout implements LauncherTransitionable, Insettable  {
    ...
    public void setInsets(Rect insets) {
        if (!mInsets.equals(insets) && mPagedView != null) {
            // force page view to layout
            mPagedView.enableForceLayout(true);
            mPagedView.requestLayout();
        }
    ...
    private void setVisibilityOfSiblingsWithLowerZOrder(int visibility) {
        ...
        View circleSlidePanel = ((Launcher) getContext()).getCircularSlidingPanel();
