...
/* SPRD: bug388051 2014-12-31 Bugfix view still exist when application is removed {@ */
...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    public void onDropCompleted(final View target, final DragObject d,
        ...
        if (successfulDrop) {
            ...
            List<LauncherActivityInfoCompat> activityList = null;
            LauncherActivityInfoCompat resolveActivity = null;
            ComponentName componentName = ((ShortcutInfo)d.dragInfo).intent.getComponent();
            LauncherAppsCompat appsCompat = LauncherAppsCompat.getInstance(getContext());
            UserHandleCompat userHandleCompat = UserHandleCompat.myUserHandle();
            if (componentName != null) {
                activityList = appsCompat.getActivityList(componentName.getPackageName(), userHandleCompat);
            }else{
                resolveActivity = appsCompat.resolveActivity(((ShortcutInfo)d.dragInfo).intent, userHandleCompat);
            }
            if ((activityList != null && activityList.size()>0) || resolveActivity != null) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (LauncherAppState.isDisableAllApps()) {
            ...
            /* SPRD : bug392209 2015-01-12 Bugfix the bottom line is not part of the display. @} */
            if(mContent.getCountY() > 0){
                LauncherAppState app = LauncherAppState.getInstance();
                DeviceProfile grid = app.getDynamicGrid().getDeviceProfile();
                mContent.setCellDimensions(grid.folderCellWidthPx, getContentAreaHeight()
                        / mContent.getCountY());
            }
            /* SPRD : bug392209 2015-01-12 Bugfix the bottom line is not part of the display. @} */
    ...
    public void onRemove(ShortcutInfo item) {
        ...
        if (getItemCount() <= 1) {
            ...
            if (mDragController != null
                    ...
                    && mInfo == mDragController.getDragInfo()) {
                mDragController.cancelDrag();
            }
            /* SPRD: bug386680 2014-12-25 Bugfix wrong FolderIcon dropped when item removed from Folder. @} */

            /* SPRD: bug387722 2014-12-29 Bugfix close the folder if it is opened. @{ */
            if (mInfo.opened) {
