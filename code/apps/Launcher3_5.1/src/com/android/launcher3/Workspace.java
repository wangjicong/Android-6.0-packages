...
public class Workspace extends SmoothPagedView
    ...
    public void onChildViewAdded(View parent, View child) {
        ...
        // SPRD: bug397326 2015-01-22 Bugfix DragEnforcer instance leak.
        cl.registerDragEnforcerInstance(mDragController);
    }
    ...
    public void onChildViewRemoved(View parent, View child) {
        ...
        if (child instanceof CellLayout) {
            ...
            final View tempChild = child;
            Runnable removeDragEnforcerInstance = new Runnable() {
                public void run() {
                    ((CellLayout) tempChild).unregisterDragEnforcerInstance(mDragController);
                }
            };
            mLauncher.addOnDeferredRemoveEnforcerCallbacks(removeDragEnforcerInstance);
            /* SPRD: bug411675 2015-03-6 Bugfix avoid java.util.ConcurrentModificationException. @} */
        }
    }
    /* SPRD: bug397326 2015-01-22 Bugfix DragEnforcer instance leak. @} */
    ...
    protected void screenScrolled(int screenCenter) {
        ...
        // SPRD: bug371310 2014-11-19 Feature circular sliding.
        shouldOverScroll = shouldOverScroll && !mIsSupportCircular;
    ...
    */
    ...
    boolean willCreateUserFolder(ItemInfo info, CellLayout target, int[] targetCell, float
        ...
        if (dropOverView != null) {
            ...
            if (lp.useTmpCoords && (lp.tmpCellX != lp.cellX || lp.tmpCellY != lp.cellY)) { //bug409946 coverity problem.
                return false;
            }
        }
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    void removeItemsByComponentName(final HashSet<ComponentName> componentNames,
        ...
        for (final CellLayout layoutParent: cellLayouts) {
            ...
            /*SPRD: bug410501 coverity 105605 problem, Inefficient Map Iterator, 2015-3-3. @{
            ...
            Iterator iter = folderAppsToRemove.entrySet().iterator();
            while(iter.hasNext()) {
                Map.Entry<FolderInfo, ArrayList<ShortcutInfo>> entry = (Map.Entry<FolderInfo, ArrayList<ShortcutInfo>>)iter.next();
                FolderInfo folder = entry.getKey();
                ArrayList<ShortcutInfo> appsToRemove = entry.getValue();
                    for (ShortcutInfo info : appsToRemove) {
                        folder.remove(info);
                    }
            }
        ...
        mapOverItems(MAP_RECURSE, new ItemOperator() {
            ...
            public boolean evaluate(ItemInfo info, View v, View parent) {
                if (info instanceof ShortcutInfo && v instanceof BubbleTextView &&
                    ...
                    if (si.updateStackSize >= 1) {
                        if (si.updateStackSize == 1) {
                            si.isDisabled = si.delayValue;
                        }
