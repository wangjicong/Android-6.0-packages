...
public class DeviceProfile {
    ...
    private void updateIconSize(float scale, int drawablePadding, Resources resources,
        ...
        /* Sunvov:dlj 160504 add start @{ */
        //if (OptConfig.SUNVOV_C7356_C4S_SUPPORT||OptConfig.SUNVOV_C7356_C4_SUPPORT){
            iconSizePx=iconSizePx-8;
        //}
        /* Sunvov:dlj 160504 add end @} */
        ...
        cellHeightPx = iconSizePx + iconDrawablePaddingPx + (int) Math.ceil(fm.bottom - fm.top)*2;//Kalyy 20160903
        ...
        /* Sunvov:dlj 160504 add start @{ */
        //if (OptConfig.SUNVOV_C7356_C4S_SUPPORT||OptConfig.SUNVOV_C7356_C4_SUPPORT){
            folderCellWidthPx = folderCellWidthPx+8;
            folderCellHeightPx = folderCellHeightPx+8;
        //}
        /* Sunvov:dlj 160504 add end @} */	
