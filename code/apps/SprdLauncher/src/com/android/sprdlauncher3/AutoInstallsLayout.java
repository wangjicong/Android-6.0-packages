...
public class AutoInstallsLayout {
    ...
    protected class AppShortcutParser implements TagParser {
        ...
        public long parseAndAdd(XmlResourceParser parser) {
            ...
            //Main menu Launcher's workspace is all shortcut
            final String type = LauncherAppState.isDisableAllApps() ? getAttributeValue(parser,ATTR_TYPE) : TAG_SHORTCUT;
            ...
            if (!TextUtils.isEmpty(packageName) && !TextUtils.isEmpty(className)) {
                ...
                try {
                    ...
                    //SPRD for default workspace shortcut can be remove
                    return addShortcut(info.loadLabel(mPackageManager).toString(),
                            intent, (TAG_SHORTCUT.equals(type) ? Favorites.ITEM_TYPE_SHORTCUT : Favorites.ITEM_TYPE_APPLICATION));
