...
public class SearchDropTargetBar extends FrameLayout implements DragController.DragListener {
    ...
    public void showSearchBar(boolean animated) {
        ...
        if(LogUtils.DEBUG_WIDGET){
            LogUtils.d("SearchDropTargetBar showSearchBar","mQSBSearchBar="+mQSBSearchBar
                    +" mQSBSearchBar.Alpha:"+(mQSBSearchBar != null ? mQSBSearchBar.getAlpha() : "mQSBSearchBar = null")
                    +"mIsSearchBarHidden="+mIsSearchBarHidden
    ...
    public void hideSearchBar(boolean animated) {
        boolean needToCancelOngoingAnimation = mQSBSearchBarAnim.isRunning() && !animated;
        if(LogUtils.DEBUG_WIDGET){
            LogUtils.d("SearchDropTargetBar hideSearchBar","mQSBSearchBar="+mQSBSearchBar
                    +" mQSBSearchBar.Alpha:"+(mQSBSearchBar != null ? mQSBSearchBar.getAlpha() : " mQSBSearchBar = null")
                    +" mIsSearchBarHidden="+mIsSearchBarHidden
                    +" needToCancelOngoingAnimation="+needToCancelOngoingAnimation);
        }
