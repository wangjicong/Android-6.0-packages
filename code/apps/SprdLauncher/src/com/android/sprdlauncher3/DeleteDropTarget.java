...
public class DeleteDropTarget extends ButtonDropTarget {
    ...
    private boolean isAllAppsApplication(DragSource source, Object info) {
        return source.supportsAppInfoDropTarget(info) && (info instanceof AppInfo);
    }
    ...
    public static boolean willAcceptDrop(Object info) {
        if (info instanceof ItemInfo) {
            ...
            if(item.itemType == LauncherSettings.Favorites.ITEM_TYPE_APPLICATION){
                return Utilities.hasDownloadFlag(info);
            }
        }
        return false;
    }
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        ...
        boolean useUninstallLabel = source.supportsAppInfoDropTarget(info) && Utilities.hasDownloadFlag(info) ;
        boolean useDeleteLabel = !useUninstallLabel && source.supportsDeleteDropTarget(info);
    ...
    private boolean isUninstallFromWorkspace(DragObject d) {
        // Only allow singlelayer download application in workspace or folder to initiate an un-install.
        return isDragSourceWorkspaceOrFolder(d) && Utilities.isApplication(d.dragInfo) && Utilities.hasDownloadFlag(d.dragInfo) ;
    }
