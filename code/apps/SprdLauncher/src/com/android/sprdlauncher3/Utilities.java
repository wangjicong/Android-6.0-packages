...
public final class Utilities {
    ...
    static boolean isApplication(Object info) {
    ...
    static boolean hasDownloadFlag(Object info) {
        if (info instanceof ShortcutInfo) {
            return (((ShortcutInfo) info).flags & AppInfo.DOWNLOADED_FLAG ) != 0;
        } else if(info instanceof AppInfo){
            return (((AppInfo) info).flags & AppInfo.DOWNLOADED_FLAG) != 0;
        } else {
            return false;
        }
    }
    ...
    public static AppWidgetProviderInfo getSearchWidgetProvider(Context context) {
        ...
        for (AppWidgetProviderInfo info : appWidgetManager.getInstalledProviders()) {
            if(LogUtils.DEBUG_WIDGET) {
                LogUtils.d(TAG, "all widgets info.provider = " + info.provider);
            }
