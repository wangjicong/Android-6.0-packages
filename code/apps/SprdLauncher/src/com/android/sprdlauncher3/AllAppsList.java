...
class AllAppsList {
    ...
    public void add(AppInfo info) {
        if (LogUtils.DEBUG_SL) {
            LogUtils.d(TAG, "Add application in app list: app = " + info.componentName
                    + ", title = " + info.title);
        }
    ...
    public void removePackage(String packageName, UserHandleCompat user, boolean clearCache) {
        ...
        if (LogUtils.DEBUG_SL) {
            LogUtils.d(TAG, "removePackage: packageName = " + packageName + ", data size = " + data.size());
        }
    ...
    public void updatePackage(Context context, String packageName, UserHandleCompat user) {
        ...
        final List<LauncherActivityInfoCompat> matches = launcherApps.getActivityList(packageName,
                user);
        if (LogUtils.DEBUG_SL) {
            LogUtils.d(TAG, "updatePackage: packageName = " + packageName + ", matches = " + matches.size());
        }
