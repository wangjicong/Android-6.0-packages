...
public class DeviceProfile {
    ...
    private void updateAvailableDimensions(Context context) {
        ...
        //qiuyaobo,20175025,begin
        //float scale = 1f;
        float scale = 0.9f;
        //qiuyaobo,20175025,end

        int drawablePadding = iconDrawablePaddingOriginalPx;
        //qqiuyaobo,20175025,begin
        //updateIconSize(1f, drawablePadding, resources, dm);
        updateIconSize(0.9f, drawablePadding, resources, dm);
        //qiuyaobo,20175025,end
    ...
    public void layout(Launcher launcher) {
        ...
        // Layout the Effects Mode
        ViewGroup effectsPanel = launcher.getEffectsPanel();
        if (effectsPanel != null) {
            Rect r = getOverviewModeButtonBarRect();
            lp = (FrameLayout.LayoutParams) effectsPanel.getLayoutParams();
            lp.gravity = Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM;
            lp.width = FrameLayout.LayoutParams.MATCH_PARENT;//availableWidthPx;//Math.min(availableWidthPx, maxWidth);
            lp.height = r.height();
            effectsPanel.setLayoutParams(lp);
