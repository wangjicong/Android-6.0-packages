...
public class FolderIcon extends FrameLayout implements FolderListener {
    ...
    public int getmIntrinsicIconSize() {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        FolderIconController controller = mLauncher.getFolderIconController();
        if(controller == null || controller.drawNativeFolderIconIfNeeded(canvas,this)){
