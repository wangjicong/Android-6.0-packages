...
import com.sprd.android.config.OptConfig;//qiuyaobo,20170513
...
public class BubbleTextView extends TextView {
    ...
    public void applyFromShortcutInfo(ShortcutInfo info, IconCache iconCache,
        ...
        //qiuyaobo,20170513,begin
        if(OptConfig.SUN_SUBCUSTOM_C7367_HWD_QHD_R12_IPHONE && (info.getTargetComponent()!=null) && "com.android.vending".equals(info.getTargetComponent().getPackageName())){
        	info.title = "APP Store";
        }
		    //qiuyaobo,20170513,end       
    ...
    public void applyFromApplicationInfo(AppInfo info) {
        ...
        mIconSize = grid.allAppsIconSizePx;
        topDrawable.setBounds(0, 0, grid.allAppsIconSizePx, grid.allAppsIconSizePx);
        setCompoundDrawables(null, topDrawable, null, null);
        setCompoundDrawablePadding(grid.iconDrawablePaddingPx);
        
        //qiuyaobo,20170513,begin
        if(OptConfig.SUN_SUBCUSTOM_C7367_HWD_QHD_R12_IPHONE && (info.componentName!=null) && "com.android.vending".equals(info.componentName.getPackageName())){
        	info.title = "APP Store";
        }
		    //qiuyaobo,20170513,end  
    ...
    private void drawDynamicIcon(Canvas canvas) {
        ...
        center[1] = getScrollY() + getPaddingTop() + (mIconSize / 2);
