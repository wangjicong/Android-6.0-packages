...
public class LauncherProvider extends ContentProvider {
    ...
    //flag of load default workspace don't use it,
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            if (version < 9) {
                ...
                loadFavorites(db, new DefaultLayoutParser(mContext, mAppWidgetHost, this,
                        mContext.getResources(), (LauncherAppState.isDisableAllApps() ? R.xml.singlelayer_update_workspace : R.xml.update_workspace)));
                version = 9;
            }
    ...
    public void clearFirstLoadFlag(){
        isFirstLoad = false;
    }
