...
import com.sprd.android.config.OptConfig;//qiuyaobo,20170522
...
public class WallpaperCropActivity extends Activity {
    ...
    protected static Point sWallpaperSize;
    protected static int sLastWidth;
    ...
    static protected Point getDefaultWallpaperSize(Resources res, WindowManager windowManager) {
        if (sDefaultWallpaperSize == null) {
            ...
            //qiuyaobo,20170522,begin
            if(OptConfig.SUN_SUBCUSTOM_C7367_HWD_QHD_R12_IPHONE) {
		            Point realSize = new Point();
		            windowManager.getDefaultDisplay().getRealSize(realSize);
		            sDefaultWallpaperSize = new Point(realSize.x, realSize.y);
            } else {
            		sDefaultWallpaperSize = new Point(defaultWidth, defaultHeight);
            }
            //qiuyaobo,20170522,end
        }
        return sDefaultWallpaperSize;
    }

    static protected Point getDefaultWallpaperSize(Resources res, WindowManager windowManager, int width) {
    ...
    protected void cropImageAndSetWallpaper(
        ...
        final Point outSize = getDefaultWallpaperSize(getResources(),
                getWindowManager(), width);
        ...
        Runnable onEndCrop = new Runnable() {
            public void run() {
                ...
                updateWallpaperDimensions(outSize.x, outSize.y);
                if (finishActivityWhenDone) {
                    setResult(Activity.RESULT_OK);
                    finish();
                }
    ...
    protected static class BitmapCropTask extends AsyncTask<Integer, Void, Boolean> {
        Uri mInUri = null;
        Context mContext;
        String mInFilePath;
        byte[] mInImageBytes;
