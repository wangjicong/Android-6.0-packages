...
public class MoviePlayerVideoView extends VideoView
    ...
    public void stopPlayback() {
        ...
        synchronized (mReleaseLock) {
            if (mMediaPlayer != null) {
                ...
                mCurrentState = STATE_IDLE;
                mTargetState = STATE_IDLE;
                /*SUN:jicong.wang modify for SUN_BREATHINGLIGHT start  @{ */
        		if(OptConfig.SUN_BREATHINGLIGHT){
        			Intent breathLightIntent = new Intent("system.movie.stop");
        			mContext.sendBroadcast(breathLightIntent);
        		}
        		/*SUN:jicong.wang modify for SUN_BREATHINGLIGHT end  @} */
            }
        }
    }
    ...
    public void start() {
        if (isInPlaybackState()) {
            ...
            /*SUN:jicong.wang modify for SUN_BREATHINGLIGHT start  @{ */
    		if(OptConfig.SUN_BREATHINGLIGHT){
    			Intent breathLightIntent = new Intent("system.movie.play");
        		mContext.sendBroadcast(breathLightIntent);
    		}
    		/*SUN:jicong.wang modify for SUN_BREATHINGLIGHT end @} */
        }
