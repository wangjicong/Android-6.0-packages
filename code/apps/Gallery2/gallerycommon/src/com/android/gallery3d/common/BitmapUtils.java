...
public class BitmapUtils {
    ...
    public static boolean isSupportedByRegionDecoder(String mimeType,boolean lowram) {
        if (mimeType == null) return false;
        mimeType = mimeType.toLowerCase();
        // SPRD: Modify 20160112, bmp support region decode now @{
        /*
        ...
        */
        ...
        return mimeType.startsWith("image/") &&
                (!mimeType.equals("image/gif") && !mimeType.endsWith("wbmp"));
        // @}
    }
