...
public class LocalImage extends LocalMediaItem {
    ...
    // SPRD:for bug 531403,Title Title and displayName are not consistent
    ...
    protected boolean updateFromCursor(Cursor cursor) {
        ...
        Log.d(TAG, "filePath = "+cursor.getString(INDEX_DATA));
    ...
    public int getSupportedOperations() {
        ...
        if (BitmapUtils.isSupportedByRegionDecoder(mimeType,GalleryUtils.isLowRam)) {
    ...
    public MediaDetails getDetails() {
        ...
        /* SPRD: Drm feature start @{ */
        details = LocalMediaItemUtils.getInstance().getDetailsByAction(this, details, DrmStore.Action.DISPLAY);
        /* @} SPRD: Drm feature end */
        return details;
    }
