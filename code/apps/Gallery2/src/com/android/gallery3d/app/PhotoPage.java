...
public abstract class PhotoPage extends ActivityState implements
     ...
     * @{
     */
    private boolean mTrimvideoEnable = System.getProperty("ro.config.trimvideo", "disable") == "enable";
    /* @} */
    ...
    public void onCreate(Bundle data, Bundle restoreState) {
        ...
        PhotoPageUtils.getInstance().getFirstPickIsDrmPhoto(data);
        ...
        mHandler = new SynchronizedHandler(mActivity.getGLRoot()) {
            ...
            public void handleMessage(Message message) {
                switch (message.what) {
                    ...
                    /* SPRD: Drm feature start @{ */
                    default: if (PhotoPageUtils.getInstance().cosumeDrmRights(message)) throw new AssertionError(message.what);
                    /* SPRD: Drm feature end @} */
                }
            }
        };
    ...
    private void updateMenuOperations() {
        ...
        if (mCurrentPhoto.getMediaType() == MediaObject.MEDIA_TYPE_GIF) {
            supportedOperations &= ~MediaObject.SUPPORT_EDIT;
        }
        /* @} */
        /* SPRD: fix bug 387548, WBMP don't support edit @{ */
        if(mCurrentPhoto.getMediaType() == MediaObject.MEDIA_TYPE_IMAGE_WBMP) {
        supportedOperations &= ~MediaObject.SUPPORT_EDIT;
        }
        /* @} */
...
//        }
        ...
        if (mCurrentPhoto.getMediaType() == MediaObject.MEDIA_TYPE_VIDEO
                || mCurrentPhoto.getMediaType() == MediaObject.MEDIA_TYPE_UNKNOWN) {
            return false;
        }
        /* @} */
        return true;
    ...
    protected boolean onItemSelected(MenuItem item) {
        ...
        switch (action) {
            ...
            default :
                /* SPRD: Drm feature start @{ */
                if (MenuExecutorUtils.getInstance().showHideDrmDetails(PhotoPage.this,
    ...
    public void onSingleTapUp(int x, int y) {
        ...
        boolean playGif = item.getMediaType() == MediaObject.MEDIA_TYPE_GIF;
        if (playVideo || playGif) {
        ...
        if (playVideo) {
            ...
            AlertDialog.OnClickListener onClickListener = new AlertDialog.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    playVideo((Activity) mActivity, itemDrm.getPlayUri(), itemDrm.getName());
                }
            };
    ...
    private void setCurrentPhotoByIntent(Intent intent) {
        ...
        if (path != null) {
            ...
            Path albumPath = mApplication.getDataManager().getDefaultSetOf(true,path);
            /**@}*/
            if (albumPath == null) {
                return;
            }
