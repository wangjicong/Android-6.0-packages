...
public class AbstractGalleryActivity extends Activity implements GalleryContext {
    ...
    // SPRD: Add for bug547276, use HandlerThread to avoid ANR
    ...
    public void printSelectedImage(Uri uri) {
        ...
        try {
            ...
            /* SPRD: Add for bug547276, use HandlerThread and get looper to be used for print @{ */
            int tid = mHandlerThread.getThreadId();
            Looper looper = mHandlerThread.getLooper();
            Log.d(TAG, "<printSelectedImage> mHanderThread id:"+tid+", looper:"+looper);
            printer.printBitmap(path, uri, new PrintHelper.OnPrintFinishCallback() {
                @Override
