...
public class GLRootView extends GLSurfaceView
    ...
    public GLRootView(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (Debug.isMonkey()) {
            Log.d(TAG, "<GLRootView> thread id:" + Thread.currentThread().getId());
        }
    ...
    private class IdleRunner implements Runnable {
        ...
        public void run() {
            ...
            mRenderLock.lock();
            /* SPRD: Modify 20160311 for bug541402, NPE thrown if mCanvas is null caused by unknown reason @{ */
    ...
    public boolean isFreezed() {
        Log.d(TAG, "<isFreezed> thread id:" + Thread.currentThread().getId());
        return mFreeze ? true : false;
    }
    // @}
}
