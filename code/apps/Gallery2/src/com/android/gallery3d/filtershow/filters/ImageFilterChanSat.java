...
public class ImageFilterChanSat extends ImageFilterRS {
    ...
    private boolean checkStop() {
        RenderScript rsCtx = getRenderScriptContext();
        // SPRD: Modify 20160115 for bug525444, gallery will crash if RenderScript context is destroyed
        // in method CachingPipeline#destroyRenderScriptContext @{
        if (rsCtx == null) {
            Log.d(LOGTAG, "<checkStop> RenderScript context is destroyed already.");
            return true;
        }
        // @}
        rsCtx.finish();
