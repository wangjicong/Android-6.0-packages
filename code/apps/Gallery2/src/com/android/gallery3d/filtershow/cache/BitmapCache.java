...
public class BitmapCache {
    ...
    public synchronized Bitmap getBitmap(int w, int h, int type) {
        ...
        if (bitmap == null
                || bitmap.getWidth() != w
                || bitmap.getHeight() != h) {
            /* SPRD: Fix bug 508723, java.lang.IllegalArgumentException:width and height must be > 0. @{ */
            w = w < 1 ? 1 : w;
            h = h < 1 ? 1 : h;
            /* SPRD: Fix bug 508723, java.lang.IllegalArgumentException:width and height must be > 0. @} */
...
//                    w, h, Bitmap.Config.ARGB_8888);
            bitmap = LargeImageProcessingUtils.createBitmapWithFixedSize(w, h, Bitmap.Config.ARGB_8888);
            /* @} */
            showBitmapCounts();
        }
    ...
    public synchronized Bitmap getBitmapCopy(Bitmap source, int type) {
        ...
        // SPRD: Add 20150803 Spreadst of bug447092
