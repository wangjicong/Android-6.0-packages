...
public abstract class ImageFilterRS extends ImageFilter {
    ...
    public Bitmap apply(Bitmap bitmap, float scaleFactor, int quality) {
        ...
        // SPRD: Modify 2016011 for bug522566, android.support.v8.renderscript.RSRuntimeException
        //  thrown for unknown reason, catch it also @{
        } catch (android.support.v8.renderscript.RSRuntimeException e) {
            Log.e(LOGTAG, "RS runtime exception ? ");
        // @}
