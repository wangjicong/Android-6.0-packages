...
public class TiledTexture implements Texture {
    ...
    private final static String TAG = "TiledTexture";
    ...
    private static class Tile extends UploadedTexture {
        ...
        protected Bitmap onGetBitmap() {
            /* SPRD: Bug 505309, 511262 while freeResources , sCanvas maybe null @} */
            if (sCanvas == null) {
            ...
            if (localBitmapRef != null) {
                ...
                // SPRD: check bitmap is recycled or not before use it.
                if (!localBitmapRef.isRecycled()) {
