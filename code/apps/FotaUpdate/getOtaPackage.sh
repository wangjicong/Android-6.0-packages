...
#device
mkdir -p  $ROOTPATH/device/sprd/whale2/common
cp -u device/sprd/whale2/common/modem.cfg device/sprd/whale2/common/nvmerge.cfg $ROOTPATH/device/sprd/whale2/common/
...
cp -u $1/fota_partition.txt $ROOTPATH/fota_partition.txt
...
#productName
#jiazhenl 20160912 modify begin
#var=$(grep  "ro.product.name=" "$1/system/build.prop" )
#productName=${var##"ro.product.name="}
#productName=${productName/ /}
var=$(grep  "ro.fota.version=" "$1/system/build.prop" )
productName=${var##"ro.fota.version="}
productName=${productName/ /}
#jiazhenl 20160912 modify end
...
#zip
cd otaPackage
zip -rq otaPackage.zip build device out vendor configure.xml build.prop fota_partition.txt ota_target_files.zip
cd ..
