...
public class AnalogClock extends View {
    ...
    private boolean mNoHourMinute = false;
    ...
    public AnalogClock(Context context, AttributeSet attrs,
        ...
        //if (FeatureOption.SUNVOV_HALL_LEATHER_HUAWEI_ANALOG_CLOCK) {
		    //    mDial = r.getDrawable(R.drawable.clock_analog_huawei_dial);
        //} else {
  ...
  //      long millis = System.currentTimeMillis() % 1000;
    ...
    public void enableHourMinute(boolean enable) {
        mNoHourMinute = !enable;
    }
