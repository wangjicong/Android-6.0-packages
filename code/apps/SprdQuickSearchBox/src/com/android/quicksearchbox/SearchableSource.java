...
public class SearchableSource extends AbstractSource {
    ...
    public CharSequence getLabel() {
        /* Modify 20121214 Spreadst of 104801,language change problem start */
         /*
        if (mLabel == null) {
            // Load label lazily
        ...
        */
        mLabel = mActivityInfo.loadLabel(getContext().getPackageManager());
        /* Modify 20121214 Spreadst of 104801,language change problem end */
        return mLabel;
    }
...
/* Modify 20121214 Spreadst of 104320,can't dispaly all serarch content start */
/*
        return mSearchable.getSuggestThreshold();
*/
        return 0;
/* Modify 20121214 Spreadst of 104320,can't dispaly all serarch content end */
    }
    ...
    private Cursor getSuggestions(Context context, SearchableInfo searchable, String query,
        ...
        Log.d("liuyj", "query(" + uri + ",null," + selection + ","
                + Arrays.toString(selArgs) + ",null)");
