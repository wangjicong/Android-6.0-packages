...
public class ListSuggestionCursor extends AbstractSuggestionCursorWrapper {
    ...
    private int mPos = 0;
    /*Add logs 20160308 for 537000 IndexOutOfBoundsException */
    private static final String TAG = "ListSuggestionCursor";
    ...
    public int getPosition() {
        Log.d(TAG, "getPosition().mPos ：" + mPos);
        return mPos;
    }
...
//      if (mPos >= size) {
    ...
    protected Suggestion current() {
        ...
        Log.d(TAG, "mPos ：" + mPos);
        Log.d(TAG, "mSuggestions.size() ：" + getCount());
