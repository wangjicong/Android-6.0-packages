...
public class SearchActivity extends Activity {
    ...
    /* SPRD: 504763 add request permission code @{ */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /* SPRD: 511007 check storage permission  @{ */
    ...
    protected void launchSuggestion(SuggestionCursor suggestions, int position) {
        ...
        Uri uri = Uri.parse("content://applications/applications/com.android.quicksearchbox/com.android.quicksearchbox.SearchActivity");
        if (intent == null || intent.getData() == null || 0 != intent.getData().compareTo(uri) ) {
            launchIntent(intent);
        }else {
            Toast.makeText(SearchActivity.this, R.string.repeat_start_search, Toast.LENGTH_SHORT).show();
        }
    }
