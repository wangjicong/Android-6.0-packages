...
public class HeadsetService extends ProfileService {
    ...
    /*
    SPRD: add for Bug514575 begin 2015-12-18
    In case HeadsetService is stopped by Task Manager, stop() will not be called.
    Add error handling in cleanup() to avoid leaking IntentReceiver.
     */
    ...
    protected boolean start() {
        ...
        try {
            ...
            /* SPRD: add for Bug514575 begin */
            mIsReceiverRegistered = true;
            /* SPRD: add for Bug514575 end */
        } catch (Exception e) {
    ...
    protected boolean stop() {
        Log.v(TAG, "stop unregisterReceiver");
        try {
            /* SPRD: add for Bug514575 begin */
    ...
    protected boolean cleanup() {
        Log.v(TAG, "clean up unregisterReceiver");
        /* SPRD: add for Bug514575 begin */
        if (mIsReceiverRegistered == true) {
            unregisterReceiver(mHeadsetReceiver);
            mIsReceiverRegistered = false;
