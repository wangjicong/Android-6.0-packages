...
final class A2dpStateMachine extends StateMachine {
    ...
    public void cleanup() {
        /* fix bug: 537976 a2dp audio route does not reset when power off BT */
        log("cleanup a2dp, current state:" + mCurrentState +  ", device: " +  mCurrentDevice);

        if (mCurrentState == BluetoothProfile.STATE_CONNECTED) {
            log("reset a2dp audio route.");
            mAudioManager.setBluetoothA2dpDeviceConnectionState(mCurrentDevice,  BluetoothProfile.STATE_DISCONNECTED,
    ...
    private class Pending extends State {
        ...
        public void enter() {
            ...
            mCurrentState = BluetoothProfile.STATE_CONNECTING;
        }
    ...
    private class Connected extends State {
        ...
        public void enter() {
            ...
            mCurrentState = BluetoothProfile.STATE_CONNECTED;
