...
public class FmReceiverServiceState
{
    ...
    static final int OPERATION_ENABLE  = 2; // When a enable command requested.
    static final int OPERATION_DISABLE = 3; // When a disable command requested.
    static final int OPERATION_SEARCH  = 4; // When a search command requested.
    static final int OPERATION_TUNE = 5;
    static final int OPERATION_MUTE = 6;
    static final int OPERATION_SEEK_ABORT = 7;
    static final int OPERATION_SET_RDS_MODE = 8;
    static final int OPERATION_SET_AUDIO_MODE = 9;
    static final int OPERATION_SET_AUDIO_PATH = 10;
    static final int OPERATION_SET_STEP_SIZE = 11;
    static final int OPERATION_SET_FM_VOLUME = 12;
    static final int OPERATION_SET_WORLD_REGION = 13;
    static final int OPERATION_NFL = 14; // When NFL is executed, this takes too much time.
    static final int OPERATION_GENERIC = 15;

    static final int OPERATION_STATUS_EVENT_CALLBACK = 16;
    static final int OPERATION_SEARCH_EVENT_CALLBACK = 17;
    static final int OPERATION_RDS_EVENT_CALLBACK = 18;
    static final int OPERATION_RDS_DATA_EVENT_CALLBACK = 19;
    static final int OPERATION_AUDIO_MODE_EVENT_CALLBACK = 20;
    static final int OPERATION_AUDIO_PATH_EVENT_CALLBACK = 21;
    static final int OPERATION_REGION_EVENT_CALLBACK = 22;
    static final int OPERATION_NFE_EVENT_CALLBACK = 23;
    static final int OPERATION_LIVE_AUDIO_EVENT_CALLBACK = 24;
    static final int OPERATION_VOLUME_EVENT_CALLBACK = 25;
    ...
    static int mFuncMask = FmProxy.FUNC_REGION_DEFAULT|FmProxy.FUNC_RDS|FmProxy.FUNC_AF;
    static int mFreq = 0;
