...
public class AnswerFragment extends BaseFragment<AnswerPresenter, AnswerPresenter.AnswerUi>
    ...
    public void onDestroyView() {
        ...
        /* SPRD: modify for Telcel @{ */
        if (getContext() != null) {
            IncomingThirdCallHelper callFailCauseHelper = IncomingThirdCallHelper
                    .getsInstance(getContext());
            callFailCauseHelper.dismissHangupCallDialog();
        }
        /* @} */
        super.onDestroyView();
    }
    ...
    public void onShowAnswerUi(boolean shown) {
        ...
        if (shown) {
            ...
            mGlowpad.stopPing();
            if (mGlowpad.sDialog != null && mGlowpad.sDialog.isShowing()) {
                mGlowpad.sDialog.dismiss();
                mGlowpad.sDialog = null;
            }
        ...
        if (getContext() != null) {
            IncomingThirdCallHelper callFailCauseHelper = IncomingThirdCallHelper
                    .getsInstance(getContext());
            callFailCauseHelper.dealIncomingThirdCall(getContext(), shown);
        } /* @} */
    }
     ...
     * @orig public void onAnswer(int, int, Context)
     */
    @Override
    public void onAnswer(int mpcMode, int videoState, Context context) {
        Log.d(this, "onAnswer videoState=" + videoState + " context=" + context);
        getPresenter().onAnswer(mpcMode, videoState, context);
    }
