...
public class PostCharDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        /* SPRD: InstantiationException when PostCharDialogFragment recreate in InCallActivity @{ */
        if (savedInstanceState != null) {
            mCallId = savedInstanceState.getString(KEY_CALL_ID);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(KEY_CALL_ID, mCallId);
