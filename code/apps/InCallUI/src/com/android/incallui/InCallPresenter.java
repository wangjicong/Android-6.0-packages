...
import com.android.incallui.IncallFlash;//sunvov liujiabin 20151210 add
...
public class InCallPresenter implements CallList.Listener,
    ...
    private static final int TONE_IS_OVER = 1;
    ...
    private final android.telecom.Call.Callback mCallCallback =
        ...
        public void onPostDialWait(android.telecom.Call telecomCall,
            ...
            /*SPRD: add for bug#510481 @{ */
            if (mCallList == null) {
                Log.w(this, "mCallList is null");
                return;
            }
            /* @} */
    ...
    public void setUp(Context context,
        ...
        mContext = context;
        /* SPRD: Clear the original Cache before new one @{ */
        if (mContactInfoCache != null) {
            mContactInfoCache.clearCache();
        }
        /* @} */
        mContactInfoCache = contactInfoCache;
        /* SPRD: Remove the original one before add new listener @{ */
    ...
    public void setActivity(InCallActivity inCallActivity) {
        ...
        // SPRD: Add for recorder
        mRecorderHelper = PhoneRecorderHelper.getInstance(mInCallActivity);
    }
    ...
    public void onCallListChange(CallList callList) {
        ...
        if (newState == InCallState.NO_CALLS) {
            InCallUIHdVoicePlugin.getInstance().removeHdVoiceIcon();
        }
    }
    ...
    public void onDisconnect(Call call) {
        ...
        if (isActivityStarted()) {
            ...
            // SPRD: add for bug 565897 dismiss pending dialogs when disconnected
		...
		mInCallActivity.IsStratRecording = false;
		/* Sunvov:jiazhenl 20150609 add for call auto record end @} */	
        // SPRD add for resolving oom.
        ContactInfoCache.getInstance(mContext).remove(call.getId());
    ...
    private void maybeShowErrorDialogOnDisconnect(Call call) {
        ...
        if (isActivityStarted() && call.getState() == Call.State.DISCONNECTED) {
            ...
            if (mContext != null && InCallUITelcelHelper.getsInstance(mContext)
                    .isSpecialVoiceClearCode(call.getNumber())) {
                return;
            }
            /* @} */
    ...
    private InCallState startOrFinishUi(InCallState newState) {
        ...
        /*Bug47022:Settings -> Display -> lightning flash open, close the holster call, not after the camera flash--up160923@{*/
				if(OptConfig.SUN_INCALL_FLASH){
		    		final IncallFlash mincallflash = IncallFlash.init();//sunvov liujiabin 20151210 add
						if(newState == InCallState.INCOMING){
							if(!mCallList.getIncomingCall().isVideoCall(mContext)){
								mincallflash.OpenLightOn();
							}
						}else{
							mincallflash.CloseLightOff();
						}
				}
		/*Bug47022:Settings -> Display -> lightning flash open, close the holster call, not after the camera flash--up160923@}*/
        
//wangxing 20160222 add hallview start
        if(OptConfig.SUNVOV_HALLVIEW_CIRCLE_SUPPORT){
	        Log.i(this,"wangxing: startForHallCallUi(true) isHallOn()="+isHallOn());   
	        if( (InCallState.INCOMING == newState || InCallState.PENDING_OUTGOING == newState || InCallState.OUTGOING == newState) && isHallOn()){
	            if(InCallState.PENDING_OUTGOING == newState || InCallState.OUTGOING == newState){
	            	Log.i(this,"wangxing: startForHallCallUi(true)");
	                startForHallCallUi(true);
	            }else{
	                Log.i(this,"wangxing: startForHallCallUi(false)");
	                startForHallCallUi(false);
	            }
	            
	            return newState;
	        }
	    }
//wangxing 20160222 add hallveiw end
        ...
        showCallUi |= InCallState.PENDING_OUTGOING == newState && mainUiNotVisible
                && isCallWithNoValidAccounts(CallList.getInstance().getPendingOutgoingCall() /*SPRD: add for bug#510481 */);
        ...
        if (activityIsFinishing) {
            /* SPRD : Modify for bug 516652 @{ */
            boolean showUiFromBackground = startIncomingCallSequence
        ...
        if (showCallUi || showAccountPicker) {
            ...
            if (isActivityStarted()) {
                ...
                /* SPRD : Modify for bug 541013 @{ */
                if (newState == InCallState.INCOMING && mInCallState == InCallState.NO_CALLS) {
                    attemptFinishActivity();
                    attemptCleanup();
                }
                /* @} *
                /* SPRD: for bug518051 && 503064 && bug520001 Acquiring full wake lock when device is interactive @{*/
                PowerManager powerManager = (PowerManager) mContext.getSystemService(Context.POWER_SERVICE);
                if (!powerManager.isInteractive()) {
                    mFullWakeLock = powerManager.newWakeLock(PowerManager.FULL_WAKE_LOCK
                            | PowerManager.ACQUIRE_CAUSES_WAKEUP | PowerManager.ON_AFTER_RELEASE, "InCallPresenter");
                    if (mFullWakeLock != null && !mFullWakeLock.isHeld()) {
        ...
        /** @} */
        /** SPRD: Add for bug503932 && bug513941 && bug517677,Show InCallUI when new call state is INCALL
         * ,old call state is PENDING_OUTGOING and InCallUI is not showing. @{
         */
        else if (newState == InCallState.INCALL && mInCallState == InCallState.PENDING_OUTGOING
                && mainUiNotVisible) {
            showInCall(false, false);
        }
        /* @} */
    ...
    private void attemptCleanup() {
        ...
        if (shouldCleanup) {
            ...
            /* SPRD: Remove it's call update listener When StatusBarNotifier is gone. @{ */
            if (mStatusBarNotifier != null) {
                mStatusBarNotifier.removeCallUpdateListenerWhenCleanup();
            }
            /* @} */
    ...
    public void setThemeColors() {
        ...
        // SPRD: Add for 525471, return when mThemeColors is null
    ...
    public MaterialPalette getThemeColors() {
        /* SPRD: Add for 517734, NullPointerException when mThemeColors is null @{ */
    ...
    private MaterialPalette getColorsFromPhoneAccountHandle(PhoneAccountHandle phoneAccountHandle) {
        ...
        /* SPRD: Add for 525471, NullPointerException when mContext is null */
        try {
            return new InCallUIMaterialColorMapUtils(
                    mContext.getResources()).calculatePrimaryAndSecondaryColor(highlightColor);
        } catch (NullPointerException e) {
            Log.e(this, " NullPointerException when calculatePrimaryAndSecondaryColor...");
            return null;
        }
        /* @} */
    }
    ...
    /* @} */
    /**
     * SPRD: fix bug 495983 getCallCardView for video call @{
     */
    public View getCallCardView() {
        if(mInCallActivity != null && mInCallActivity.getCallCardFragment() != null){
            return mInCallActivity.getCallCardFragment().getView();
        }else{
            return null;
        }
    }
    ...
    public void displayDialpad(boolean show) {
        if (mInCallActivity != null && mInCallActivity.getCallButtonFragment() != null) {
            mInCallActivity.getCallButtonFragment().displayDialpad(show,true);
        }
    }

    public void showConferenceListFragment(boolean show) {
        if (mInCallActivity == null) {
            return;
        }
        mInCallActivity.showConferenceListFragmet(show);
    }
    /*@}*/
    ...
    public float getSecondaryCallInfo() {
        if(mInCallActivity != null){
            return mInCallActivity.getCallCardFragment().getSecondaryCallInfo();
        }else{
            return 0.0f;
        }
    }
    ...
    @Override
    public void onReponseAudioToVideo(Call call) {
        Log.i(this, "onReponseAudioToVideo");
        if(mContext != null){
            KeyguardManager keyguardManager = (KeyguardManager) mContext.getSystemService(Context.KEYGUARD_SERVICE);
            if(keyguardManager != null && keyguardManager.inKeyguardRestrictedInputMode()){
                showInCall(false,false);
                if (isActivityStarted()) {
                    mInCallActivity.forceDismissKeyguard();
                }
            }
        }
        /* SPRD: add for bug546719@{ */
        try {
        ...
        if (mToneGenerator != null) {
            ...
            mHandler.sendEmptyMessageDelayed(TONE_IS_OVER, 1000);
        }
        /* @} */
    }
    /* @} */
    ...
    public void AutoRecorder() {
        if (mInCallActivity!=null){
            mInCallActivity.autoRecorder();
        }
    }
    /* Sunvov:jiazhenl 20150609 add for call auto record end @} */
    //wangxing 20160222 add hallCall start
    /*SUN:jicong.wang add for vibrate when call connection start {@*/
    public void VibrateWhenCallConnection() {
        if (mInCallActivity!=null){
            mInCallActivity.vibrateWhenCallConnection();
        }
    } 
    /*SUN:jicong.wang add for call connection end @}*/
	public void showInCallFromHall(){
		Log.i(this,"wangxing:  showInCallFromHall");
	    mContext.startActivity(getInCallIntent( false,false));
	}
	
	
	public boolean isHallOn(){
		
		boolean value = Settings.System.getInt(mContext.getContentResolver(),"com.wx.hall.status", 0)==1 ? true : false;
		
		return value;
	}
	
	
	private void startForHallCallUi(boolean paramBoolean){
		
		Log.i(this,"wangxing:  paramBoolean="+ paramBoolean);
		Intent localIntent = new Intent("com.wx.hallview.launchfragment");
	    localIntent.putExtra("fragment_tag", "incall");
	    localIntent.putExtra("is_outgoing", paramBoolean);
    ...
    public String getOutgoingCallNumber()
	{
		if (mCallList != null){
		    ...
		    Call localCall = mCallList.getFirstCall();
		    if(localCall != null){
	            return localCall.getNumber();
	        }
	    }
	    return null;
	}
	...
	public long getCallElapsedTime()
	{
		if (mCallList != null){
		    ...
		    Call localCall = mCallList.getFirstCall();
		    if(localCall != null){
	            return localCall.getConnectTimeMillis();
	        }
	    }
	    return -1L;
	}
//wangxing 20160222 add hallCall end
}
