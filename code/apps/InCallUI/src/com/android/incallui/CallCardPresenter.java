...
/*SUN:jicong.wang add foir SUN_INCALL_FLASH @}*/
/**
...
//                Call.areSameNumber(mPrimary, primary));
        ...
        if (isPrimaryCallActive() || isPrimaryCallIsConference()) {
            ...
            if (mPrimary.isVideoCall(mContext)==false){
                Log.d(this, "Kalyy Starting record");
                InCallPresenter.getInstance().AutoRecorder();
            }
            /* Sunvov:jiazhenl 20150609 add for call auto record end @} */

            /*SUN:jicong.wang for vibrate when call connection start {@*/
            //InCallPresenter.getInstance().VibrateWhenCallConnection();
            /*SUN:jicong.wang for vibrate when call connection end @} */
        } else {
