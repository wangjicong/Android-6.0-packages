...
public class InCallCameraManager {
    ...
    public interface CameraPauseStateListener {
        void onCameraPauseStateChanged(boolean isCameraPaused);//SPRD:Add for bug544111
    }
    /* @} */
    ...
    private final List<CameraPauseStateListener>  mCameraPauseStateListeners = new CopyOnWriteArrayList<CameraPauseStateListener>();//SPRD:Add for bug544111
    ...
    /* SPRD: add for bug544111@{*/
    public void addCameraPauseStateListener(CameraPauseStateListener listener) {
        if (listener != null) {
            mCameraPauseStateListeners.add(listener);
        }
    }

    public void removeCameraPauseStateListener(CameraPauseStateListener listener) {
        if (listener != null) {
            mCameraPauseStateListeners.remove(listener);
        }
    }

    public void notifyCameraPauseState(boolean isCameraPaused) {
        for (CameraPauseStateListener listener : mCameraPauseStateListeners) {
            listener.onCameraPauseStateChanged(isCameraPaused);
        }
    }
    /* @} */
    ...
    public void setCameraPaused(boolean pause) {
        mCameraPaused = pause;
        notifyCameraPauseState(mCameraPaused);//SPRD:Add for bug544111
    }
    /** @} */
}
