...
public class FileType {
    ...
    private Set<String> mImageFileType = new HashSet<String>();

    private Set<String> mAudioFileType = new HashSet<String>();

    private Set<String> mVideoFileType = new HashSet<String>();

    private Set<String> mDocFileType = new HashSet<String>();

    private Set<String> mTextFileType = new HashSet<String>();

    private Set<String> mWordFileType = new HashSet<String>();

    private Set<String> mExcelFileType = new HashSet<String>();

    private Set<String> mPPTFileType = new HashSet<String>();

    private Set<String> mWebTextFileType = new HashSet<String>();

    private Set<String> mPdfFileType = new HashSet<String>();

    private Set<String> mPackageFileType = new HashSet<String>();

    private Set<String> mVcardFileType = new HashSet<String>();

    private Set<String> mVcalenderFileType = new HashSet<String>();
