...
public class FilePickerActivity extends Activity implements OnItemClickListener {
    ...
    private void init(int which){
        ...
        if(which == 2) {
            mTopPath = StorageUtil.getUSBStorage();
        }
        init();
    }
    /* @} */
    ...
    public void onBackPressed() {
        if (mAdapter != null && mAdapter.getCurrentPath().getParent().toString().equals(mAdapter.getTopPath().toString())){
            mReturnHome.setVisible(false);
        }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        if (file.isDirectory()) {
            ...
            if (requiredType != null && requiredType.equals("*/*")) {
                ...
                intent.setDataAndType(FileUtil.getFileUri(file,type,this), type);
                /* @} */
                /* @} */
