...
public class CellBroadcastResources {
    ...
    public static String getDialogTitleResource(Context context, CellBroadcastMessage cbm, String channelName){
        int rId = 0;
        rId = getDialogTitleResource(cbm);
        if (rId == R.string.cb_other_message_identifiers) {
            return channelName!=null?channelName:context.getString(rId);
        } else {
