...
public class NoteEditor extends BaseActivity{
    ...
    private void updateDisplay() {
        ...
        /* SPRD 523304 identify information content for before and after the url of the character @{ */
        Linkify.addLinksSprd(mNowContent, Linkify.ALL);
        /* @} */
    ...
    private void insertNote(String content) {
        if (content.length() > 0 || isTitleValid()) {//content is not empty or title need update
            ...
            if (getDataManager(this).insertItem(mNoteItem) == INSERT_ITEM_FAIL)
                return;
            /* @} */
            mOldContent = content;
