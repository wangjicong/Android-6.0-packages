...
public final class PreferencesSettingsFragment extends SubScreenFragment {
    ...
    public void onResume() {
        super.onResume();
        /* SPRD:Add for bug 494279, disable voice input when the DUT didn't support voice input. @{ */
        boolean isShortEnabled = RichInputMethodManager.getInstance().isShortcutImeEnabled();
...
//            voiceInputKeyOption.setSummary(VOICE_IME_ENABLED
            voiceInputKeyOption.setEnabled(VOICE_IME_ENABLED && isShortEnabled);
            voiceInputKeyOption.setSummary((VOICE_IME_ENABLED && isShortEnabled)
                    /* @} */
