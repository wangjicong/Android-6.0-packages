...
public class OpenWnnJAJP extends OpenWnn {
    ...
    /* SPRD: add for multi-user problem @{ */
    ...
    public OpenWnnJAJP() {
        ...
        if (userId == 0) {
            mDictPath = "/data/data/jp.co.omronsoft.openwnn/writableJAJP.dic";
        } else if (userId > 0) {
            mDictPath = "/data/user/" + String.valueOf(userId)
                    + "/jp.co.omronsoft.openwnn/writableJAJP.dic";
        }
        /* @} */
